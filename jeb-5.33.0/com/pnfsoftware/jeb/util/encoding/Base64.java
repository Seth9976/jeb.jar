...
public class Base64 {
   private static final ILogger logger = GlobalLog.getLogger(Base64.class);
   ...
   public static byte[] encodeBytesToBytes(byte[] var0) {
      ...
      try {
         ...
         Assert.fail("IOExceptions only come from GZipping, which is turned off: " + var3.getMessage());
      }
   ...
   public static byte[] encodeBytesToBytes(byte[] var0, int var1, int var2, int var3) throws IOException {
      if (var0 == null) {
         ...
         throw new IllegalArgumentException(Strings.ff("Cannot have offset of %d and length of %d with array of length %d", var1, var2, var0.length));
      } else if ((var3 & 2) != 0) {
   ...
   private static int decode4to3(byte[] var0, int var1, byte[] var2, int var3, int var4) {
      if (var0 == null) {
         ...
         throw new IllegalArgumentException(Strings.ff("Source array with length %d cannot have offset of %d and still process four bytes.", var0.length, var1));
         ...
         throw new IllegalArgumentException(
            Strings.ff("Destination array with length %d cannot have offset of %d and still store three bytes.", var2.length, var3)
         );
      }
   }

   public static byte[] decode(byte[] var0) throws IOException {
      return decode(var0, 0, var0.length, 0);
   }
   ...
   public static byte[] decode(byte[] var0, int var1, int var2, int var3) throws IOException {
      if (var0 == null) {
         ...
         throw new IllegalArgumentException(Strings.ff("Source array with length %d cannot have offset of %d and process %d bytes.", var0.length, var1, var2));
      } else if (var2 == 0) {
         return new byte[0];
      } else if (var2 < 4) {
         ...
         for (int var10 = var1; var10 < var1 + var2; var10++) {
            byte var11 = var4[var0[var10] & 255];
            if (var11 < -5) {
               throw new IOException(Strings.ff("Bad Base64 input character decimal %d in array position %d", var0[var10] & 255, var10));
            }

            if (var11 >= -1) {
               var8[var9++] = var0[var10];
               if (var9 > 3) {
   ...
   public static byte[] decode(String var0, int var1) throws IOException {
      if (var0 == null) {
         ...
         if (var2 != null && var2.length >= 4 && !var3) {
            int var4 = var2[0] & 255 | var2[1] << 8 & 0xFF00;
            if (35615 == var4) {
   ...
   public static Object decodeToObject(String var0) throws IOException, ClassNotFoundException {
      return decodeToObject(var0, 0, null);
   }

   public static Object decodeToObject(String var0, int var1, ClassLoader var2) throws IOException, ClassNotFoundException {
   ...
   public static byte[] decodeFromFile(String var0) throws IOException {
      ...
      try {
         ...
         var1 = new byte[var5];
         System.arraycopy(var4, 0, var1, 0, var5);
   ...
   public static String encodeFromFile(String var0) throws IOException {
      ...
      try {
         File var3 = new File(var0);
         byte[] var4 = new byte[Math.max((int)(var3.length() * 1.4 + 1.0), 40)];
         int var5 = 0;
         ...
         if (this.position < 0) {
            if (this.encode) {
               ...
               for (var7 = 0; var7 < 4; var7++) {
                  ...
                  do {
                     var8 = this.in.read();
                  } while (var8 >= 0 && this.decodabet[var8 & 127] <= -5);
