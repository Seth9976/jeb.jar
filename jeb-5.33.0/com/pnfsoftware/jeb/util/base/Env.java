...
public class Env {
   ...
   private static boolean record(String var0, String var1, int var2) {
      ...
      if ((var3 != null || var1 != null) && (var3 == null || !var3.equals(var1))) {
         if (var1 == null && var2 >= 0) {
            String var4 = S.L("Environment variable not found");
            if (var2 == 0) {
               var4 = S.L("System environment variable not found");
            } else if (var2 == 1) {
               var4 = S.L("Shell environment variable not found");
            }

            logger.debug("%s: %s", var4, var0);
         }
