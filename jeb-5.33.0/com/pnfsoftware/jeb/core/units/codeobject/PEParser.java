...
import com.pnfsoftware.jeb.corei.parsers.winpe.Av;
import com.pnfsoftware.jeb.corei.parsers.winpe.DH;
import com.pnfsoftware.jeb.corei.parsers.winpe.K;
import com.pnfsoftware.jeb.corei.parsers.winpe.cq;
...
public class PEParser {
   ...
   public PEParser(IInput var1) throws IOException {
      ...
      try (SeekableByteChannel var4 = var1.getChannel()) {
         ...
         var8.rewind();
         var8.limit(var10);
         this.opthdr = cq.pC(var8, this.is64Bit);
         int var11 = this.opthdr.fI;
         int var12 = this.opthdr.oT;
         ...
         this.sectab = new DH[this.filehdr.A];
         if (this.sectab.length > 0) {
            var4.position(var7 + 4 + 20 + this.filehdr.E);
            ...
            for (int var15 = 0; var15 < this.sectab.length; var15++) {
               ...
               try {
                  ...
                  while (var34 < var16.pC.length && var16.pC[var34] != 0) {
                     var34++;
                  }

                  var33 = Strings.decodeASCII(var16.pC, 0, var34);
               } catch (Exception var36) {
                  var33 = "";
               }

               int var49 = this.sectionCharacteristicsToGenericFlags(var16.gp);
         ...
         if (this.sectab.length >= 1) {
            int var14 = (int)this.sectab[0].UT;

            for (int var47 = 1; var14 == 0 && var47 < this.sectab.length; var47++) {
               var14 = (int)this.sectab[var47].UT;
            }
      ...
      byte var39 = 0;
      if ((this.filehdr.sY & 8192) != 0) {
         var39 |= 4;
      }

      var38.setFlags(var39);
      var38.setTargetProcessor(this.machineToProcessorType(this.filehdr.pC));
      var38.setTargetSubsystem(this.subsystemToSubsystemType(this.opthdr.rl));
      var38.setEndianness(this.machineToEndianness(this.filehdr.pC));
      var38.setWordSize(this.is64Bit ? 64 : 32);
      var38.setCompilationTimestamp(this.filehdr.getTimestampMs());
      var38.setImageBase(this.opthdr.gp);
      var38.setImageSize(this.opthdr.eP);
      var38.setEntryPoint(this.opthdr.sY);
      var38.setOverlayOffset(var2);
      this.ldInfo = var38.build();

      for (int var6 = 0; var6 < this.opthdr.LM.length; var6++) {
         Av var40 = this.opthdr.LM[var6];
         String var43 = var6 < Av.pC.length ? Av.pC[var6] : "-";
         long var44 = 0L;
         if (var40.kS != 0L) {
            var44 = this.convertRelativeAddressToFileOffset(var40.kS);
         }

         this.secInfo.add(new SegmentInformation(var43, var44, var40.wS, var40.kS, var40.wS, 0));
      }
   }
   ...
   public boolean isAddressInside(long var1) {
      return var1 >= this.opthdr.gp && var1 < this.add(this.opthdr.gp, this.opthdr.eP);
   }

   public long convertFileOffsetToRelativeAddress(long var1) {
      for (DH var6 : this.sectab) {
