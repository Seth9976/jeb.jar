...
@Ser
public abstract class AbstractInteractiveBinaryUnit extends AbstractBinaryUnit implements IInteractiveUnit {
   @SerId(1)
   private IMetadataManager metadataManager = new MetadataManager();

   public AbstractInteractiveBinaryUnit(String var1, IInput var2, String var3, String var4, IUnit var5) {
      this(var1, var2, var3, var4, var5.getUnitProcessor(), var5, var5.getPropertyDefinitionManager());
   }

   public AbstractInteractiveBinaryUnit(
      String var1, IInput var2, String var3, String var4, IUnitProcessor var5, IUnitCreator var6, IPropertyDefinitionManager var7
   ) {
