...
public class DalvikInstructionOpcodes {
   ...
   public static final int OP_INVOKE_POLYMORPHIC = 250;
   public static final int OP_INVOKE_POLYMORPHIC_RANGE = 251;
   public static final int OP_INVOKE_CUSTOM = 252;
   public static final int OP_INVOKE_CUSTOM_RANGE = 253;
   public static final int OP_CONST_METHOD_HANDLE = 254;
   public static final int OP_CONST_METHOD_TYPE = 255;
   public static final int OP_OART_RETURN_VOID_NO_BARRIER = 115;
   public static final int OP_OART_IGET_QUICK = 227;
   public static final int OP_OART_IGET_WIDE_QUICK = 228;
   public static final int OP_OART_IGET_OBJECT_QUICK = 229;
   public static final int OP_OART_IPUT_QUICK = 230;
   public static final int OP_OART_IPUT_WIDE_QUICK = 231;
   public static final int OP_OART_IPUT_OBJECT_QUICK = 232;
   public static final int OP_OART_INVOKE_VIRTUAL_QUICK = 233;
   public static final int OP_OART_INVOKE_VIRTUAL_QUICK_RANGE = 234;
   public static final int OP_OART_IPUT_BOOLEAN_QUICK = 235;
   public static final int OP_OART_IPUT_BYTE_QUICK = 236;
   public static final int OP_OART_IPUT_CHAR_QUICK = 237;
   public static final int OP_OART_IPUT_SHORT_QUICK = 238;
   public static final int OP_OART_IGET_BOOLEAN_QUICK = 239;
   public static final int OP_OART_IGET_BYTE_QUICK = 240;
   public static final int OP_OART_IGET_CHAR_QUICK = 241;
   public static final int OP_OART_IGET_SHORT_QUICK = 242;
   public static final int OP_OART_CONST_METHOD_HANDLE = 254;
   public static final int OP_OART_CONST_METHOD_TYPE = 255;
   public static final int OP_ODEX_IGET_VOLATILE = 227;
   public static final int OP_ODEX_IPUT_VOLATILE = 228;
   public static final int OP_ODEX_SGET_VOLATILE = 229;
   public static final int OP_ODEX_SPUT_VOLATILE = 230;
   public static final int OP_ODEX_IGET_OBJECT_VOLATILE = 231;
   public static final int OP_ODEX_IGET_WIDE_VOLATILE = 232;
   public static final int OP_ODEX_IPUT_WIDE_VOLATILE = 233;
   public static final int OP_ODEX_SGET_WIDE_VOLATILE = 234;
   public static final int OP_ODEX_SPUT_WIDE_VOLATILE = 235;
   public static final int OP_ODEX_BREAKPOINT = 236;
   public static final int OP_ODEX_THROW_VERIFICATION_ERROR = 237;
   public static final int OP_ODEX_EXECUTE_INLINE = 238;
   public static final int OP_ODEX_EXECUTE_INLINE_RANGE = 239;
   public static final int OP_ODEX_INVOKE_OBJECT_INIT_RANGE = 240;
   public static final int OP_ODEX_RETURN_VOID_BARRIER = 241;
   public static final int OP_ODEX_IGET_QUICK = 242;
   public static final int OP_ODEX_IGET_WIDE_QUICK = 243;
   public static final int OP_ODEX_IGET_OBJECT_QUICK = 244;
   public static final int OP_ODEX_IPUT_QUICK = 245;
   public static final int OP_ODEX_IPUT_WIDE_QUICK = 246;
   public static final int OP_ODEX_IPUT_OBJECT_QUICK = 247;
   public static final int OP_ODEX_INVOKE_VIRTUAL_QUICK = 248;
   public static final int OP_ODEX_INVOKE_VIRTUAL_QUICK_RANGE = 249;
   public static final int OP_ODEX_INVOKE_SUPER_QUICK = 250;
   public static final int OP_ODEX_INVOKE_SUPER_QUICK_RANGE = 251;
   public static final int OP_ODEX_IPUT_OBJECT_VOLATILE = 252;
   public static final int OP_ODEX_SGET_OBJECT_VOLATILE = 253;
   public static final int OP_ODEX_SPUT_OBJECT_VOLATILE = 254;
