...
public class CFG implements IControlFlowGraph, Iterable {
   ...
   public List getExitBlocks() {
      ...
      for (BasicBlock var3 : this.bblist) {
         if (var3.outsize() == 0) {
            var1.add(var3);
         } else if (var3.outsize() == 1) {
            AddressableInstruction var4 = this.getLastsBreakingInstruction2(var3);
            if (var4 != null && var4.getInstructionFlags().contains(InstructionFlags.CONDITIONAL_EXEC)) {
               IFlowInformation var5 = var4.getInstruction().getBreakingFlow(var4.getOffset());
               if (var5.isBroken()) {
                  for (ICodePointer var7 : var5.getTargets()) {
                     if (var7.isUnknownAddress() || !var7.isUnknownAddress() && this.getBlockAt(var7.getAddress()) == null) {
                        var1.add(var3);
                        break;
                     }
                  }
   ...
   private AddressableInstruction getLastsBreakingInstruction2(BasicBlock var1) {
      long var2 = var1.getLastAddress();
      IInstruction var4 = var1.getLast();
      if (var4.getBreakingFlow(var2).isBroken()) {
         return new AddressableInstruction(var2, var4);
      } else {
         if (var1.size() > 1) {
            var4 = var1.get(var1.size() - 2);
            var2 -= var4.getSize();
            if (var4.getBreakingFlow(var2).isBroken()) {
               return new AddressableInstruction(var2, var4);
            }
   ...
   public IInstruction replaceInstruction(IInstruction var1, IInstruction var2) {
      if (var2 == null) {
         throw new IllegalArgumentException("Null instruction");
      } else {
         for (BasicBlock var4 : this.bblist) {
            for (int var5 = 0; var5 < var4.size(); var5++) {
               if (var4.get(var5) == var1) {
                  var4.set(var5, var2);
                  return var1;
               }
            }
