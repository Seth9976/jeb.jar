...
public class EPrototypeHandler implements IEPrototypeHandler {
   private static final StructuredLogger logger = aco.pC(EPrototypeHandler.class);
               ...
               switch (var15.getType()) {
                  ...
                  case REGISTER_PAIR:
                     ...
                     if (var1) {
                        ...
                        alr var19 = new alr(this.ctx, var4);
                        var19.pC(-1L, var41.getId(), true);
                        var19.pC(var41, var14.part(var41.getBitsize()));
                        var19.pC(-1L, var18.getId(), true);
                        var19.pC(var18, var14.slice(var41.getBitsize()));
               ...
               if (var14 != null) {
                  ...
                  switch (var15.getType()) {
                     ...
                     case STACK:
                        ...
                        break;
                     case MIXED:
                        var14 = aku.pC(var12.getBitsize(), var12, null);
                        break;
                     default:
                        throw new DecompilerException("Input storage type not supported: " + var15.getType());
                  }
