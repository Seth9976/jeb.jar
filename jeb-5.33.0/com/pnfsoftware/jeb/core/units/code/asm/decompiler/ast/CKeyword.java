...
public enum CKeyword {
   ...
   private static final StructuredLogger logger = aco.pC(CKeyword.class);
   ...
   public static void generateAccessFlags(COutputSink var0, int var1, int var2, CEntityType var3) {
      ...
      var1 = switch (CKeyword$1.$SwitchMap$com$pnfsoftware$jeb$core$units$code$asm$decompiler$ast$CEntityType[var3.ordinal()]) {
         case 1 -> var1 & 30239;
         case 2 -> var1 & 204287;
         case 3 -> var1 & 20703;
