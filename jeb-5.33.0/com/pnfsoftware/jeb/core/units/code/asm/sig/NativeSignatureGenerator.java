...
import com.pnfsoftware.jeb.corei.parsers.asm.nativesig.cq;
import com.pnfsoftware.jeb.corei.parsers.asm.nativesig.zp;
...
public class NativeSignatureGenerator {
   ...
   public INativeSignature generateSignature(INativeCodeAnalyzer var1, INativeMethodItem var2, Set var3, Set var4) {
      ...
      zp var6 = (zp)this.featureSignersManagerDB.get(var1);
      if (var6 == null) {
         var6 = new zp(var1);
         this.featureSignersManagerDB.put(var1, var6);
      }

      List var7 = var6.pC(var2, var5);
      Set var8 = this.defaultStrategy.getAttributeSigners(var1, var2);
      cq var9 = (cq)this.attributeSignersManagerDB.get(var1);
      if (var9 == null) {
         var9 = new cq(var1);
         this.attributeSignersManagerDB.put(var1, var9);
      }

      List var10 = var9.pC(var2, var8);
      return new KD(var2.getName(true), var7, var10, new NativeSignatureFlags(SignatureTargetType.ROUTINE));
   }
