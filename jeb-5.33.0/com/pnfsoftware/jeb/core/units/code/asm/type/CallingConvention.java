   ...
   public class RetLocationGenerator implements IStorageEntryGenerator {
      ...
      private StorageEntry nextInternal(TypeLayoutInfo var1) {
         ...
         if (CallingConvention.this.hasFlag(32)) {
            ...
            StorageEntry var4 = CallingConvention.this.getReturnAddressSlot(this.inputStackSlotCount);
            if (var4 == null) {
               return null;
            } else {
               if (var4.isStackBased()) {
                  var3++;
               }
            ...
            if (var2 != 0) {
               acj.pC(new RuntimeException("Unexpected index for multi-slot output: " + var2));
               return null;
            } else {
