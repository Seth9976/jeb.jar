...
import com.pnfsoftware.jebglobal.ajh;
import com.pnfsoftware.jebglobal.ajk;
...
public abstract class AbstractConverter implements IEConverter {
   private static final StructuredLogger logger = aco.pC(AbstractConverter.class);
   @SerId(1)
   ...
   protected AbstractConverter(IProcessor var1, int var2, int var3) {
      ...
      this.gCtx = new ajo(this, var2, var3, var1.getEndianness().isBig());
   }
   ...
   protected void convertBlock(BasicBlock var1, List var2) {
      ...
      try {
         ...
         logger.error(S.L("Error: Instruction cannot be converted: 0x%X: %s: %s"), var5, Formatter.byteArrayToHex(var9.getCode()), var9.format(var5));
   ...
   private void sanitizeFakeBranch(long var1, INativeContinuousItem var3, List var4, boolean var5) {
      ...
      for (int var8 = 0; var8 < var4.size(); var8++) {
         ...
         if (var10 != null && var10 == var1 && var9 instanceof ajg && ((ajg)var9).wS() == var6) {
            ((ajg)var9).pC(var7);
         }
      }
   }
   ...
   public final List convertBlockForTest(BasicBlock var1) {
      ArrayList var4;
      try {
         aki var2 = new aki((ajo)this.gCtx);
         this.setCurrentContext(var2);
      ...
      if (var2 == null) {
         ...
         while (true) {
            ...
            while (true) {
               ...
               var13 = var3.getReturnAddressSlot(var12);
               if (var13 != null) {
                  var14 = var5.getOutputs(var8);
            ...
            IEGeneric var15 = this.findReturnAddrVar(var1, var4, var8, var16, var13, var14);
            if (var15 != null) {
               ...
               if (var15 != null) {
                  ...
                  for (IWildcardType var21 : var2.getReturnTypes()) {
                     var13 = var27.next(var21.getLayoutInfo());
                     if (var13 == null) {
                        logger.warn("Cannot find storage location for output: %s", var21.getLayoutInfo());
                     } else {
                        switch (var13.getType()) {
                           case REGISTER:
                              EVarCopyFinder var31 = var1.copyFinder(var13, var14, var9.getOffset());
                              ...
                              break;
                           case STACK:
                              int var30 = var13.getValueAsStackIndex();
                              ...
                              break;
                           case REGISTER_PAIR:
                              EVarCopyFinder var22 = var1.copyFinder(var13, var14, var9.getOffset());
                  ...
                  if (var10 instanceof IECall) {
                     ...
                     ((ajk)var10).setReturnLocation(null);
   ...
   protected final boolean isPCRightValueCompatibleReturnValue(IDFA var1, BasicBlock var2, IEGeneric var3, IEGeneric var4) {
      if (var3 instanceof IECompose var5) {
         if (var5.getPartsCount() != 2 || !EUtil.isZero(var5.getHighPart())) {
            return true;
         }

         var3 = var5.getLowPart();
      }

      if (var3 == var4) {
         return true;
      } else {
         if (var3 instanceof IEVar var17) {
            long var6 = var2.getLastAddress();

            while (true) {
               Collection var8 = var1.getUseDefs(var6, var17.getId());
               long var9 = -1L;
               IEAssign var11 = null;

               for (long var13 : var8) {
                  IEStatement var15 = (IEStatement)var1.getCfg().getInstruction(var13);
                  if (var15 instanceof IEAssign var16 && !(var16.getDstOperand() instanceof IEMem)) {
                     if (var11 != null) {
                        var11 = null;
                        break;
                     }
               ...
               if (var11 == null || !(var11.getSrcOperand() instanceof IEVar var18)) {
                  break;
               }

               if (var18.equalsEx(var4, false)) {
                  return true;
               }
