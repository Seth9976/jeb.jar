...
import com.pnfsoftware.jeb.corei.parsers.asm.nativesig.codeless.Av;
import com.pnfsoftware.jeb.corei.parsers.asm.nativesig.codeless.KD;
import com.pnfsoftware.jeb.corei.parsers.asm.nativesig.codeless.zp;
...
public class CodelessSignatureManager implements IEventListener {
   ...
   public MatchingState match(INativeCodeUnit var1, CodelessSignaturePackageEntry var2) {
      KD var3 = new KD();
      MatchingState var4 = var3.pC(var2.getFile().getAbsolutePath(), var1);
      if (var4 != null) {
   ...
   public LibraryIdentificationResults identifyLibraries(INativeCodeUnit var1) {
      Av var2 = new Av();
      return var2.pC(this.entries, var1);
   }
