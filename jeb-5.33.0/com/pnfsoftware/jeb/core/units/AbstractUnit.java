...
public abstract class AbstractUnit extends JebEventSource implements IUnit {
   ...
   public AbstractUnit(String var1, String var2, IUnitProcessor var3, IUnitCreator var4, IPropertyDefinitionManager var5) {
      ...
      if (var1 != null && var1.length() != 0) {
         ...
         this.name = this.sanitizeName(var2);
   ...
   private String sanitizeName(String var1) {
      return var1 != null && !var1.isBlank() ? var1.trim().replace('/', '_').replace('\\', '_') : "u" + this.uid;
   }

   @Override
   public void setName(String var1) {
      try (ACLock var2 = this.getLock().a()) {
         var1 = this.sanitizeName(var1);
   ...
   protected void addChild(IUnit var1, boolean var2, boolean var3) {
      if (var1 == null) {
         ...
         if (!var4.contains(var1)) {
            if (var1.getParent() == this || var1.getParent() instanceof LK && ((LK)var1.getParent()).getWrap() == this) {
               var4.add(var1);
               if (var3) {
   ...
   protected boolean setChild(IUnit var1, IUnit var2, boolean var3) {
      if (this.isDisposed()) {
         ...
         if (var2 == null) {
            ...
            return false;
         } else if (var2.getParent() == this || var2.getParent() instanceof LK && ((LK)var2.getParent()).getWrap() == this) {
