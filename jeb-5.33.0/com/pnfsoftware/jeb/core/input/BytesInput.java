...
public class BytesInput implements IInput {
   ...
   public BytesInput(IInput var1, long var2, int var4) throws IOException {
      try (InputStream var5 = var1.getStream()) {
         var5.skipNBytes(var2);
         byte[] var6 = var5.readNBytes(var4);
         this.buffer = ByteBuffer.wrap(var6, 0, var4);
         this.data = var6;
         this.offset = 0;
         this.length = var4;
      }
