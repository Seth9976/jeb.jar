...
public class SystemInformation {
   ...
   public static final String javavendor = System.getProperty(ckx.pC(new byte[]{80, 11, 23, 23, 79, 88, 19, 11, 10, 11, 29}, 1, 58), "");
   public static final String javaversion = System.getProperty(ckx.pC(new byte[]{41, 14, 6, 24, 92, 31, 2, 26, 7, 73, 71, 13}, 2, 72), "");
   public static final String osname = System.getProperty(ckx.pC(new byte[]{44, 28, 94, 23, 19, 4, 2}, 2, 141), "");
   public static final String osarch = System.getProperty(ckx.pC(new byte[]{-31, 28, 93, 79, 19, 17, 11}, 1, 142), "");
   public static final String osversion = System.getProperty(ckx.pC(new byte[]{44, 28, 94, 15, 23, 27, 20, 1, 27, 78}, 2, 87), "");
   public static final String username = System.getProperty(ckx.pC(new byte[]{50, 6, 22, 23, 92, 64, 15, 12, 8}, 1, 71), "");
   public static final String compname;
   public static final String localeinfo;
   public static final String osfullname;

   public static String getCurrentDirectory() {
      return System.getProperty(ckx.pC(new byte[]{54, 28, 21, 11, 92, 13, 14, 26}, 2, 212));
   }
   ...
   public static String setCurrentDirectory(String var0) {
      ...
      System.setProperty(ckx.pC(new byte[]{54, 28, 21, 11, 92, 13, 14, 26}, 2, 50), var0);
      return var1;
   }
