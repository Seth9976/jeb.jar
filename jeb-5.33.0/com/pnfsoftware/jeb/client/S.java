         ...
         if (var2 == null) {
            synchronized (S.class) {
               ...
               if (var2 == null) {
                  ...
                  byte[] var4;
                  if (AssetManager.pC(var5)) {
                     var4 = AssetManager.A(var5);
                  } else {
                     var5 = "s-" + var1 + ".bin";
                     if (!AssetManager.pC(var5)) {
                        return null;
                     ...
                     var4 = AssetManager.A(var5);
                     String var6 = ckx.pC(new byte[]{-67, 15, 7, 98, 100, 33, 6, 12, 2, 29, 25, 5, 9, 23, 82, 86, 86, 21, 27, 86}, 1, 247);
                     ckv.pC(Strings.encodeASCII(var6), var4);
                  }
