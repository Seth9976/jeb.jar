...
@Ser
public class Ws extends AbstractBinaryUnit {
   ...
   public static bO pC(IEnginesContext var0, IRuntimeProject var1) {
   ...
   protected boolean processInternal() {
      try {
         ...
         File var4 = pC(var9, var3).kS(var1);
