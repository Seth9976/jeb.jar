...
public class Av implements K {
   ...
   public Av(int var1, boolean var2) {
      this.A = var1;
      this.kS = var2;
   }
   ...
   public List pC(File var1) throws IOException, JebException {
      try {
         ...
         ArrayList var14;
         try {
            D8Command var3 = (D8Command)((Builder)((Builder)((Builder)((Builder)((Builder)D8Command.builder().setMinApiLevel(this.A))
                           .setDisableDesugaring(!this.kS))
