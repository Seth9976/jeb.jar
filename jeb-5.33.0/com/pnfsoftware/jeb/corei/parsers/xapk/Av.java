...
import com.pnfsoftware.jeb.corei.parsers.json.K;
...
@Ser
public class Av extends AbstractBinaryUnit implements IArchiveUnit, IXApkUnit {
   ...
   public Ws pC() {
      return (Ws)UnitUtil.findChild(this, null, Ws.class, false, 0);
   }

   public K A() {
      return (K)UnitUtil.findChild(this, null, K.class, false, 0);
   }

   @Override
   public String getPackageName() {
      try {
         Object var1 = this.A().getDocument();
