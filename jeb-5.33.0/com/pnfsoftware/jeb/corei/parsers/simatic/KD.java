...
public class KD extends GenericCodeFormatter {
   private gb pC() {
      ...
      return var1 instanceof gb ? (gb)var1 : null;
   }
   ...
   public void pC(long var1, yt var3, IInstructionOperand var4, int var5, int var6, CodeDocumentPart var7) {
      gb var8 = this.pC();
      if (var8 != null && var8.getPropertyManager().getBoolean("AugmentDisassembly")) {
         RC var9 = (RC)var4;
         if (var9.pC() != 1792 && var9.pC() == 768) {
            long var10 = var9.pC(var1);
