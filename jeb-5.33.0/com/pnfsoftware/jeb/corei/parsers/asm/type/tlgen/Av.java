...
public class Av {
   private static final ILogger ys = GlobalLog.getLogger(Av.class);
   public boolean pC;
   public File A;
   public File kS;
   public File wS;
   public TypeLibraryMetadata UT;
   public File E;
   public Map sY = new HashMap();

   public Av(boolean var1, boolean var2, File var3, File var4, File var5, TypeLibraryMetadata var6) {
      this.pC = var1;
      this.A = var3;
      this.kS = var4;
      this.wS = var5;
   ...
   public String toString() {
      return Strings.ff("hdr=%s;cst=%s;out=%s", this.A, this.kS, this.wS);
   }

   public static List pC(File var0) throws IOException, TypelibDefinitionException {
      if (!Strings.endsWith(var0.getPath().toLowerCase(), ".yml", ".yaml")) {
         String var1 = Strings.decodeLocal(IO.readFile(var0));
         return Lists.createArrayList(pC(var1));
      } else {
         return A(var0);
      }
   }

   public static List A(File var0) throws IOException, TypelibDefinitionException {
      String var1 = Strings.decodeLocal(IO.readFile(var0));
      return pC(var1, var0.getParentFile());
   }

   public static List pC(String var0, File var1) {
      ArrayList var2 = new ArrayList();
      Yaml var3 = new Yaml();
      Object var4 = var3.load(var0);
      if (var4 instanceof Map var5) {
         Av var6 = pC(var5, var1);
         var2.add(var6);
      } else {
   ...
   public static Av pC(Map var0, File var1) {
      String var2 = kS(var0, "hdrsrc");
      var2 = A(var2);
      String var3 = kS(var0, "cstsrc");
      var3 = A(var3);
      String var4 = kS(var0, "output");
      var4 = A(var4);
      ArrayList var5 = new ArrayList();
      String var6 = wS(var0, "processor");
      if (var6 != null) {
         ...
         var5.addAll(pC(var0, "processors"));
      }

      ArrayList var34 = new ArrayList();
      var6 = wS(var0, "subsystem");
      if (var6 != null) {
         ...
         var34.addAll(A(var0, "subsystems"));
      }

      CompilerType var35 = CompilerType.valueOf(wS(var0, "compiler"));
      ...
      try {
         var9 = UT(var0, "groupid");
      } catch (Exception var29) {
         try {
            String var11 = wS(var0, "groupid");
            if (var11 != null) {
      ...
      int var36 = pC(var0, "packing", Integer.MAX_VALUE);
      Map var37 = pC(var0);
      double var13 = pC(var0, "priority", 0.0);
      int var15 = pC(var0, "version", 0);
      String var16 = kS(var0, "name");
      String var17 = kS(var0, "description");
      String var18 = kS(var0, "author");
      boolean var19 = pC(var0, "enabled", true);
      boolean var20 = pC(var0, "rcpcopy", false);
      if (var2 == null && var3 == null) {
         ...
         var24.putData(var37);
         return new Av(var19, var20, var21, var22, var23, var24);
      }
   }

   private static Map pC(Map var0) {
   ...
   private static List pC(Map var0, Object var1) {
      ArrayList var2 = new ArrayList();
   ...
   private static List A(Map var0, Object var1) {
      ArrayList var2 = new ArrayList();
      Object var3 = var0.get(var1);
      if (var3 instanceof String) {
   ...
   private static String kS(Map var0, Object var1) {
      return (String)var0.get(var1);
   }

   private static String wS(Map var0, Object var1) {
      String var2 = kS(var0, var1);
      return var2 == null ? null : var2.toUpperCase();
   }

   private static Integer UT(Map var0, Object var1) {
      return (Integer)var0.get(var1);
   }

   private static int pC(Map var0, Object var1, int var2) {
      Integer var3 = UT(var0, var1);
      return var3 != null ? var3 : var2;
   }

   private static Boolean E(Map var0, Object var1) {
      return (Boolean)var0.get(var1);
   }

   private static boolean pC(Map var0, Object var1, boolean var2) {
      Boolean var3 = E(var0, var1);
      return var3 != null ? var3 : var2;
   }

   private static Double sY(Map var0, Object var1) {
      return (Double)var0.get(var1);
   }

   private static double pC(Map var0, Object var1, double var2) {
      Double var4 = sY(var0, var1);
      return var4 != null ? var4 : var2;
   }

   @Deprecated
   public static Av pC(String var0) {
      File var1 = null;
      File var2 = null;
      File var3 = null;
                  ...
                  try {
                     switch (var22) {
                        ...
                        case "author":
                           ...
                           break;
                        default:
                           ys.warn("Line %d: Skipping unknown entry: %s", var16, var22);
                     }
                  } catch (Exception var28) {
      ...
      if (var1 == null && var2 == null) {
         ...
         return new Av(true, false, var1, var2, var3, var29);
      }
   }
}
