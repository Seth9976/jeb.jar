...
public class sy {
   ...
   public static String pC(INativeSignature var0, UnmanglerService var1, String var2) {
      Set var3 = pC(var0, var1);
      if (var3.isEmpty()) {
         return "unk_lib_sub";
         ...
         return var3.size() == 1 ? (String)var3.iterator().next() : pC(var3);
      }
   }

   private static Set pC(INativeSignature var0, UnmanglerService var1) {
   ...
   public static String pC(Set var0) {
      return "unk_lib_sub";
   }
}
