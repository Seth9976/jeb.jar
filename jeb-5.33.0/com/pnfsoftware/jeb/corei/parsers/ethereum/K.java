...
public class K extends AbstractEOptimizer {
   ...
   protected int perform() {
      ...
      for (BasicBlock var3 : this.cfg) {
         for (int var4 = 0; var4 <= var3.size() - 3; var4++) {
            Couple var5 = this.pC(var3, var4, null, null);
            if (var5 != null) {
               IEVar var6 = (IEVar)var5.getFirst();
               IEVar var7 = (IEVar)var5.getSecond();
               var5 = this.pC(var3, var4 + 1, var7, null);
               if (var5 != null) {
                  IEVar var8 = (IEVar)var5.getSecond();
                  var5 = this.pC(var3, var4 + 2, var8, var6);
                  if (var5 != null) {
                     if (var4 >= 1) {
                        IDFA var9 = this.cfg.doDataFlowAnalysis();
                        if (this.pC(var3, var4, var7, var8, var6, var9)) {
                           var1++;
                     ...
                     if (var4 <= var3.size() - 6) {
                        ...
                        if (this.A(var3, var4, var7, var8, var6, var12)) {
                           var1++;
                           this.cfg.invalidateDataFlowAnalysis();
                        }
                     }
   ...
   Couple pC(BasicBlock var1, int var2, IEGeneric var3, IEGeneric var4) {
   ...
   IEGeneric pC(BasicBlock var1, int var2, IEGeneric var3) {
      Assert.a(var3 != null);
   ...
   Couple pC(BasicBlock var1, int var2, IEGeneric... var3) {
   ...
   boolean pC(BasicBlock var1, int var2, IEVar var3, IEVar var4, IEVar var5, IDFA var6) {
      Couple var7 = this.pC(var1, var2 - 1, var3, var4);
      if (var7 == null) {
         return false;
      } else {
   ...
   boolean A(BasicBlock var1, int var2, IEVar var3, IEVar var4, IEVar var5, IDFA var6) {
      IEGeneric var7 = this.pC(var1, var2 + 3, var5);
      if (var7 == null) {
         return false;
      } else if (!(var7 instanceof IEOperation var8)) {
         return false;
      } else if (var8.getOperand1() == var3 && var8.getOperand2() instanceof IEImm) {
         Couple var9 = this.pC(var1, var2 + 4, var3, var4);
         if (var9 == null) {
            return false;
         } else {
            var9 = this.pC(var1, var2 + 5, var4, var5);
            if (var9 == null) {
               return false;
