...
public class Base64Identifier extends AbstractUnitIdentifier {
   ...
   public boolean canIdentify(IInput param1, IUnitCreator param2, String param3, Map param4) {
      ...
      // 0c7: aload 5
      // 0c9: iload 7
      // 0cb: invokevirtual com/pnfsoftware/jeb/corei/parsers/base64/Base64Identifier.pC (Ljava/nio/ByteBuffer;I)Z
      // 0ce: ireturn
      // 0cf: bipush 0
      // 0d0: ireturn
      // 0d1: iinc 7 1
      ...
      // 1a3: aload 14
      // 1a5: iload 7
      // 1a7: invokevirtual com/pnfsoftware/jeb/corei/parsers/base64/Base64Identifier.pC (Ljava/nio/ByteBuffer;I)Z
      // 1aa: istore 16
      // 1ac: aload 10
      // 1ae: ifnull 1b6
      // 1b1: aload 10
   ...
   private boolean pC(ByteBuffer var1, int var2) {
      int var3 = var2 % 4;
      if (var3 < 2) {
         return false;
      } else if (var3 == 2) {
