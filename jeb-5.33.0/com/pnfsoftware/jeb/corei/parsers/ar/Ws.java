...
@Ser
public class Ws extends AbstractBinaryUnit implements IArchiveUnit {
   ...
   protected boolean processInternal() {
      try (SeekableByteChannel var1 = this.getInput().getChannel()) {
         if (ChannelUtil.getLELong(var1, 0L) != 738142165265366049L) {
            ...
            int var2 = 8;
            this.pC = this.pC(var1, var2, "/               ");
            if (this.pC != null) {
               if (!this.pC(var1)) {
                  return false;
               }

               var2 = var2 + 60 + this.A.pC();
               if (var2 % 2 != 0) {
                  var2++;
               }
            }

            this.kS = this.pC(var1, var2, "/               ");
            if (this.kS != null) {
               if (!this.pC(var1, var2)) {
                  return false;
               }

               var2 = var2 + 60 + this.wS.pC();
               if (var2 % 2 != 0) {
                  var2++;
               }
            }

            this.UT = this.pC(var1, var2, "//              ");
            if (this.UT != null) {
               int var3 = Integer.parseInt(Strings.decodeASCII(this.UT.E, 0, 10).trim());
               if (var3 != 0) {
                  this.ys = var2 + 60;
               }
            ...
            while (true) {
               Sv var4 = this.pC(var1, var14, null);
               if (var4 == null) {
                  return true;
               }

               this.E.add(var4);
               String var5 = Strings.decodeASCII(var4.pC, 0, 16);
               if (var5.startsWith("/")) {
               ...
               int var18 = Integer.parseInt(Strings.decodeASCII(var4.E, 0, 10).trim());
   ...
   Sv pC(SeekableByteChannel var1, int var2, String var3) throws IOException {
      ...
      if (var1.read(var4) != 60) {
         ...
         Sv var5 = Sv.pC(var4);
         if (var3 != null) {
            String var6 = Strings.decodeASCII(var5.pC, 0, 16);
            if (!var6.equals(var3)) {
               return null;
            }
         }
   ...
   boolean pC(SeekableByteChannel var1) throws IOException {
   ...
   boolean pC(SeekableByteChannel var1, int var2) throws IOException {
