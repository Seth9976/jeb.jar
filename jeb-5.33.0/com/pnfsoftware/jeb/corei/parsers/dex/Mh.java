...
public class Mh extends com.pnfsoftware.jeb.corei.parsers.dex.Av {
   private static final ILogger A = GlobalLog.getLogger(Mh.class);
   private List kS = new ArrayList();
   private int wS = -1;
   private Set UT = new HashSet();
   private String E = null;

   public Mh(vi var1, String var2, INet var3) {
      super(var1, var2, var3, "DexJavadoc");
      this.kS.add(new Mh.K("Landroidx/", "https://androidx.de/"));
   }
   ...
   public TypedContent getItemInformation(IAddressableUnit var1, long var2, String var4, List var5) {
      ...
      if (var1 != this.getPrimaryTarget()) {
         ...
         Object var6 = ((vi)this.getPrimaryTarget()).getObjectById(var2);
         if (var6 instanceof IDexType || var6 instanceof IDexClass) {
            String var11 = this.pC(var6);

            while (var11.length() > 0 && var11.startsWith("[")) {
               var11 = var11.substring(1);
            }

            return this.ys(var11);
         } else if (var6 instanceof IDexMethod var10) {
            String var12 = this.pC(var10.getClassType());
            String var13 = var10.getName(false);
            if (var13.equals("<init>")) {
               var13 = var10.getClassType().getName(false);
            }

            return this.pC(var12, new Mh.Sv(var10), var13, var10.getClassType().getImplementingClass());
         } else if (var6 instanceof IDexField var7) {
            String var8 = this.pC(var7.getClassType());
            String var9 = var7.getName(false);
            return this.pC(var8, new Mh.Av(var9), var9, var7.getClassType().getImplementingClass());
         } else {
            return null;
         }
      }
   ...
   public TypedContent getLocationInformation(IAddressableUnit var1, String var2) {
      if (var2.startsWith("about:blank")) {
         ...
         for (int var4 : this.UT) {
            ...
            String var5 = var2;
            Mh.K var6 = (Mh.K)this.kS.get(var4);
            String var7 = var6.A.substring(0, var6.A.indexOf("/", 8));
            if (var2.startsWith("/")) {
               var5 = var7 + var2;
            }
   ...
   protected TypedContent ys(String var1) {
      this.wS = -1;
      if (this.oT(var1)) {
         Document var2 = this.WR(var1);
         if (var2 == null) {
            return null;
         }

         String var3 = this.pC(var2, var1, null);
         if (var3 != null) {
            return TypedContent.html(var3);
         }
      }

      for (Mh.K var8 : this.kS) {
         if (var8.pC(var1)) {
            Document var4 = this.pC(var1, var8);
            if (var4 == null) {
               return null;
            }

            String var5 = this.pC(var4, var1, var8);
            if (var5 != null) {
               this.wS = 0;
               this.UT.add(0);
   ...
   private String gp(String var1) {
      ...
      if (!var5.isEmpty()) {
         ...
         if (var9.hasNext()) {
            ...
            return this.A(var8.toString(), "", true, var2);
         }
      }
   ...
   protected TypedContent pC(String var1, Mh.Ws var2, String var3, IDexClass var4) {
      if (this.oT(var1)) {
         Document var5 = this.WR(var1);
         if (var5 == null) {
            return null;
         }

         String var6 = this.pC(var2, var3, var5, var1);
         if (var6 != null) {
      ...
      while (var4 != null) {
         ...
         for (int var13 = 0; var13 < var12.size(); var13++) {
            ...
            TypedContent var8 = this.pC(this.pC(var7), var2, var3, null);
            if (var8 != null) {
               return var8;
            }
         ...
         for (ICodeType var16 : var14) {
            TypedContent var17 = this.pC(this.pC(var16), var2, var3, null);
            if (var17 != null) {
               return var17;
            }
         }
   ...
   protected TypedContent kS(String var1, String var2) {
      if (this.oT(var1)) {
         ...
         String var6 = this.pC(new Mh.Av(var2), var4, var3, var1);
         if (var6 != null) {
            return TypedContent.html(var6);
         }
      }
   ...
   private boolean oT(String var1) {
   ...
   private String pC(Document var1, String var2, Mh.K var3) {
      ...
      if (var4 == null) {
         ...
         if (var12.size() != 0 && !((Element)var12.get(0)).children().isEmpty()) {
            Element var14 = this.pC(null, var1);
            return var14 != null ? this.A(var14.toString(), var2, true, var1) : this.A(var1.toString(), var2, false, var1);
         } else {
            return null;
         }
      } else {
         ...
         for (int var7 = 0; var7 < var9.size() && var7 < 30; var7++) {
            ...
            if (var7 != 0 && this.fI(var8.tagName()) || var8.hasClass("details")) {
               break;
            }
         ...
         return this.A(var6.toString(), var2, true, var1);
      }
   }

   private boolean fI(String var1) {
      return var1.length() > 1 && Character.toLowerCase(var1.charAt(0)) == 'h' && Character.isDigit(var1.charAt(1));
   }

   private String pC(Mh.Ws var1, String var2, Document var3, String var4) {
      ArrayList var5 = new ArrayList();
      ...
      if (!var5.isEmpty()) {
         for (Element var21 : var5) {
            ...
            if (var11 != null && (!var7 && (var11.tagName().equals("ul") || var11.tagName().equals("div")) || var7 && var11.tagName().equals("h3"))) {
               ...
               int var13 = var1.pC(var12);
               if (var13 == 0) {
                  return this.A(var7 ? this.pC(var11) : var11.toString(), var4, true, var3);
               }
      ...
      if (!var5.isEmpty()) {
         for (Element var23 : var5) {
            ...
            int var27 = var1.pC(var25);
            if (var27 == 0) {
               return this.A(var7 ? this.pC(var23) : var23.parent().toString(), var4, true, var3);
            }
      ...
      if (var6.isEmpty()) {
         ...
         if (var20.size() == 1) {
            return this.A(((Element)var20.get(0)).toString(), var4, true, var3);
         } else {
            ...
            return this.A(var24.toString(), var4, true, var3);
         }
      }
   }

   private String pC(Element var1) {
   ...
   protected String A(String var1, String var2, boolean var3, Document var4) {
   ...
   private Document WR(String var1) {
      String var2 = var1.substring(1, var1.length() - 1) + ".html";
      return this.A(var2);
   }

   private Document pC(String var1, Mh.K var2) {
      try {
         String var3 = var1.substring(1, var1.length() - 1) + ".html";
         String var4 = this.pC.query(var2.A + var3);
   ...
   private Document kS() {
      try {
         if (this.E == null) {
            this.E = this.pC.query("https://source.android.com/docs/core/runtime/dex-format");
            if (this.E == null) {
               return null;
            }
         }

         return Jsoup.parse(this.E, "");
      } catch (IOException var2) {
         A.catchingSilent(var2);
         return null;
      }
   }

   private static class Av implements Mh.Ws {
      private String pC;
      ...
      public int pC(String var1) {
         ...
         return this.pC.equals(var1) ? 0 : -1;
      }
   }
   ...
   private static class K {
      ...
      public boolean pC(String var1) {
         return Strings.startsWith(var1, this.pC);
      }
   }

   private class Sv implements Mh.Ws {
      private IDexMethod A;

      public Sv(IDexMethod var2) {
         this.A = var2;
      }
      ...
      public int pC(String var1) {
         var1 = Strings.urldecodeUTF8(var1);
         List var2 = this.A.getParameterTypes();
         if (var1.contains("-")) {
            if (var1.endsWith("-")) {
         ...
         for (var6 = 0; var5 < var3.length; var5++) {
            ...
            if (!var7.isEmpty() && !var7.equals(")")) {
               ...
               int var9 = this.pC(var7, this.pC(var8));
               if (var9 == 0) {
                  var6++;
               } else {
                  if (var9 < 0) {
      ...
      private int pC(String var1, String var2) {
      ...
      private String pC(ICodeType var1) {
         String var2 = Mh.this.pC(var1);
         int var3 = 0;
