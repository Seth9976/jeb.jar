...
@Ser
public class RC implements IDexMap {
   ...
   public IDexMap.Entry getEntry(int var1) {
      return (IDexMap.Entry)this.A.get(var1);
   }

   public static RC pC(byte[] var0, int var1) {
      RC var2 = new RC();
      ...
      for (int var4 = 0; var4 < var3; var4++) {
         ...
         switch (var5) {
            ...
            case 8198:
            case 61440:
               var2.A.put(var5, new IDexMap.Entry(var5, var7, var6));
               break;
         }
      }
