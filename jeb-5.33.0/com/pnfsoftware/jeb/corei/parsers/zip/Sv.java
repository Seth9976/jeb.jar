...
import com.pnfsoftware.jebglobal.ckt;
...
@Ser
public class Sv extends AbstractBinaryUnit implements IDataProvider, IArchiveUnit {
   private static final ILogger A = GlobalLog.getLogger(com.pnfsoftware.jeb.corei.parsers.zip.Sv.class);
   @SerId(1)
   boolean pC;

   public Sv(String var1, IInput var2, IUnitProcessor var3, IUnitCreator var4, IPropertyDefinitionManager var5, String var6) {
   ...
   public byte[] getDataBytes(String var1, int var2) {
      try {
         ...
         try {
            ...
            A.catchingSilent(var15);
            return null;
         }

         A.catchingSilent(var18);
         return null;
      }
   }
   ...
   protected boolean processInternal() {
      try {
         ...
         if (var1) {
            ...
            DataContainerUnit.register(this, new com.pnfsoftware.jeb.corei.parsers.zip.Sv.Sv().pC());
         } else {
            Object[] var3 = new Object[0];
            LazyDataContainerUnit.register(this, new com.pnfsoftware.jeb.corei.parsers.zip.Sv.K().pC());
         }
   ...
   abstract class Av extends ckt {
      String pC;
      long A;
      ZipArchiveEntry kS;
      InputStream wS;

      public Collection pC() throws IOException {
         TreeMap var1 = new TreeMap();

         try {
            ZipFile var2 = new ZipFile(Sv.this.getInput().getChannel());
            ...
            try {
               ...
               while (var16.hasMoreElements()) {
                  try {
                     ...
                     if (var20.isEmpty()) {
                        Sv.this.logWarn(true, S.L("Illegal zip entry name: \"%s\""), var19);
                     } else {
                        this.pC(var19, var18, var17, var2.getInputStream(var17));
                        this.pC(var1, var20, var17.isDirectory());
                     }
                  } catch (IOException var13) {
                     com.pnfsoftware.jeb.corei.parsers.zip.Sv.A.catchingSilent(var13);
                     break;
                  }
               }
            } catch (Throwable var14) {
            ...
            ZipArchiveInputStream var3 = new ZipArchiveInputStream(Sv.this.getInput().getStream());
            ...
            try {
               while (true) {
                  try {
                     ...
                     if (var8.isEmpty()) {
                        Sv.this.logWarn(true, S.L("Illegal zip entry name: \"%s\""), var7);
                     } else {
                        this.pC(var7, var5, var4, var3.canReadEntryData(var4) ? var3 : null);
                        this.pC(var1, var8, var4.isDirectory());
                     }
                  } catch (IOException var11) {
                     com.pnfsoftware.jeb.corei.parsers.zip.Sv.A.catchingSilent(var11);
                     break;
                  }
               }
            } catch (Throwable var12) {
      ...
      void pC(String var1, long var2, ZipArchiveEntry var4, InputStream var5) {
         this.pC = var1;
         this.A = var2;
         this.kS = var4;
         this.wS = var5;
   ...
   class K extends com.pnfsoftware.jeb.corei.parsers.zip.Sv.Av {
      ...
      public LazyDataContainerUnit.Entry pC(String var1, int var2) {
         return LazyDataContainerUnit.Entry.create(Sv.this, this.pC, this.A, var1, var2);
      }
   ...
   class Sv extends com.pnfsoftware.jeb.corei.parsers.zip.Sv.Av {
      public DataContainerUnit.Entry pC(String var1) {
         return DataContainerUnit.Entry.createFolder(var1);
      }

      public DataContainerUnit.Entry pC(String var1, int var2) throws IOException {
         byte[] var3;
         if (this.wS == null) {
            var3 = new byte[0];
         } else {
            var3 = IO.readInputStream(this.wS);
         }

         return DataContainerUnit.Entry.create(var1, var3);
      }

      public Map pC(DataContainerUnit.Entry var1) {
         return var1.getChildren();
      }

      public boolean A(DataContainerUnit.Entry var1) {
         return var1.isFolder();
      }
   }
}
