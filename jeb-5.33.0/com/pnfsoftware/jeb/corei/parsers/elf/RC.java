...
@SerDisabled
public class RC extends AbstractTableDocument {
   private IELFUnit pC;
   private TableDocumentPart A;

   public RC(IELFUnit var1) {
      this.pC = var1;
      ...
      this.A = new TableDocumentPart(0, var2);
   }
   ...
   public String coordinatesToAddress(ICellCoordinates var1) {
      if (var1 == null) {
         ...
         ITableRow var2 = (ITableRow)this.A.getRows().get(var1.getRowIndex());
         return this.pC(var2);
      }
   }
   ...
   public ICellCoordinates addressToCoordinates(String var1) {
      if (var1 == null) {
         ...
         for (int var2 = 0; var2 < this.getRowCount(); var2++) {
            ITableRow var3 = (ITableRow)this.A.getRows().get(var2);
            if (var1.equals(this.pC(var3))) {
   ...
   private String pC(ITableRow var1) {
