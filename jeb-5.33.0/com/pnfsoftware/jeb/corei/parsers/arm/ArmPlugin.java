...
import com.pnfsoftware.jebglobal.DP;
import com.pnfsoftware.jebglobal.KQ;
import com.pnfsoftware.jebglobal.NR;
import java.util.Arrays;
import java.util.List;

public class ArmPlugin extends AbstractNativeDisassemblerPlugin {
   public ArmPlugin() {
      super("arm", 0.0);
   }
   ...
   public IProcessor getProcessor(IUnitCreator var1) {
      ...
      return new cq(var2, var1);
   }

   private int pC(IUnitCreator var1) {
      byte var2 = 32;
   ...
   static {
      ...
      ELFPluginsService.getInstance().addRelocationContext(DP.ED);
      ELFPluginsService.getInstance().addRelocationContext(DP.Sc);
      ELFPluginsService.getInstance().addRelocationContext(DP.ah);
      ELFPluginsService.getInstance().addRelocationContext(DP.eP);
      ELFPluginsService.getInstance().addSectionProcessor(new KQ());
      ELFPluginsService.getInstance().addSymbolsProcessorFactory(new NR());
   }
}
