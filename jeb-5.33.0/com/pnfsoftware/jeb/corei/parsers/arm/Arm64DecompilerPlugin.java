...
public class Arm64DecompilerPlugin extends AbstractNativeDecompilerPlugin {
   public Arm64DecompilerPlugin() {
      super("dcmp_arm64", 0.0);
   }

   @Override
   public IPluginInformation getPluginInformation() {
      return new PluginInformation(S.L("Aarch64 Decompiler"), S.L("ARM 64-bit decompiler"), "PNF Software", Version.create(0, 0, 1));
   }

   @Override
   public IEConverter getConverter(INativeCodeUnit var1) {
      return new HE((cq)var1.getProcessor());
   }
