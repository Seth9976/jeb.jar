...
import com.pnfsoftware.jebglobal.ash;

public class vi extends AbstractEExpressionOptimizer {
   public vi() {
   ...
   protected AbstractEExpressionOptimizer.EOR optimizeExpression(IEGeneric var1) {
      if (EUtil.getOperation(var1, OperationType.LOG_EQ, OperationType.LOG_NEQ) != null) {
         ...
         if (this.pC(var2) && (this.pC(var3) || var3 instanceof IEImm)) {
            IEGeneric var13 = ((IESlice)var2).getWholeExpression();
            if (EUtil.isOperation(var13, OperationType.AND) && this.pC(var3)) {
            ...
            if (EUtil.isImmZero(var3) || this.pC(var3, var10, (IEGeneric)var12, var13, var7)) {
   ...
   private boolean pC(IEGeneric var1, IEGeneric var2, IEGeneric var3, IEGeneric var4, boolean var5) {
      ash var6 = new ash(this.ectx);
      IEGeneric var7 = EUtil.buildOverflowFlag(var2, var3, var4, var5);
      IEGeneric var8 = var6.pC(var7);
      IEGeneric var9 = var6.pC(var1.duplicate());
