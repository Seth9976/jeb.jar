...
public class ArmDecompilerPlugin extends AbstractNativeDecompilerPlugin {
   public ArmDecompilerPlugin() {
      super("dcmp_arm", 0.0);
   }

   @Override
   public IPluginInformation getPluginInformation() {
      return new PluginInformation(S.L("ARM Decompiler"), S.L("ARM 32-bit decompiler"), "PNF Software", Version.create(0, 0, 1));
   }
