...
public class Ws {
   public static boolean pC(byte[] var0) {
      return pC("X.509", var0);
   }

   public static boolean pC(String var0, byte[] var1) {
      try {
   ...
   public static String pC(Certificate var0) {
      ...
      if (var0 instanceof X509Certificate var2) {
         String var3 = Strings.ff(
            ...
            pC(var2.getPublicKey()),
            var2.getSigAlgName(),
            var2.getSigAlgOID(),
            Formatter.byteArrayToHexString(var2.getSignature())
         );
         var1.append(var3);
      } else {
      ...
      if (var7 != null) {
         CharSequence var8 = Formatter.byteArrayToHex(Hash.calculateMD5(var7));
         CharSequence var4 = Formatter.byteArrayToHex(Hash.calculateSHA1(var7));
         CharSequence var5 = Formatter.byteArrayToHex(Hash.calculateSHA256(var7));
   ...
   public static String pC(PublicKey var0) {
      StringBuilder var1 = new StringBuilder();
