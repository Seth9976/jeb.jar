...
@SerDisabled
public class Av extends AbstractTreeDocument {
   private Sv pC;
   private List A;
   ...
   public Av(Sv var1) {
      if (!var1.isProcessed()) {
         ...
         if (var2 == null) {
            ...
            this.A.add(new KVNode("Type", var2.getType()));
            if (var2 instanceof X509Certificate var4) {
               this.A.add(new KVNode("Version", var4.getVersion()));
               this.A.add(new KVNode("Serial Number", "0x" + var4.getSerialNumber().toString(16)));
               this.A.add(new KVNode("Subject", var4.getSubjectX500Principal()));
               KVNode var3;
               this.A.add(var3 = new KVNode("Validity"));
               var3.addChild(new KVNode("From", var4.getNotBefore()));
               var3.addChild(new KVNode("To", var4.getNotAfter()));
               this.A.add(var3 = new KVNode("Public Key"));
               ...
               this.A.add(var3 = new KVNode("Signature"));
               ...
               if (var12 != null) {
                  this.A.add(var3 = new KVNode("Fingerprints"));
               ...
               this.A.add(new KVNode("Details", var2.toString()));
            }
         }
      }
   }
   ...
   public String coordinatesToAddress(INodeCoordinates var1) {
      if (var1 != null && var1.getPath() != null && !var1.getPath().isEmpty()) {
         KVNode var2 = (KVNode)this.A.get((Integer)var1.getPath().get(0));
