...
import com.pnfsoftware.jebglobal.bpe;
import com.pnfsoftware.jebglobal.ckx;
import java.util.Map;

public class DexDecompilerIdentifier extends AbstractUnitIdentifier {
   private static final ILogger A = GlobalLog.getLogger(DexDecompilerIdentifier.class);
   public static final String pC = ckx.pC(new byte[]{7, 40, 38, 56, 28, 8, 11, 17, 7, 73, 91, 54, 71, 76, 94, 90, 82, 120, 73, 89}, 2, 87);
