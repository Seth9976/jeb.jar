...
public class MipsPlugin extends AbstractNativeDisassemblerPlugin {
   public MipsPlugin() {
      super("mips", 0.0);
   }
   ...
   static {
      ...
      ELFPluginsService.getInstance().addRelocationContext(cq.gp);
      ELFPluginsService.getInstance().addRelocationContext(cq.oT);
   }
}
