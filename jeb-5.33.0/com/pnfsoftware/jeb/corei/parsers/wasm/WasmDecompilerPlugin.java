...
public class WasmDecompilerPlugin extends AbstractNativeDecompilerPlugin {
   public WasmDecompilerPlugin() {
      super("dcmp_wasmbc", 0.0);
   }

   @Override
   public IPluginInformation getPluginInformation() {
      return new PluginInformation(S.L("WebAssembly Decompiler"), S.L("WebAssembly bytecode decompiler"), "PNF Software", Version.create(1, 1));
   }

   @Override
   public IEConverter getConverter(INativeCodeUnit var1) {
      Hv var2 = (Hv)var1.getParent();
      return new io(var2, var1);
   }
