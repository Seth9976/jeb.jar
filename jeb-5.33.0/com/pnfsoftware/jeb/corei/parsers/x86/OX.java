...
import com.pnfsoftware.jebglobal.cja;
import java.util.List;

@Ser
public class OX extends AbstractAnalyzerExtension {
   private static final ILogger kS = GlobalLog.getLogger(OX.class);
   @SerId(1)
   private long wS = -1L;
   @SerId(2)
   ...
   public ChainedOperationResult getTrampolineTarget(CFG var1) {
      if (var1.size() != 1) {
         ...
         if (var2.size() < 1) {
            ...
            if (var3.getProcessorMode() == 32 && var3.A.length == 6 && var3.A[0] == -1 && (var3.A[1] == -95 || var3.A[1] == -93)) {
               ICodeObjectUnit var4 = this.gca.getContainer();
               if (var4 == null) {
                  return ChainedOperationResult.continue_();
               }

               if (!this.UT && this.wS == -1L) {
                  ...
                  if (var5 != null) {
                     this.wS = var5.getOffsetInMemory() + this.getUnit().getVirtualImageBase();
               ...
               if (((a)this.gca).wS() != null) {
                  ISegmentInformation var7 = CodeObjectUnitUtil.findSectionByRelativeAddress(var4, var1.getEntryAddress() - ((a)this.gca).wS().NS());
                  if (var7 != null && !var7.getName().startsWith(".plt")) {
                     return ChainedOperationResult.continue_();
                  }

                  Av[] var6 = var3.A();
                  if (var6 != null && var6.length == 1 && var6[0].A()) {
                     return new ChainedOperationResult(new Pointer(this.wS + ((IInstructionOperandCMA)var6[0]).getMemoryDisplacement(), 0, 5));
                  }
               }
            }
   ...
   private long pC() {
      Vr var1 = ((a)this.gca).wS();
      ICodeObjectUnit var2 = this.gca.getContainer();
      long var3 = var1.NS();
      long var5 = var3;
      long var7 = var3 + var1.vP();
   ...
   public ChainedOperationResult pC(long var1, vh var3, IBasicBlockSkeleton var4) {
      if (this.pC == null) {
         this.pC = cja.pC(this.gca);
      }

      return this.pC != null && this.pC.pC(var1, var3, var4) ? ChainedOperationResult.TRUE_STOP : ChainedOperationResult.FALSE_CONTINUE;
   }

   @Override
   public ChainedOperationResult determineSwitchInformation(long var1, IBasicBlockSkeleton var3, List var4) {
      if (this.pC != null) {
         SwitchInformation var5 = this.pC.pC(var1, var3, var4);
         if (var5 != null) {
   ...
   public ChainedOperationResult postprocessImage(int var1) {
      ...
      try {
         if (this.A == null) {
            this.A = new wY(this.gca, ((a)this.gca).wS().ld());
         }
         ...
         kS.error(S.L("Tail call analyzer failed"));
