...
public class X64Plugin extends AbstractNativeDisassemblerPlugin {
   public X64Plugin() {
      super("x86_64", 0.0);
   }
   ...
   static {
      ...
      ELFPluginsService.getInstance().addRelocationContext(Sv.ah);
      ELFPluginsService.getInstance().addRelocationContext(Sv.eP);
      ELFPluginsService.getInstance().addRelocationContext(Sv.UO);
      ELFPluginsService.getInstance().addRelocationContext(Sv.Ab);
   }
}
