...
public class X64DecompilerPlugin extends AbstractNativeDecompilerPlugin {
   public X64DecompilerPlugin() {
      super("dcmp_x86_64", 0.0);
   }

   @Override
   public IPluginInformation getPluginInformation() {
      return new PluginInformation(S.L("x86-64 Decompiler"), S.L("Intel/AMD x86 64-bit (x64) decompiler"), "PNF Software", Version.create(0, 0, 1));
   }

   @Override
   public IEConverter getConverter(INativeCodeUnit var1) {
      return new Yd((Or)var1.getProcessor());
   }
