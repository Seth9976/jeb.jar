...
public class X86Plugin extends AbstractNativeDisassemblerPlugin {
   public X86Plugin() {
      super("x86", 0.0);
   }
   ...
   static {
      ...
      ELFPluginsService.getInstance().addRelocationContext(Pt.ED);
      ELFPluginsService.getInstance().addRelocationContext(Pt.Sc);
      ELFPluginsService.getInstance().addRelocationContext(Pt.eP);
      ELFPluginsService.getInstance().addRelocationContext(Pt.UO);
      ELFPluginsService.getInstance().addRelocationContext(Pt.ah);
   }
}
