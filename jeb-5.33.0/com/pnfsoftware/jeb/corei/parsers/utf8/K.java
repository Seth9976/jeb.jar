...
@SerDisabled
public class K extends AbstractTextDocument {
   ...
   public ITextDocumentPart getDocumentPart(long var1, int var3, int var4) {
      ...
      if (var5 >= 0 && var3 >= 0 && var4 >= 0) {
         pC.info("Requesting lines: id=%d, after=%d, before=%d", var5, var3, var4);
