...
public class Av extends AbstractBinaryUnit implements IDataProvider, IArchiveUnit {
   private static final ILogger pC = GlobalLog.getLogger(com.pnfsoftware.jeb.corei.parsers.sevenzip.Av.class);
   ...
   public byte[] getDataBytes(String param1, int param2) {
      ...
      // 03: dup
      // 04: aload 0
      // 05: invokevirtual com/pnfsoftware/jeb/corei/parsers/sevenzip/Av.getInput ()Lcom/pnfsoftware/jeb/core/input/IInput;
      ...
      // 46: iinc 4 1
      // 49: goto 14
      // 4c: new com/pnfsoftware/jeb/corei/parsers/sevenzip/Sv
      // 4f: dup
      // 50: aload 0
      // 51: aload 3
      // 52: invokespecial com/pnfsoftware/jeb/corei/parsers/sevenzip/Sv.<init> (Lcom/pnfsoftware/jeb/corei/parsers/sevenzip/Av;Lorg/apache/commons/compress/archivers/sevenz/SevenZFile;)V
      // 55: astore 6
      // 57: aload 6
      ...
      // 7f: athrow
      // 80: astore 6
      // 82: getstatic com/pnfsoftware/jeb/corei/parsers/sevenzip/Av.pC Lcom/pnfsoftware/jeb/util/logging/ILogger;
      // 85: aload 6
      ...
      // aa: athrow
      // ab: astore 3
      // ac: getstatic com/pnfsoftware/jeb/corei/parsers/sevenzip/Av.pC Lcom/pnfsoftware/jeb/util/logging/ILogger;
      // af: aload 3
   ...
   protected boolean processInternal() {
      try {
         LazyDataContainerUnit.register(this, new com.pnfsoftware.jeb.corei.parsers.sevenzip.Av.Av().pC());
         return true;
   ...
   class Av extends cku {
      public Collection pC() throws IOException {
         ...
         SevenZFile var2 = new SevenZFile(Av.this.getInput().getChannel());
         ...
         try {
            while (true) {
               try {
                  ...
                  this.pC(var4, var5);
                  this.pC(var1, Arrays.asList(var7), var3.isDirectory());
               } catch (IOException var9) {
                  com.pnfsoftware.jeb.corei.parsers.sevenzip.Av.pC.catching(var9);
                  break;
               }
            }
