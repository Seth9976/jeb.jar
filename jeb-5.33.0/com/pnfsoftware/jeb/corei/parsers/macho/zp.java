...
import com.pnfsoftware.jebglobal.ceq;
import com.pnfsoftware.jebglobal.cer;
import com.pnfsoftware.jebglobal.ces;
import com.pnfsoftware.jebglobal.cet;
import com.pnfsoftware.jebglobal.ceu;
import com.pnfsoftware.jebglobal.cev;
...
@Ser
public class zp extends AbstractCodeObjectUnit {
   private static final ILogger ah = GlobalLog.getLogger(zp.class);
   @SerId(1)
   rQ pC;
   @SerId(2)
   ...
   public zp(String var1, IInput var2, IUnitProcessor var3, IUnitCreator var4, IPropertyDefinitionManager var5) {
   ...
   protected boolean processInternal() {
      ...
      try (SeekableByteChannel var1 = this.getInput().getChannel()) {
         ...
         var1.position(0L);
         this.kS = var2 == -17958193 || var2 == -805638658;
         this.wS = var2 != -17958194 && var2 != -17958193 ? Endianness.BIG_ENDIAN : Endianness.LITTLE_ENDIAN;
         int var3 = this.kS ? 32 : 28;
         ByteBuffer var4 = ByteBuffer.allocate(var3).order(this.wS.toByteOrder());
         if (var1.read(var4) != var3) {
            return false;
         }

         var4.rewind();
         this.pC = rQ.pC(var4, this.kS);
         if (this.pC.wS != 2 && this.pC.wS != 6 && this.pC.wS != 8) {
            throw new RuntimeException(Strings.ff("TBI: filetype %d", this.pC.wS));
         }

         for (int var5 = 0; var5 < this.pC.UT; var5++) {
            long var6 = var1.position();
            int var8 = ChannelUtil.getInt(var1, var6, this.wS.toByteOrder());
            int var9 = ChannelUtil.getInt(var1, var6 + 4L, this.wS.toByteOrder());
            if (this.kS && var9 % 8 != 0 || !this.kS && var9 % 4 != 0) {
               Object[] var67 = new Object[0];
            }

            var1.position(var6);
            var4 = ByteBuffer.allocate(var9).order(this.wS.toByteOrder());
            ...
            switch (var8) {
               ...
               case 34:
                  Av var62 = Av.pC(var4);
                  if (!this.pC(var62, this.ED, false)) {
                     return false;
                  }

                  if (!this.pC(var62, this.ED, true)) {
                     return false;
                  }

                  if (!this.A(var62, this.ED)) {
                     return false;
                  }

                  if (!this.pC(var62, this.ED)) {
                     return false;
                  }
               ...
               case 1:
                  ...
                  int var11 = this.kS(var10.ld);
                  String var12 = Strings.decodeASCII(var10.kS).trim();
                  SegmentInformation var13 = new SegmentInformation(var12, var10.E, var10.sY, var10.wS - this.ys, var10.UT, var11);
                  ...
                  this.ld = Longs.maxUnsigned(var10.wS + var10.UT & 4294967295L, this.ld);
                  if (var12.equals("__TEXT")) {
                     if (this.UT != -1L) {
                        throw new RuntimeException("TBI: multiple __TEXT segments");
                     }

                     this.UT = var10.wS & 4294967295L;
                  }

                  if (var10.gp > 255) {
                     this.addNotification(
                        new UnitNotification(NotificationType.WARNING, Strings.ff(S.L("Mach-O file: number of sections is more than %d (%d)"), 255, var10.gp))
                     );
                  }

                  for (int var44 = 0; var44 < var10.gp; var44++) {
                     RC var46 = RC.pC(var4);
                     if ((var46.ld & 0xFF) == 6) {
                        this.WR.add(var46);
                     }
                     ...
                     String var47 = Strings.ff("%s", Strings.decodeASCII(var46.pC).trim());
                     SegmentInformation var49 = new SegmentInformation(var47, var46.UT, var46.wS, var46.kS - this.ys, var46.wS, var11);
                     this.addSection(var49);
                     var73 = new Object[]{var49};
                     if (this.pC(var46, var47, var12)) {
                        var73 = new Object[0];
                        this.NS.add(var49);
                     }

                     if (this.Sc && ceq.A(var46, var47)) {
                        var73 = new Object[0];
                        this.vP.add(var46);
                     }
                  }
                  ...
                  if (var12.equals("__TEXT")) {
                     long var45 = this.getSection(0).getOffsetInMemory() - this.UT;
                     SegmentInformation var48 = new SegmentInformation("<hdr>", 0L, var45, this.UT, var45, 3);
               ...
               case 5:
                  switch (this.pC.A) {
                     case 7:
                        GK var53 = GK.pC(var4);
                        if (var53.kS != 1) {
                           throw new RuntimeException(Strings.ff("TBI: x86 flavor %d", var53.kS));
                        }

                        this.sY = var53.vP & 4294967295L;
                        this.A.add(var53);
                        break label386;
                     case 12:
                        vi var58 = vi.pC(var4);
                        if (var58.kS != 1) {
                           throw new RuntimeException(Strings.ff("TBI: ARM32 flavor %d", var58.kS));
                        }

                        this.sY = var58.ys & 4294967295L;
                        this.A.add(var58);
                        break label386;
                     case 16777223:
                        Mh var56 = Mh.pC(var4);
                        if (var56.kS != 4) {
                           throw new RuntimeException(Strings.ff("TBI: x86-64 flavor %d", var56.kS));
                        }
                     ...
                     case 16777228:
                        p var59 = p.pC(var4);
                        if (var59.kS != 6) {
                           throw new RuntimeException(Strings.ff("TBI: ARM64 flavor %d", var59.kS));
                        }
                        ...
                        break label386;
                     default:
                        ah.error(S.L("NOT IMPLEMENTED: LC_UNIXTHREAD with %s cpu type"), this.pC.A);
                        break label386;
                  }
               case 11:
                  Sv var27 = Sv.pC(var4);
                  if (!this.gp && !this.pC(var27, this.ED)) {
                     return false;
                  }
               ...
               case 25:
                  ...
                  qt var14 = qt.pC(var4);
                  if (var14.UT % 4096L != 0L) {
                     var14.UT &= -4096L;
                     var14.UT += 4096L;
                  }

                  if (var14.sY % 4096L != 0L) {
                     var14.sY &= -4096L;
                     var14.sY += 4096L;
                  }

                  int var15 = this.kS(var14.ld);
                  String var16 = Strings.decodeASCII(var14.kS).trim();
                  SegmentInformation var17 = new SegmentInformation(var16, var14.E, var14.sY, var14.wS - this.ys, var14.UT, var15);
                  ...
                  this.ld = Longs.maxUnsigned(var14.wS + var14.UT, this.ld);
                  ...
                  if (var14.gp > 255) {
                     this.addNotification(
                        new UnitNotification(NotificationType.WARNING, Strings.ff(S.L("Mach-O file: number of sections is more than %d (%d)"), 255, var14.gp))
                     );
                  }

                  for (int var18 = 0; var18 < var14.gp; var18++) {
                     sy var52 = sy.pC(var4);
                     if ((var52.ld & 0xFF) == 6) {
                        this.WR.add(var52);
                     }
                     ...
                     String var54 = Strings.ff("%s", Strings.decodeASCII(var52.pC).trim());
                     SegmentInformation var57 = new SegmentInformation(var54, var52.UT, var52.wS, var52.kS - this.ys, var52.wS, var15);
                     this.addSection(var57);
                     var68 = new Object[]{var57};
                     if (this.pC(var52, var54, var16)) {
                        var68 = new Object[0];
                        this.NS.add(var57);
                     }

                     if (this.Sc && ceq.A(var52, var54)) {
                        var68 = new Object[0];
                        this.vP.add(var52);
                     }
                  }
                  ...
                  if (var16.equals("__TEXT")) {
                     long var50 = this.getSection(0).getOffsetInMemory() - this.UT;
                     SegmentInformation var55 = new SegmentInformation("<hdr>", 0L, var50, this.UT, var50, 3);
               ...
               case 38:
                  cq var19 = cq.pC(var4);
                  BytesInput var20 = new BytesInput(this.getInput(), var19.kS, var19.wS);
                  ...
                  while (true) {
                     ...
                     var22 += var24;
                     SymbolInformation var26 = new SymbolInformation(SymbolType.FUNCTION, 0, 0L, null, 0L, var22 + this.UT - this.ys, 0L);
      ...
      if (this.ld == -1L) {
         ...
         var36.setFlags(0);
         var36.setTargetProcessor(this.A(this.pC.A));
         var36.setEndianness(this.wS);
         var36.setWordSize(this.kS ? 64 : 32);
         var36.setImageBase(this.ys);
         var36.setImageSize(this.ld - this.ys);
         if (this.UT != -1L && this.E != -1L) {
            var36.setEntryPoint(this.UT + this.E - this.ys);
            if (this.sY != -1L) {
               throw new RuntimeException("TBI: multiple entry points");
            }
         } else if (this.sY != -1L) {
            var36.setEntryPoint(this.sY - this.ys);
         }

         this.setLoaderInformation(var36.build());
         if (this.xC) {
            try {
               String var37 = this.pC(this.pC.A);
               if (var37 != null) {
   ...
   private boolean A() throws IOException {
      try (SeekableByteChannel var1 = this.getInput().getChannel()) {
         for (bO var3 : this.vP) {
            String var4 = Strings.ff("%s", Strings.decodeASCII(var3.pC()).trim());
            if (!var4.equals("__objc_classlist") && !var4.equals("__objc_nlclslist")) {
               if (var4.equals("__objc_catlist") || var4.equals("__objc_nlcatlist")) {
                  for (long var14 = var3.kS(); var14 < var3.kS() + var3.E(); var14 += this.kS ? 8L : 4L) {
                     long var16 = this.kS
                        ? ChannelUtil.getLong(var1, var14, this.wS.toByteOrder())
                        : ChannelUtil.getInt(var1, var14, this.wS.toByteOrder()) & 4294967295L;
                     if (!this.pC(var1, var16 - this.UT)) {
                        return false;
                     }
                  }
               }
            } else {
               for (long var5 = var3.kS(); var5 < var3.kS() + var3.E(); var5 += this.kS ? 8L : 4L) {
                  long var7 = this.kS
                     ? ChannelUtil.getLong(var1, var5, this.wS.toByteOrder())
                     : ChannelUtil.getInt(var1, var5, this.wS.toByteOrder()) & 4294967295L;
                  if (!this.pC(var1, var7 - this.UT, false)) {
                     return false;
                  }

                  long var9 = this.kS
                     ? ChannelUtil.getLong(var1, var7 - this.UT, this.wS.toByteOrder())
                     : ChannelUtil.getInt(var1, var7 - this.UT, this.wS.toByteOrder()) & 4294967295L;
                  if (!this.pC(var1, var9 - this.UT, true)) {
                     return false;
                  }
               }
            }
            ...
            if (ceq.pC(var3, var4)) {
               long var15 = var3.UT() - this.ys;

               for (long var17 = var15; var17 < var15 + var3.E(); var17 += this.kS ? 8L : 4L) {
                  this.addSymbol(new SymbolInformation(SymbolType.PTROBJECT, 0, 0L, null, 0L, var17, this.kS ? 8L : 4L));
               }
            }
         }
      }
   ...
   private boolean pC(SeekableByteChannel var1, long var2) throws IOException {
      var1.position(var2);
      ByteBuffer var4 = ByteBuffer.allocate(48).order(this.wS.toByteOrder());
      if (var1.read(var4) != 48) {
         return false;
      } else {
         var4.rewind();
         cer var5 = cer.pC(var4);
         if (var5.pC == 0L) {
            return false;
         } else {
            return var5.kS != 0L && !this.pC(var1, var5.kS - this.UT, null, false) ? false : var5.wS == 0L || this.pC(var1, var5.wS - this.UT, null, false);
         }
      }
   }

   private boolean pC(SeekableByteChannel var1, long var2, boolean var4) throws IOException {
      var1.position(var2);
      int var5 = this.kS ? 40 : 20;
      ByteBuffer var6 = ByteBuffer.allocate(var5).order(this.wS.toByteOrder());
      if (var1.read(var6) != var5) {
         return false;
      } else {
         var6.rewind();
         ces var7 = ces.pC(var6, this.kS);
         if (var7.UT == 0L) {
            return true;
         } else {
            long var8 = var7.UT - this.UT;
            int var10 = this.kS ? 88 : 80;
            var6 = ByteBuffer.allocate(var10).order(this.wS.toByteOrder());
            var1.position(var8);
            if (var1.read(var6) != var10) {
               return false;
            } else {
               var6.rewind();
               cet var11 = cet.pC(var6, this.kS);
               if (var11.E == 0L) {
                  return false;
               } else if (var11.E - this.UT < 0L) {
                  return false;
               } else {
                  String var12 = this.A(var11.E - this.UT);
                  if (var11.sY != 0L) {
                     long var13 = var11.sY - this.UT;
                     if (var13 < 0L) {
                        return false;
                     }

                     if (!this.pC(var1, var13, var12, var4)) {
                        return false;
                     }
                  }
   ...
   private boolean pC(SeekableByteChannel var1, long var2, String var4, boolean var5) throws IOException {
      ByteBuffer var6 = ByteBuffer.allocate(8).order(this.wS.toByteOrder());
      var1.position(var2);
      if (var1.read(var6) != 8) {
         return false;
      } else {
         var6.rewind();
         cev var7 = cev.pC(var6);
         long var8 = var2 + 8L;
         int var10 = this.kS ? 24 : 12;
         var6 = ByteBuffer.allocate(var10).order(this.wS.toByteOrder());

         for (int var11 = 0; var11 < var7.A; var11++) {
            var1.position(var8);
            if (var1.read(var6) != var10) {
               return false;
            }
            ...
            if (var4 != null) {
               ...
               var13.append(var4);
               var13.append(" ");
               var13.append(this.A(var12.pC - this.UT));
               var13.append("]");
            }

            this.addSymbol(new SymbolInformation(SymbolType.FUNCTION, 0, 0L, var4 != null ? var13.toString() : null, 0L, var12.kS, 0L));
            var8 += var10;
            var6.rewind();
         }
   ...
   private boolean pC(bO var1, String var2, String var3) {
      if (var3.equals("__DATA")) {
         return true;
      } else {
         int var4 = var1.A() & 0xFF;
         switch (var4) {
            case 1:
            case 2:
            case 3:
   ...
   private boolean pC(long var1) {
      ...
      for (ISegmentInformation var5 : this.getValidSections()) {
         if (Longs.compareUnsigned(var1 - this.ys, var5.getOffsetInMemory()) >= 0
            && Longs.compareUnsigned(var1 - this.ys, var5.getOffsetInMemory() + var5.getSizeInMemory()) < 0) {
            var3 = var5;
            break;
         }
      }

      return var3 == null ? true : this.NS.contains(var3);
   }

   private boolean pC(Sv var1, boolean var2) throws IOException {
      if (var1.xC == 0) {
         return true;
      } else {
         try (SeekableByteChannel var3 = this.getInput().getChannel()) {
            ...
            for (bO var6 : var4) {
               ...
               for (int var13 = this.kS ? 8 : 4; var9 < var6.kS() + var6.E(); var9 += var13) {
                  int var14 = ChannelUtil.getInt(var3, var1.vP + var8, this.wS.toByteOrder());
                  if (var14 != Integer.MIN_VALUE && var14 != -1073741824) {
                     if (var14 < 0 || var14 >= this.oT.size()) {
                        throw new RuntimeException("Invalid segment index");
                     }

                     if (var2) {
                        Object[] var10000 = new Object[]{this.oT.get(var14)};
                     }

                     this.pC((String)this.oT.get(var14), var11, var13);
                  }
   ...
   private boolean pC(Av var1, boolean var2) throws IOException {
      if (var1.fI == 0) {
         return true;
      } else {
         boolean var4;
         try (SeekableByteChannel var3 = this.getInput().getChannel()) {
            ...
            var4 = this.pC(var3, var1.oT, var1.oT, "", var2);
         }
   ...
   private boolean pC(SeekableByteChannel var1, long var2, long var4, String var6, boolean var7) throws IOException {
      if (var7) {
      ...
      if (var8 != 0) {
         ...
         if (this.pC(this.UT + var12)) {
            this.addSymbol(new SymbolInformation(SymbolType.OBJECT, 2, 0L, var6, 0L, this.UT + var12, 0L));
         } else {
            this.addSymbol(new SymbolInformation(SymbolType.FUNCTION, 2, 0L, var6, 0L, this.UT + var12, 0L));
         }
      }
      ...
      if (var27 == 0) {
         ...
         for (byte var13 = 0; var13 < var27; var13++) {
            ...
            if (!this.pC(var1, var2, var2 + var15, var6.concat(var31), var7)) {
               return false;
            }
         }
   ...
   private boolean pC(Av var1, boolean var2, boolean var3) throws IOException {
      if (var2) {
         if (var3) {
            Object[] var10000 = new Object[0];
         } else {
      ...
      try (SeekableByteChannel var4 = this.getInput().getChannel()) {
         String var5 = null;
         long var9 = 0L;
         long var15 = var3 ? var1.sY : var1.UT;
         long var17 = var3 ? var1.ys : var1.E;
         int var19 = this.kS ? 8 : 4;
         long var20 = var15;
         boolean var22 = false;
         ...
         while (!var22 && var20 != var15 + var17) {
            ...
            switch (var24) {
               case -128:
                  ...
                  break;
               case -112:
                  this.pC(var5, var9 - this.ys, var19);
                  var9 += var19;
                  if (var2) {
   ...
   private boolean pC(String var1, long var2, int var4) {
      return ceq.pC(var1)
   ...
   private boolean A(Av var1, boolean var2) throws IOException {
      if (var2) {
         Object[] var10000 = new Object[0];
      }
      ...
      if (var1.gp == 0) {
         ...
         try (SeekableByteChannel var3 = this.getInput().getChannel()) {
            String var4 = null;
            long var8 = 0L;
            int var14 = this.kS ? 8 : 4;
            long var15 = var1.ld;
            boolean var17 = false;

            while (!var17 && var15 != var1.ld + var1.gp) {
               ...
               switch (var19) {
                  case -128:
                     ...
                     var8 += var28.value;
                     if (var2) {
                        Object[] var42 = new Object[]{var15 - var1.ld - 1L, var28.value};
                     }
                     ...
                     break;
                  case -112:
                     this.pC(var4, var8 - this.ys, var14);
                     var8 += var14;
                     if (var2) {
                        Object[] var41 = new Object[]{var15 - var1.ld - 1L};
                     }
                     break;
                  case -96:
                  case -80:
                  ...
                  case 0:
                     if (var2) {
                        Object[] var40 = new Object[]{var15 - var1.ld - 1L};
                     }
                     break;
                  case 16:
                     long var32 = var20;
                     if (var2) {
                        Object[] var39 = new Object[]{var15 - var1.ld - 1L, var32};
                     }
                     break;
                  case 32:
                     ...
                     if (var2) {
                        Object[] var38 = new Object[]{var15 - var1.ld - 1L, var31};
                     }
                  ...
                  case 48:
                     long var10 = var20;
                     if (var2) {
                        Object[] var37 = new Object[]{var15 - var1.ld - 1L, var10};
                     }
                     break;
                  case 64:
                     var4 = this.A(var15);
                     ...
                     if (var2) {
                        Object[] var36 = new Object[]{var15 - var1.ld - 1L, var20, var4};
                     }
                  ...
                  case 80:
                     ...
                     if (var2) {
                        Object[] var35 = new Object[]{var15 - var1.ld - 1L, var20};
                     }
                     break;
                  case 96:
                     ...
                     if (var2) {
                        Object[] var34 = new Object[]{var15 - var1.ld - 1L, var12};
                     }
                  ...
                  case 112:
                     ...
                     if (var2) {
                        Object[] var33 = new Object[]{var15 - var1.ld - 1L, Integer.valueOf(var20), var26.value};
                     }
   ...
   private boolean pC(oP var1, boolean var2) throws IOException {
      if (var1.wS == 0) {
         return true;
      } else {
         try (SeekableByteChannel var3 = this.getInput().getChannel()) {
            var3.position(var1.kS);
            int var4 = 0;

            while (var4 < var1.wS) {
               int var5 = this.kS ? 16 : 12;
               ByteBuffer var6 = ByteBuffer.allocate(var5).order(this.wS.toByteOrder());
               ...
               if (var7 == 0) {
                  ...
                  var21 = this.A((long)(var1.UT + var7));
               }
               ...
               if ((var8 & 224) != 0) {
                  ...
                  switch (var8 & 0xFF) {
                     ...
                     case 36:
                        if (!var21.isEmpty()) {
                           this.addSymbol(new SymbolInformation(SymbolType.OBJECT, 0, 0L, var21, 0L, var11 - this.ys, 0L));
                        }
   ...
   private ProcessorType A(int var1) {
      switch (var1) {
         case 7:
