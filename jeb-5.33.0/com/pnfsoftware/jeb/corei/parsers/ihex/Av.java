...
@Ser
public class Av extends AbstractCodeObjectUnit {
   private static final ILogger UT = GlobalLog.getLogger(Av.class);
   @SerId(1)
   ProcessorType pC;
   @SerId(2)
   byte[] A;
   ...
   protected boolean processInternal() {
      ...
      this.pC = ProcessorUtil.fromArchName(var1);
      this.wS = this.getPropertyManager().getBoolean("BigEndian") ? Endianness.BIG_ENDIAN : Endianness.LITTLE_ENDIAN;
      this.kS = Conversion.stringToInt(this.getPropertyManager().getString("WantedWordsize"));
      long var2 = Conversion.stringToLong(this.getPropertyManager().getString("WantedImageBase"), -1L);
      if (this.pC != null && this.pC.isIntel()) {
         this.wS = Endianness.LITTLE_ENDIAN;
      }
         ...
         try (InputStream var5 = this.getInput().getStream()) {
            ...
            while (var7.pC()) {
               ...
               switch (var14.pC()) {
                  ...
                  case 2:
                     var11 = true;
                     var9 = EndianUtil.bigEndianBytesToShort(var14.A());
                     var9 <<= 4;
                     break;
                  case 3:
                     if (var12 != null) {
                     ...
                     long var15 = EndianUtil.bigEndianBytesToShort(var14.A()) & 65535L;
                     long var17 = EndianUtil.bigEndianBytesToShort(var14.A(), 2) & 65535L;
                  ...
                  case 5:
                     ...
                     var12 = EndianUtil.bigEndianBytesToInt(var14.A()) & 4294967295L;
                     break;
                  default:
                     this.addNotification(new UnitNotification(NotificationType.UNSUPPORTED_FEATURE, Strings.ff(S.L("Unknown record type: %d"), var14.pC())));
               }
            }
            ...
            var30.setWordSize(this.kS);
            var30.setEndianness(this.wS);
            long var31 = this.pC();
            if (var2 != -1L && var31 != var2) {
               UT.warn(S.L("Image base was determined to be: 0x%X. It is overridden to be: 0x%X"), var31, var2);
               var31 = var2;
            }

            var30.setImageBase(var31);
            var30.setEntryPoint(0L);
            var30.setImageSize(this.A() - var31);
            ...
            if (this.pC == null) {
               ...
               try {
                  String var33 = ProcessorUtil.toWellKnownUnitType(this.pC);
                  if (var33 != null) {
