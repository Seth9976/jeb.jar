...
public class TarIdentifier extends AbstractUnitIdentifier {
      ...
      if (var1 == null) {
         ...
         if (var5.limit() < 512) {
            ...
            if (var6[99] != 0) {
               ...
               return !pC(var6, 100, 8) || !pC(var6, 108, 8) || !pC(var6, 116, 8) ? false : pC(var6, 136, 12);
            }
         }
      }
   }

   private static boolean pC(byte[] var0, int var1, int var2) {
   ...
   private static byte[] pC(ByteBuffer var0) {
