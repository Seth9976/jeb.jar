...
public class Av extends AbstractBinaryUnit implements IDataProvider, IArchiveUnit {
   private static final ILogger pC = GlobalLog.getLogger(com.pnfsoftware.jeb.corei.parsers.tar.Av.class);
   ...
   public byte[] getDataBytes(String param1, int param2) {
      ...
      // 03: dup
      // 04: aload 0
      // 05: invokevirtual com/pnfsoftware/jeb/corei/parsers/tar/Av.getInput ()Lcom/pnfsoftware/jeb/core/input/IInput;
      ...
      // a7: areturn
      // a8: astore 6
      // aa: getstatic com/pnfsoftware/jeb/corei/parsers/tar/Av.pC Lcom/pnfsoftware/jeb/util/logging/ILogger;
      // ad: aload 6
      ...
      // d2: athrow
      // d3: astore 3
      // d4: getstatic com/pnfsoftware/jeb/corei/parsers/tar/Av.pC Lcom/pnfsoftware/jeb/util/logging/ILogger;
      // d7: aload 3
   ...
   protected boolean processInternal() {
      try {
         LazyDataContainerUnit.register(this, new com.pnfsoftware.jeb.corei.parsers.tar.Av.Av().pC());
         return true;
   ...
   class Av extends cku {
      public Collection pC() throws IOException {
         ...
         TarArchiveInputStream var2 = new TarArchiveInputStream(Av.this.getInput().getStream());
         ...
         try {
            while (true) {
               try {
                  ...
                  if (var5 != null && var5.equals("Truncated TAR archive") && Av.this.getInput().getCurrentSize() > 4294967295L) {
                     com.pnfsoftware.jeb.corei.parsers.tar.Av.pC.catchingSilent(var9);
                  } else {
                     com.pnfsoftware.jeb.corei.parsers.tar.Av.pC.catching(var9);
                  }
                  break;
               }
            }
