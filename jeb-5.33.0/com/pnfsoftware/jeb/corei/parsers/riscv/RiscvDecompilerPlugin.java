...
public class RiscvDecompilerPlugin extends AbstractNativeDecompilerPlugin {
   public RiscvDecompilerPlugin() {
      super("dcmp_riscv", 0.0);
   }

   @Override
   public IPluginInformation getPluginInformation() {
      return new PluginInformation(S.L("RISC-V Decompiler"), S.L("RV32I/RV64I decompiler"), "PNF Software", Version.create(0, 0, 1));
   }

   @Override
   public IEConverter getConverter(INativeCodeUnit var1) {
      return new Sv((sy)var1.getProcessor());
   }
