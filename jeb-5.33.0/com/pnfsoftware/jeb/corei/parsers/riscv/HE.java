...
public class HE extends AbstractRegisterBank2 {
   ...
   public static final HE kS = new HE(32, 64);
   public static final HE wS = new HE(64, 64);
   ...
   public HE(int var1, int var2) {
      ...
      for (int var3 = 0; var3 <= 31; var3++) {
         RegisterDescriptionEntry var4 = add(this.entries, var1, "x" + var3, pC[var3]).grp(0, var3);
         if (var3 == 2) {
      ...
      for (int var5 = 0; var5 <= 31; var5++) {
         this.add(var2, "f" + var5, A[var5]).grp(2, var5);
      }
