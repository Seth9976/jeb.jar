...
class oP extends AbstractCommandHandler {
   oP(K var1, ICommandManager var2, String var3, String var4) {
   ...
   public ExecutionResult execute(List var1) {
      ...
      return var2 == null ? K.pC : ExecutionResult.fromBoolean(var2.stepInto());
   }
}
