...
class qt extends AbstractCommandHandler {
   qt(K var1, ICommandManager var2, String var3, String var4) {
   ...
   public ExecutionResult execute(List var1) {
      if (var1.isEmpty()) {
         IDebuggerThread var4 = this.pC.UT.getDefaultThread();
         if (var4 == null) {
            return K.pC;
         } else {
         ...
         return !this.pC.UT.setDefaultThread(var2) ? ExecutionResult.error(S.L("Cannot set the default thread")) : ExecutionResult.GENERIC_SUCCESS;
      }
   }
}
