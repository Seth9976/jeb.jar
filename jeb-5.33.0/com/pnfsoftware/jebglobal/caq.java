...
public class caq extends AbstractDOptimizer {
   public boolean pC;
   boolean A = true;
   boolean kS = true;
         ...
         while (var12 < this.cfg.size()) {
            ...
            if (var13.size() == 1 && (var14 = (IDInstruction)var13.get(0)).isNop()) {
               ...
               for (BasicBlock var11 : var6.getInputBlocks()) {
                  this.pC((IDInstruction)var11.getLast(), var8, var9);
               }
   ...
   private void pC(IDInstruction var1, int var2, int var3) {
