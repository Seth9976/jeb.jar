...
public class blz extends AbstractJOptimizer {
   @Override
   public int perform() {
   ...
   int pC(IJavaBlock var1) {
      ...
      for (int var3 = 0; var3 < var1.size(); var3++) {
         ...
         if (var4 instanceof IJavaWhile && ((IJavaWhile)var4).getPredicate().isLitteralTrue() && this.pC((IJavaWhile)var4, var1, var3)) {
            var2++;
         }
   ...
   private boolean pC(IJavaWhile var1, IJavaBlock var2, int var3) {
