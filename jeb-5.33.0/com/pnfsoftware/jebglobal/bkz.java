...
public class bkz extends AbstractJBlockOptimizer {
   @Override
   public int optimizeBlock(IJavaBlock var1, IJavaElement var2) {
      int var3 = 0;

      for (int var4 = 0; var4 < var1.size(); var4++) {
         if (var1.get(var4) instanceof IJavaDoWhile var6 && JUtil.getFirstRealStatement(var1, var4 + 1) instanceof IJavaLabel var8 && this.pC(var6, var8)) {
            var3++;
         }
      }
   ...
   private boolean pC(IJavaDoWhile var1, IJavaLabel var2) {
