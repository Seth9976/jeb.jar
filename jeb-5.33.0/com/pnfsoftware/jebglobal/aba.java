...
public class aba extends YA {
   ...
   public boolean pC(INativeCodeUnit var1) {
      ...
      return var2 == null ? false : CodeObjectUnitUtil.findSegmentByName(var2, ".vmp0") != null || CodeObjectUnitUtil.findSegmentByName(var2, ".vmp1") != null;
   }
}
