...
public class brc {
   ...
   public boolean pC(IDInstruction var1, IDInstruction var2) {
      ...
      if (var3 != var4) {
         ...
         return this.pC(var1.getOperand1(), var2.getOperand1(), var5) && this.pC(var1.getOperand2(), var2.getOperand2(), false);
      }
   }

   private boolean pC(IDElement var1, IDElement var2) {
      return this.pC(var1, var2, false);
   }

   private boolean pC(IDElement var1, IDElement var2, boolean var3) {
      if (var1 == null) {
         return var2 == null;
      } else if (var2 == null) {
         return false;
         ...
         return this.pC(var9, (IDExpression)var2, var3);
         ...
         if (!var4.getCases().equals(var5.getCases())) {
            ...
            for (Object var7 : var4.getCases()) {
               if (!this.pC(var4.getTargetForCase(var7), var5.getTargetForCase(var7))) {
                  return false;
               }
            }
   ...
   private boolean pC(IDExpression var1, IDExpression var2, boolean var3) {
      if (var1 == null) {
         return var2 == null;
      } else if (var2 == null) {
         return false;
         ...
         if (this.pC == null) {
            return var17 == var19;
         } else if (var17 == var19 || var3 || this.pC.containsKey(var17) && this.pC.containsValue(var19)) {
            Integer var21 = (Integer)this.pC.get(var17);
            if (var21 == null) {
               this.pC.put(var17, var19);
            } else if (var21 != var19) {
               return false;
            }
         ...
         return !this.pC(var11.getArray(), var16.getArray()) ? false : this.pC(var11.getIndex(), var16.getIndex());
      } else if (var1 instanceof IDInstanceField var10) {
         IDInstanceField var15 = (IDInstanceField)var2;
         return !this.pC(var10.getInstance(), var15.getInstance()) ? false : this.pC(var10.getIndex(), var15.getIndex());
         ...
         if (!Objects.equals(var9.getOperator(), var14.getOperator())) {
            return false;
         } else if (!this.pC(var9.getOperand1(), var14.getOperand1())) {
            return false;
         } else {
            return !this.pC(var9.getOperand2(), var14.getOperand2()) ? false : this.pC(var9.getCondPredicate(), var14.getCondPredicate());
         }
         ...
         if (var8.getInvokeType() != var13.getInvokeType()) {
            ...
            if (var18 != var13.getCountOfArguments()) {
               ...
               for (int var20 = 0; var20 < var18; var20++) {
                  if (!this.pC(var8.getArgument(var20), var13.getArgument(var20))) {
                     return false;
                  }
               }
         ...
         if (!var4.getType().equals(var5.getType())) {
            return false;
         } else if (!this.pC(var4.getSize(), var5.getSize())) {
            return false;
         } else {
            ...
            if (var6 != var5.getCountOfInitialValues()) {
               ...
               for (int var7 = 0; var7 < var6; var7++) {
                  if (!this.pC(var4.getInitialValue(var7), var5.getInitialValue(var7))) {
                     return false;
                  }
               }
