...
public class agm extends AbstractCElementOptimizer {
   private static final StructuredLogger pC = aco.pC(agm.class);
   ...
   protected ICElement optimizeElement(ICElement var1, ICElement var2) {
      if (!(var1 instanceof ICOperation var3)) {
         ...
         ICExpression var4 = this.pC(var3, var2);
         if (var4 != null) {
            return var4;
         } else {
            ...
            if (var9 != null) {
               ...
               var4 = this.kS(var3, var2);
               if (var4 != null) {
                  if (var4 instanceof ICOperation) {
                     ICExpression var14 = this.pC((ICOperation)var4, var2);
                     if (var14 != null) {
                        return var14;
                     }
                  }
   ...
   private ICExpression pC(ICOperation var1, ICElement var2) {
      ICExpression var3 = this.A(var1, var2);
      if (var3 != null) {
         return var3;
      } else {
   ...
   private ICExpression A(ICOperation var1, ICElement var2) {
      if (CUtil.isIntegerConstant(var1.getFirstOperand())
         ...
         if (add.pC(var1) || CUtil.isOperation(var1, COperatorType.LOG_AND, COperatorType.LOG_IDENT, COperatorType.LOG_NOT, COperatorType.LOG_OR)) {
   ...
   private ICExpression pC(ICExpression var1, ICElement var2) {
   ...
   private ICOperation pC(ICOperation var1) {
      if (!CUtil.isOperation(var1, COperatorType.COND)) {
         ...
         if (add.pC(var4, var3)) {
            ...
            if (var7.reverse(this.m.getGlobalContext().getOperatorFactory()) && add.pC(var7, var3) && var1.replaceSubElement(var4, this.cf.createInt32(0))) {
               return var1;
            }
         }
   ...
   private ICExpression A(ICOperation var1) {
            ...
            do {
               ...
               for (int var10 = 0; var10 < var7.size() - 1; var10++) {
                  for (int var11 = var10 + 1; var11 < var7.size(); var11++) {
                     ICExpression var12 = this.pC(var7, var10, var11, var5);
                     if (var12 != null) {
                        var9 = true;
   ...
   private ICExpression pC(List var1, int var2, int var3, COperatorType var4) {
      ICExpression var5 = (ICExpression)var1.get(var2);
      ICExpression var6 = (ICExpression)var1.get(var3);
      ICIdentifier var7 = this.pC(var5, var6);
      if (var7 == null) {
         return null;
      } else {
         ICOperation var8 = (ICOperation)var5;
         ICOperation var9 = (ICOperation)var6;
         if (this.pC(var8.getOperatorType(), var9.getOperatorType())) {
   ...
   private boolean pC(COperatorType var1, COperatorType var2) {
      switch (var1) {
         case LE:
            return false;
         case LT:
   ...
   private ICIdentifier pC(ICExpression var1, ICExpression var2) {
   ...
   private ICExpression kS(ICOperation var1, ICElement var2) {
      Object var3 = null;
      Object var4 = null;
      boolean var5 = false;
      ...
      if (CUtil.isOperation((ICExpression)var3, COperatorType.COND)) {
         ...
         if (CUtil.isIntegerValue(var15.getSecondOperand(), 0L) != CUtil.isIntegerValue(var15.getThirdOperand(), 0L)) {
            ...
            if (var9) {
               ...
               this.pC(var13.getFirstOperand(), (ICElement)var13);
               this.pC(var13.getSecondOperand(), (ICElement)var13);
               if (var5) {
               ...
               this.pC(var16.getFirstOperand(), (ICElement)var16);
               this.pC(var16.getSecondOperand(), (ICElement)var16);
               if (var5) {
