...
public class byo extends AbstractDOptimizer {
   @Override
   public int perform() {
      ...
      for (byo.Av var30 : var1) {
         var30.kS.setInitialValues(var30.UT);

         for (int var32 : Lists.reverse(var30.A)) {
            DUtil.removeInstruction(var30.pC, var32);
         }
      }
