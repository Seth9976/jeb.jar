...
@Ser
public class biz extends bio implements IJavaContinue {
   @SerId(1)
   private IJavaLabel wS;

   public biz(IJavaLabel var1) {
      this.wS = var1;
   }
   ...
   public String toString() {
      return "continue" + (this.wS == null ? "" : " " + this.wS.getName());
   }

   public biz A() {
      biz var1 = new biz(this.wS == null ? null : this.wS.duplicate());
      this.pC(var1);
      return var1;
   }
}
