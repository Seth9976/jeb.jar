...
public class bmi extends AbstractJOptimizer {
   @Override
   public int perform() {
      if (this.m == null) {
         return 0;
      } else {
         boa var1 = new boa(this.m);
         int var2 = 0;
         List var3 = var1.A();
         ...
         for (int var4 = 0; var4 < var3.size(); var4++) {
            ...
            if (var5 instanceof IJavaLabel) {
               ...
               if (var6 > var4 + 1) {
                  ...
                  if (!(var7 instanceof bop) || ((bop)var7).sY() == bop.Sv.pC) {
                     var1.pC(var4, var6);
                     var2++;
                  }
               }
         ...
         for (int var11 = 0; var11 < var3.size(); var11++) {
            ...
            if (var12 instanceof bnl) {
               int var13 = var1.UT(var11) + 1;
               if (!(var12 instanceof boc)) {
                  if (var13 - 3 >= 0) {
                     var30.put(var11, var13 - 3);
                  }

                  if (var12 instanceof bon) {
                     if (var11 - 1 >= 0) {
                        var31.put(var11, var11 - 1);
                     }

                     if (((bon)var12).pC().isLitteralTrue()) {
               ...
               var1.pC(var13, true, false, 2, null);
               if (!var1.wS().isEmpty()) {
                  ArrayList var14 = new ArrayList(var1.wS());
         ...
         for (int var34 = 0; var34 < var3.size(); var34++) {
            ...
            if (var36 instanceof bnl) {
               var33.push(var34);
            } else if (var36 instanceof bnm) {
               var33.pop();
            }
            ...
            if (var36 instanceof IJavaGoto) {
               ...
               if (var16 != null) {
                  ...
                  while (var23.hasNext()) {
                     ...
                     var18++;
                     if (!(var3.get(var22) instanceof boc)) {
                        var19++;
                     }
                  }
