...
public class aln extends AbstractEExpressionOptimizer {
   public aln() {
   ...
   protected AbstractEExpressionOptimizer.EOR optimizeExpression(IEGeneric var1) {
      ...
      if (var1 instanceof IEStatement) {
         ...
         if (var1 instanceof IESlice) {
            var2 = this.pC((IESlice)var1, false);
            ...
            if (EUtil.isImmZero(var5)) {
               if (var4 instanceof IESlice) {
                  var4 = this.pC((IESlice)var4, true);
   ...
   private IEGeneric pC(IESlice var1, boolean var2) {
   ...
   private IEGeneric pC(IEOperation var1) {
      if (var1.getOperationType().isAnyOf(OperationType.SAR, OperationType.SHR)) {
         IEGeneric var2 = var1.getOperand1();
         if (var1.getOperand2() instanceof IEImm var4 && var2 instanceof IEOperation var5) {
            IEGeneric var6 = var5.getOperand1();
            if (this.pC(var5, var4)) {
               int var7 = EUtil.evalAsSaturatedPositiveInt(var4);
               IEOperation var8 = EUtil.createResizeOperation(var6, var1.getBitsize() - var7, false);
               return EUtil.createResizeOperation(var8, var1.getBitsize(), var1.getOperationType() == OperationType.SAR);
            }
         }
      }
   ...
   private boolean pC(IEOperation var1, IEImm var2) {
      IEGeneric var3 = var1.getOperand2();
      if (var1.getOperationType() == OperationType.MUL) {
         if (var3 instanceof IEImm var4) {
            BigInteger var5 = var4.getValue();
            int var6 = EUtil.evalAsSaturatedPositiveInt(var2);
            return var5.equals(BigInteger.ONE.shiftLeft(var6));
         }
      } else if (var1.getOperationType() == OperationType.SHL && var3 instanceof IEImm var7) {
         return var2.getValue().equals(var7.getValue());
      }
