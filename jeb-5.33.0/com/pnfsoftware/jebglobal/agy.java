...
public class agy extends AbstractCBlockOptimizer {
   @Override
   ...
   private boolean pC(ICPredicate var1, ICPredicate var2) {
      Boolean var3 = add.pC(var1, var2);
