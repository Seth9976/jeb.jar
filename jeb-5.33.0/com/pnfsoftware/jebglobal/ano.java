...
public class ano {
   private static final StructuredLogger UT = aco.pC(ano.class);
   IEConverter pC;
   IERoutineContext A;
   INativeDecompilerExtensionsManager kS;
   IWildcardTypeManager wS;

   public ano(IERoutineContext var1, INativeDecompilerExtensionsManager var2) {
      if (var1 == null) {
   ...
   public List pC(CFG var1, int var2, IWildcardPrototype var3, INativeMethodItem var4) {
      if (var2 + 1 >= var1.size()) {
         return null;
         ...
         if (var5 != null && var5.isStackCleanedByCaller()) {
            if (this.kS != null) {
               VariableArgumentInformation var6 = (VariableArgumentInformation)this.kS.resolveVariableArgumentInformation(this.A, var1, var2, var3).getResult();
               if (var6 != null) {
            ...
            if (EUtil.isPCAssign((IEStatement)var15.getLast())) {
               ...
               if (var8 != null) {
                  List var9 = this.pC(var7, var8, var5, var3.getParameterTypes(), var4);
                  if (var9 != null) {
                     return var9;
                  }
               }
            ...
            Integer var17 = this.pC(var1, var2, var3);
            if (var17 == null) {
               var17 = this.A(var1, var2, var3);
               if (var17 == null) {
                  return null;
               }
            }
            ...
            if (var17 < var18) {
               ...
               while (var19-- > 0) {
                  var20.add(this.wS.createWithSlotcount(1));
               }
   ...
   private List pC(IEAssign var1, PreRoutineInvocationDetails var2, ICallingConvention var3, List var4, INativeMethodItem var5) {
      if (var5 != null) {
         String var6 = var5.getFinalName();
         if (var6 != null && this.A.getNativeContext().getCodeContainerType() == 1) {
            switch (var6) {
               case "open":
               case "open64":
               case "openat":
               ...
               case "prctl":
                  ...
                  IEImm var29 = var2.readArg(this.A.getConverter(), var25);
                  if (var29 != null && var29.canReadAsLong()) {
                     ...
                     if (var31 < 2147483647L && var31 > -2147483648L) {
                        ...
                        switch ((int)var31) {
                           ...
                           case 38:
                           case 1499557217:
                              var33.add(this.wS.create("unsigned long"));
                              break;
                           case 2:
                           case 5:
                           case 9:
               ...
               case "fcntl64":
                  ...
                  IEImm var12 = var2.readArg(this.A.getConverter(), var11);
                  if (var12 != null && var12.canReadAsLong()) {
                     ...
                     if (var13 < 2147483647L && var13 > -2147483648L) {
                        ...
                        switch ((int)var13) {
                           ...
                           case 6:
                           case 7:
                              var15.add(this.wS.create("struct flock *"));
                              break;
                           default:
                              return null;
                        }
      ...
      alw var16 = new alw(this.A, var1, var2, var3, var4);
      return !var16.pC(false) ? null : var16.A();
   }

   private Integer pC(CFG var1, int var2, IWildcardPrototype var3) {
      IEVar var4 = this.pC.getStackPointer();
      ...
      if (var7 == null) {
         ...
         if (var14 == null) {
            ...
            if (var11 < 0L) {
               ...
               int var13 = (int)var11 / this.pC.getStackSlotSize();
               return var13;
            }
         }
      }
   ...
   private Integer A(CFG var1, int var2, IWildcardPrototype var3) {
      ano.Av var4 = new ano.Av(this.A, (int)var1.get(var2).getFirstAddress());
      Integer var5 = var4.pC();
      if (var5 == null) {
         return null;
      } else {
         StorageEntry var6 = var3.getCallingConvention().getReturnAddressSlot();
         if (var6 == null) {
            return null;
         } else {
            boolean var7 = var6.getType() == StorageEntry.Type.STACK;
            if (var7) {
               var5 = var5 - 1;
            }
   ...
   private static class Av {
      ...
      public Av(IERoutineContext var1, int var2) {
         this.pC = var1;
         this.A = var2;
      }

      public Integer pC() {
         int var1 = this.pC.getStackPointerId();
         int var2 = this.pC.getConverter().getStackSlotSize();
         EState var3 = this.pC.getGlobalContext().buildState(false, false, false);
         long var4 = this.pC.convertIntermediateOffset(this.A);
         this.pC.getConverter().initializeStateRegisters(var3, var4);
         ...
         BasicBlock var8 = this.pC.getCfg().getBlockAt((long)this.A);
