...
@Ser
public class bir extends bil implements IJavaBlock {
   @SerId(1)
   ...
   public bir(IJavaStatement var1) {
      this();
      this.add(var1);
   }
   ...
   public IJavaStatement get(int var1) {
      return (IJavaStatement)this.wS.get(var1);
   }

   @Override
   public IJavaStatement getLast() {
      return (IJavaStatement)this.wS.get(this.wS.size() - 1);
   }

   @Override
   public IJavaStatement removeLast() {
      return this.remove(this.wS.size() - 1);
   }

   @Override
   public IJavaStatement remove(int var1) {
      return (IJavaStatement)this.wS.remove(var1);
   }
   ...
   public List generateFlatList() {
      ArrayList var1 = new ArrayList();
      var1.add(new bno(this));

      for (IJavaStatement var3 : this.wS) {
   ...
   public boolean replaceSubElement(IJavaElement var1, IJavaElement var2) {
      for (int var3 = 0; var3 < this.wS.size(); var3++) {
         if (this.wS.get(var3) == var1) {
            ...
            this.wS.set(var3, (IJavaStatement)var2);
            return true;
         }
      }
   ...
   private void pC(JavaOutputSink var1, boolean var2) {
      if (var2) {
         Assert.a(this.wS.size() == 1);
      }

      int var3 = 0;

      for (IJavaStatement var5 : this.wS) {
         ...
         boolean var7 = var5 instanceof bjs && var1.getIndentationLevel() >= 0;
         if (var7) {
         ...
         if (var5 instanceof bio && ((bio)var5).kS != null) {
            var1.onEolAddComment(((bio)var5).kS);
         }
         ...
         if (!var2) {
            ...
            var1.eol();
            if (var5 instanceof IJavaCompound && var1.getInsertBlankLinesAfterCompounds() && var3 + 1 < this.wS.size()) {
               var1.eol();
            }
         }
   ...
   public String toString() {
      ...
      for (IJavaStatement var4 : this.wS) {
         if (var2 > 0) {
