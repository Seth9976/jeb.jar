...
public class amq {
   private static final StructuredLogger A = aco.pC(amq.class);
   static boolean pC = true;
   private IERoutineContext kS;

   public amq(IERoutineContext var1) {
      this.kS = var1;
   }

   public int pC() {
      int var1 = 0;
      CFG var2 = this.kS.getCfg();
      ...
      while (true) {
         ...
         if (!(var4 instanceof IENop)) {
            ...
            if (!(var8.getSrcOperand() instanceof IEVar)) {
               ...
               Integer var11 = this.kS.getUnderlyingRegisterId(var9.getId());
                  ...
                  if (var14.size() == 1 && (Long)var14.iterator().next() == var5) {
                     ...
                     for (long var33 : var15) {
                        ...
                        if (var19 instanceof IEAssign && ((IEAssign)var19).getDstOperand() instanceof IEVar) {
                           ...
                           Integer var21 = this.kS.getUnderlyingRegisterId(var20.getId());
