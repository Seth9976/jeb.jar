...
@Ser
public class cfj extends AbstractInstructionOperandList {
   private static Map pC = new HashMap();
   @SerId(1)
   private boolean A;

   public cfj(int var1, int var2, long var3) {
      super(var1, var2, var3, 0);
   }

   public cfj(int var1, int var2, int var3, long var4, boolean var6) {
      super(var1, var3, var4, var2);
      this.A = var6;
   }

   public cfj(long var1, int var3, cfj... var4) {
      super(var4.length, var1, var3, var4);
   }

   public static long pC(int var0, int var1, int var2) {
      int var3 = pC(var0, var2);
      return RegisterUtil.createRegisterId(var1, var0, var3);
   }

   public static cfj A(int var0, int var1, int var2) {
      int var3 = pC(var0, var2);
      long var4 = pC(var0, var1, var2);
      switch (var0) {
         case 0:
         case 2:
         case 3:
   ...
   private static cfj pC(long var0, int var2, int var3) {
      cfj var4 = (cfj)pC.get(var0);
      if (var4 == null) {
         var4 = new cfj(0, var2, var0);
         pC.put(var0, var4);
      }
   ...
   public String getRegisterName(long var1) {
      return pC(var1, this.getOperandBitsize() == 64 ? 64 : 32);
   }

   public static String pC(long var0, int var2) {
   ...
   public static cfj pC(int var0, long var1, boolean var3) {
      return new cfj(1, 0, var0, var1, var3);
   }

   public Long pC(long var1, int var3, IMachineContext var4) {
      switch (this.getOperandType()) {
         case 0:
            return cgm.pC(var4, this.getOperandValue(), var3);
         case 1:
         case 2:
         case 3:
