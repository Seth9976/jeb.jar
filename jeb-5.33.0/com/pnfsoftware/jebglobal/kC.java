...
class kC extends AbstractCommandHandler {
   kC(ub var1, ICommandManager var2, String var3, CommandParameter[] var4, String var5, String var6) {
   ...
   public ExecutionResult execute(List var1) {
      ...
      byte[] var4 = ((ia)ub.WR(this.pC)).A().UT(var3);
      if (var4 == null) {
         ...
         if (var7 != null) {
            ...
            if (IO.writeFileSafe(var8, var4, 0, var5, true)) {
