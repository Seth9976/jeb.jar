...
class hT implements tR {
   Predicate pC;
   private final String ld;
   private final String[] gp;
   private final Map oT;
   private final String[] fI;
   private final Map WR;
   private final String[] NS;
   private final String vP;
   static final hT A = new wa(
   ...
   static final hT kS = new qX(
      ...
      .pC(var0 -> Strings.startsWith(var0, "CAS", "LD", "PRF", "ST", "SWP"));
   static final hT wS = new rf(
      ...
      .pC(var0 -> Strings.startsWith(var0, "F", "SCVTF", "UCVTF"));
   static final hT UT = new hT(
   ...
   private static String[] xC = new String[]{"EQ", "NE", "CS", "CC", "MI", "PL", "VS", "VC", "HI", "LS", "GE", "LT", "GT", "LE"};
   static final hT E = new yR(
   ...
   static final hT sY = new PK(
      ...
      .pC(var0 -> Strings.startsWith(var0, "VCMP", "VDIV", "VFN", "VJCVT", "VNM", "VSEL", "VSQ"));
   static final hT ys = new nU(
      ...
      .pC(var0 -> Strings.startsWith(var0, "V", "F"));

   public hT(String var1, String var2, String[] var3, String[] var4, String[] var5, Map var6) {
      this.ld = var1;
      this.vP = var2;
      this.gp = var3;
      this.fI = var4;
      ...
      if (var6 == null) {
         ...
         for (Entry var14 : var6.entrySet()) {
            for (String var16 : (List)var14.getValue()) {
               this.oT.put(var16, (String)var14.getKey());
            }
         }
      }
   }

   public hT pC(Predicate var1) {
      this.pC = var1;
      return this;
   }
   ...
   public boolean kS(String var1) {
      return this.pC == null || this.pC.test(var1);
   }
   ...
   public List A(String var1) {
      ...
      String var9 = this.UT(var1);
      if (var9 != null) {
         var2.add(Strings.safe(this.ld) + var9 + this.wS(var1));
      } else {
         for (String var8 : this.gp) {
            var2.add(Strings.safe(this.ld) + var1 + var8 + this.wS(var1));
         }
      }
   ...
   private String UT(String var1) {
      if (this.oT == null) {
         return null;
      } else {
         String var2 = (String)this.oT.get(var1);
   ...
   private String E(String var1) {
      if (this.WR == null) {
         ...
         return var2 == null ? null : this.fI[var2];
      }
   }
