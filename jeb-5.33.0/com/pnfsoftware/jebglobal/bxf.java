...
public class bxf extends AbstractDOptimizer {
   private static final ILogger pC = GlobalLog.getLogger(bxf.class, Integer.MAX_VALUE);
   ...
   public int perform() {
      ...
      if (var2 <= 0) {
         com.pnfsoftware.jeb.corei.parsers.dexdec.rQ.pC(new RuntimeException("spagh.rem. seems stuck"), this.ctx.getMethodSignature());
      }
