...
public class bnh extends AbstractJOptimizer {
   public bnh() {
               ...
               if (!this.pC(var1, var15, var14)) {
                  ...
                  for (String var19 : this.c.getMethodsSignatures()) {
                     ...
                     if (Strings.isContainedIn(var22, "valueOf(Ljava/lang/String;)", "values()")) {
                        com.pnfsoftware.jeb.corei.parsers.dexdec.rQ.pC(this.decomp, this.dex.getMethod(var19), "Built-in enum method");
                     }
                  }
                  ...
                  for (IJavaMethod var10 : var2) {
                     ...
                     if (var5.contains(var25.partypes.get(var25.partypes.size() - 1))) {
                        com.pnfsoftware.jeb.corei.parsers.dexdec.rQ.pC(this.decomp, this.dex.getMethod(var11), "Constructor for custom enum");
   ...
   boolean pC(IJavaMethod var1, int[] var2, JavaReconEnum var3) {
