...
public class Nt implements zz {
      ...
      if (!Booleans.isTrue(var6.getNonReturning())) {
         ...
         if (var8.size() == 0) {
            ...
            for (BasicBlock var10 : var8) {
               ...
               if (!PU.wS((com.pnfsoftware.jeb.corei.parsers.arm.rQ)var11.getInstruction())) {
                  return false;
               }

               Long var12;
               try {
                  var12 = ((com.pnfsoftware.jeb.corei.parsers.arm.rQ)var11.getInstruction())
                     .pC()
                     .pC((com.pnfsoftware.jeb.corei.parsers.arm.rQ)var11.getInstruction(), var11.getOffset(), null);
               ...
               auu var13 = this.pC.E(var12);
               if (var13 == null) {
                  return false;
               }

               if (!this.pC(var12, var13)) {
                  return false;
               }
            }
   ...
   private boolean pC(long var1, auu var3) {
