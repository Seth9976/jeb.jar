...
public class bxk extends AbstractDOptimizer {
   @Override
   public int perform() {
      int var1 = 0;
      ...
      for (BasicBlock var3 : this.cfg) {
         for (int var4 = 0; var4 < var3.size(); var4++) {
            ...
            if (var5.isInvoke()
               ...
               if (var17 != null) {
                  IDNewInfo var19 = pC(this.g, var17, var6);
               ...
               if (var15.isInvoke()
                  ...
                  && this.pC(var9, var10.getArgument(0))) {
                  IDNewInfo var20 = pC(this.g, var7, var10);
   ...
   static IDNewInfo pC(IDGlobalContext var0, IDAllocObjectInfo var1, IDCallInfo var2) {
