...
public class blq extends AbstractJBlockOptimizer {
   @Override
   ...
   private int pC(IJavaBlock var1, int var2) {
      ...
      for (blq.Av var7 : var4) {
         IJavaCall var8 = (IJavaCall)var7.A;
         ...
         if (var9.size() == 2 && var9.get(0) instanceof IJavaStaticField && var9.get(1) instanceof IJavaNewArray) {
            ...
            if (var10 != null && var11 >= 0 && var12 != null) {
               ...
               if (var7.pC.replaceSubElement(var8, var19)) {
                  var5++;
               }
            }
         }
   ...
   private void pC(IJavaElement var1, IJavaElement var2, HashSet var3, List var4) {
      if (!var3.contains(var2)) {
         var3.add(var2);
         if (var2 instanceof IJavaCall && this.pC((IJavaCall)var2)) {
            var4.add(new blq.Av(var1, var2));
         } else {
   ...
   static class Av {
      public IJavaElement pC;
      public IJavaElement A;

      public Av(IJavaElement var1, IJavaElement var2) {
         this.pC = var1;
         this.A = var2;
      }
   }
