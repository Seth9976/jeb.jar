...
public class azb {
   CodeConstantManager pC = new CodeConstantManager();

   public azb(File var1) throws IOException {
      this(IO.readLines(var1));
   }

   public azb(Collection var1) {
      int var2 = 0;
