...
public class aph extends AbstractEOptimizer {
   private static final StructuredLogger E = aco.pC(aph.class);
   static final INode pC = Util.N(O.ADD, Util.N(O.SLICE_HALF1, Util.L(0)), Util.N(O.SLICE_HALF1, Util.L(1)));
   static final INode A = Util.N(
      O.ADD,
   ...
   private static final INode sY = Util.N(
      O.COND,
      Util.N(O.LT_U, Util.N(O.ADD, Util.N(O.SLICE_HALF1, Util.L(0)), Util.N(O.SLICE_HALF1, Util.L(1))), Util.N(O.SLICE_HALF1, Util.L(0))),
      Util.LC(1L),
      Util.LC(0L)
   );
   static final INode kS = Util.N(O.ADD, sY, Util.N(O.SLICE_HALF2, Util.L(0)), Util.N(O.SLICE_HALF2, Util.L(1)));
   static final INode wS = Util.N(O.SUB, Util.N(O.SLICE_HALF1, Util.L(0)), Util.N(O.SLICE_HALF1, Util.L(1)));
   static final INode UT = Util.N(
      O.SUB,
      Util.N(O.SLICE_HALF2, Util.L(0)),
      Util.N(
         O.ADD,
      ...
      for (BasicBlock var3 : this.cfg.getBlocks()) {
         ...
         for (int var7 = 0; var7 < var3.size(); var7++) {
            ...
            if (var8 instanceof IEAssign && ((IEAssign)var8).getLeftOperand() instanceof IESlice) {
               ...
               if (var4) {
                  if (this.pC(var9, var5)) {
                     var1 += this.pC(var1, var3, var5, var6, var7);
                     var4 = false;
                     continue;
                  }
                     ...
                     if (var12 instanceof IEAssign && ((IEAssign)var12).getLeftOperand() instanceof IESlice) {
                        ...
                        if (this.pC(var13, var5)) {
                           ...
                           if (var11 < var6) {
                              ...
                              if (var11 + 1 == var6) {
                                 var1 += this.pC(var1, var3, var5, var6, var14);
                              }
                           }
                           break;
                        }
   ...
   private int pC(int var1, BasicBlock var2, IEVar var3, int var4, int var5) {
      Object[] var10000 = new Object[]{var2.get(var4), var2.get(var5)};
      if (this.pC(var2, var4, var5, var3)) {
         return 1;
      } else {
         return this.A(var2, var4, var5, var3) ? 1 : 0;
      }
   }

   private boolean pC(IESlice var1, IEVar var2) {
   ...
   private boolean pC(BasicBlock var1, int var2, int var3, IEVar var4) {
      boolean var5 = true;
      IEAssign var6 = (IEAssign)var1.get(var2);
      EExpressionMatcher var7 = new EExpressionMatcher(pC);
      if (!var7.isMatch(var6.getRightOperand())) {
         var7 = new EExpressionMatcher(wS);
         if (!var7.isMatch(var6.getRightOperand())) {
            return false;
         }
      ...
      EExpressionMatcher var9 = new EExpressionMatcher(var5 ? A : UT);
   ...
   private boolean A(BasicBlock var1, int var2, int var3, IEVar var4) {
