...
public class ccd extends AbstractDOptimizer {
      ...
      for (int var2 = 0; var2 < this.cfg.size(); var2++) {
         ...
         for (int var4 = 0; var4 < var3.size(); var4++) {
            ...
            if (var5.getOpcode() == DOpcodeType.IR_ASSIGN && var5.getOperand2() instanceof IDNewInfo && var5.getOperand1() instanceof IDVar) {
               ...
               Boolean var9 = (Boolean)pC.get(var8);
               if (var9 != null) {
   ...
   private static List pC(IDInstruction var0, IDExpression var1, boolean var2) {
      ArrayList var3 = new ArrayList();
      var0.visitDepthPost(new cce(var1, var2, var3));
   ...
   private int A() {
      ...
      for (BasicBlock var3 : this.cfg) {
         for (int var4 = 0; var4 < var3.size(); var4++) {
            IDInstruction var5 = (IDInstruction)var3.get(var4);
            if (!var5.visitInstruction(new ccf(this), true)) {
               var1++;
               var4--;
            }
         }
   ...
   private IDExpression pC(IDCallInfo var1) {
      ...
      if (!(var2 instanceof IDNewInfo var7)) {
         ...
         Boolean var5 = (Boolean)pC.get(var7.getMethodSignature());
         if (var5 == null) {
            return null;
         } else {
            if (var5) {
   ...
   static {
      pC.put("Ljava/lang/StringBuilder;-><init>()V", false);
      pC.put("Ljava/lang/StringBuilder;-><init>(I)V", false);
      pC.put("Ljava/lang/StringBuilder;-><init>(Ljava/lang/CharSequence;)V", true);
      pC.put("Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V", true);
      pC.put("Ljava/lang/StringBuffer;-><init>()V", false);
      pC.put("Ljava/lang/StringBuffer;-><init>(I)V", false);
      pC.put("Ljava/lang/StringBuffer;-><init>(Ljava/lang/CharSequence;)V", true);
      pC.put("Ljava/lang/StringBuffer;-><init>(Ljava/lang/String;)V", true);
   }
}
