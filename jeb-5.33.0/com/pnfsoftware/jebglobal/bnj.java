...
class bnj implements IJVisitor {
   bnj(bni var1) {
      this.pC = var1;
   }
   ...
   public void pC(IJavaElement var1, IJavaElement var2, IVisitResults var3) {
      ...
      if (this.pC.jctx.getClassFactory().get(var4.getSignature()) != this.pC.c) {
         if (var1.getReconLambda() == null) {
            String var23 = this.pC.pC(var4);
            if (var23 != null) {
               String var9 = var4.getSignature() + "->" + var23;
               IDexMethod var10 = this.pC.dex.getMethod(var9);
               if (var10 != null && var10.isInternal()) {
                  ...
                  if (!var11.isAbstract()) {
                     if (var11.getCodeItem() != null && var11.getCodeItem().getInstructions().size() < 40) {
                        int var12 = 0;
                        IDexClass var13 = this.pC.dex.getClass(var4.getSignature());
                        if (var13 != null) {
                        ...
                        if (var12 < 200) {
                           IJavaClass var24 = this.pC.jctx.getClassFactory().get(var4.getSignature());
                           if (var24 != null && var24.isBuilt()) {
                              IJavaMethod var25 = this.pC.pC(var24, var23);
                              if (var25 != null && !var25.isAbstract() && var25.getBody().size() == 1) {
                                 IJavaCall var16 = this.pC.pC(var25.getBody().get(0));
                                 IJavaMethod var18;
                                 if (var16 != null && !(var18 = var16.getMethod()).isExternal() && var18.getClassType() == this.pC.c.getType()) {
                                    Object[] var10000 = new Object[]{var4};
                                    HashMap var26 = new HashMap();
                                    if (var6 == null || this.pC.pC(var6, var5, var26)) {
                                       ArrayList var27 = new ArrayList();
                                       HashMap var28 = new HashMap();
                                       if (this.pC.pC(var25, var16, var26, var27, var28)) {
                                          var18.addFlags(16);
                                          com.pnfsoftware.jeb.corei.parsers.dexdec.rQ.pC(this.pC.decomp, this.pC.dex.getMethod(var18.getSignature()));
                                          var24.addFlags(32);
                                    ...
                                    if (this.pC.pC(var25, var16, var19, var20, var21)) {
                                       var25.addFlags(16);
                                       com.pnfsoftware.jeb.corei.parsers.dexdec.rQ.pC(this.pC.decomp, this.pC.dex.getMethod(var25.getSignature()));
                                       var24.addFlags(32);
                              ...
                              if (this.pC.drcollector != null) {
                                 this.pC.drcollector.request(var4.getSignature());
                              }
                           }
                        }
                     }
