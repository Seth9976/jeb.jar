...
public class TA implements zz {
   private final a pC;
   private final Tw A;
   private final IReferenceManager kS;
   ...
   public boolean pC(long var1, com.pnfsoftware.jeb.corei.parsers.arm.rQ var3, TreeSet var4, TreeSet var5) {
      auu var6 = this.A.E(var1);
      CFG var7 = var6.getData().getCFG();
      Boolean var8 = this.pC(var4, var5, var1, var7);
      if (var8 != null) {
         return !var8;
         ...
         com.pnfsoftware.jeb.corei.parsers.arm.rQ var9 = (com.pnfsoftware.jeb.corei.parsers.arm.rQ)var7.getEntryBlock().get(0);
         if (var9.getProcessorMode() == 64
            && var7.getEntryBlock().size() > 1
            && var9.UT().E()
            && Strings.isContainedIn(var9.wS().pC(), "LDR", "LDRB", "LDUR")
            && var9.pC(0).UT(8)) {
            var9 = (com.pnfsoftware.jeb.corei.parsers.arm.rQ)var7.getEntryBlock().get(1);
         }

         if (var9.UT().E() && var9.wS().pC().equals("MOV")) {
            if (var9.getProcessorMode() != 64) {
               if (!var9.pC(0).UT(4) && !var9.pC(0).UT(5)) {
                  return false;
               }
            } else if (!var9.pC(0).UT(19) && !var9.pC(0).UT(20) && !var9.pC(0).UT(21)) {
               return false;
            }
            ...
            for (BasicBlock var11 : var7.getExitBlocks()) {
               ...
               if (var12 != null
                  && (
                     PU.sY((com.pnfsoftware.jeb.corei.parsers.arm.rQ)var12.getInstruction())
                        || this.pC(var12.getOffset(), (com.pnfsoftware.jeb.corei.parsers.arm.rQ)var12.getInstruction())
                  )) {
                  return false;
               }
            }
   ...
   private Boolean pC(TreeSet var1, TreeSet var2, Long var3, CFG var4) {
      Long var5 = this.pC(var1, var2, var3);
      ...
      if (var6 == null) {
         ...
         while ((var5 == null || var9 < var5) && var7 < 100 && var7 + var8 < 1000) {
            INativeContinuousItem var11 = this.A.getNextItem(var9);
            if (var11 == null) {
               break;
            }

            if (var11 instanceof INativeDataItem) {
               Set var12 = this.kS.getReferencesTo(var11.getMemoryAddress());
               if (!var12.isEmpty() && var12.size() >= 1) {
                  ...
                  for (IReference var15 : var12) {
                     ...
                     if (var16.isInternalAddress()) {
                        ...
                        List var17 = this.A.getContainedRoutineAddresses(var16.getInternalAddress());
                        if (var17.size() > 0) {
   ...
   private boolean pC(INativeMethodItem var1) {
      if (this.pC.sY() == null) {
         return false;
      } else {
         ...
         label48: {
            label47: {
               try {
                  var6 = true;
                  List var2 = this.pC.sY().match(this.pC, Arrays.asList(var1.getData()), false, true, false);
                  if (var2.isEmpty()) {
                     var9 = false;
                     var6 = false;
                     break label48;
   ...
   private Long pC(TreeSet var1, TreeSet var2, Long var3) {
      Long var4;
   ...
   private Long A(TreeSet var1, TreeSet var2, Long var3) {
      Long var4 = null;
