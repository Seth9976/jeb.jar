...
public class cai extends AbstractDOptimizer {
   private int pC = 0;
   ...
   private int A() {
      int var1 = 0;
      int var2 = 0;
      boq var3 = new boq(this.ctx, true);
      int var4 = 100000;
               ...
               if (var11.isJump()) {
                  ...
                  if (var12 <= var8.getBase() || var12 > var9.getBase()) {
                     ...
                     for (BasicBlock var16 : var8.getOutputs()) {
                        if (var13 >= 1) {
                           int var17 = var3.pC(var16.getBase());
                           if (var17 >= 1) {
                     ...
                     if (var14.size() >= 2) {
                        ...
                        var24.add(var23);
                        this.cfg.addBlock(var5.wS(), var24);
      ...
      if (var2 > var4) {
         ...
         com.pnfsoftware.jeb.corei.parsers.dexdec.rQ.pC(var21, this.ctx.getMethodSignature());
      }
   ...
   private int kS() {
      ...
      while (var2++ <= var4) {
         ...
         int var6 = var5.kS();
         int var7 = var5.wS();
         if (var6 < var7 && var7 >= 0 && !var5.wS) {
            BasicBlock var8 = this.cfg.get(var6);
            BasicBlock var9 = this.cfg.get(var7);
            TreeMap var10 = new TreeMap();

            for (BasicBlock var12 : var8.getOutputs()) {
               var10.put(var12.getBase(), var3.pC(var12.getBase()));
            }
            ...
            if (var10.size() >= 2) {
               ...
               for (int var15 = 0; var15 < var14.size(); var15++) {
                  ...
                  int var20 = var3.pC(var16);
                  int var21 = var3.pC(var18);
                  ...
                  if (var22 != null && var22.irrinsize() <= 0 && var22.outsize() == 1) {
                     ...
                     if ((!((IDInstruction)var22.getLast()).getBreakingFlow().isBroken() || var34) && var22.size() - (var34 ? 1 : 0) <= 2) {
                        ...
                        BasicBlock var41 = bpl.pC(var22, this.cfg.getEndAddress());
                        if (!var34) {
                        ...
                        if (var13 != 0) {
                           ...
                           var3.pC();
                           if (this.cfg.size() <= 100 && bpl.pC(this.ctx)) {
                              this.assignLocalFields(this.ctx);
                           }
      ...
      if (var2 > var4) {
         ...
         com.pnfsoftware.jeb.corei.parsers.dexdec.rQ.pC(var32, this.ctx.getMethodSignature());
      }
