...
public class arf extends AbstractEExpressionOptimizer {
   public arf() {
   ...
   protected AbstractEExpressionOptimizer.EOR optimizeExpression(IEGeneric var1) {
      if (var1 instanceof IEOperation var2) {
         if (var2.getOperationType() == OperationType.AND) {
            ...
            AbstractEExpressionOptimizer.EOR var5 = this.pC(var3, var4);
            if (var5 == null) {
               var5 = this.pC(var4, var3);
            }
            ...
            if (var19 instanceof IEImm && var19.getBitsize() <= 64) {
               ...
               if (var24 > 0) {
                  if (var14 instanceof IECompose var6) {
                     ...
                     int var31 = this.pC(((IEOperation)var14).getOperand2());
                     if (var31 >= 0) {
      ...
      if (var1 instanceof IESlice) {
         ...
         if (EUtil.isOperation(var11, OperationType.MUL)) {
            int var26 = this.pC(((IEOperation)var11).getOperand2());
            if (var26 >= 0) {
      ...
      if (var1 instanceof IECond var13 && EUtil.isZero(var13.getExpressionFalse())) {
         ...
         if (!var22.isEmpty()) {
            ...
            return AbstractEExpressionOptimizer.EOR.create(this.ectx.createCond(this.pC(var18), var13.getExpressionTrue(), var13.getExpressionFalse()));
         }
      }
   ...
   private void pC(List var1, IEGeneric var2) {
      if (EUtil.isOperation(var2, OperationType.LOG_AND)) {
         IEOperation var3 = (IEOperation)var2;
         this.pC(var1, var3.getOperand1());
         this.pC(var1, var3.getOperand2());
      } else {
         var1.add(var2);
      }
   }

   private IEGeneric pC(List var1) {
