...
public class bxo extends AbstractDOptimizer {
   private static final ILogger pC = GlobalLog.getLogger(bxo.class);
                     ...
                     if (var16 != var9 && var16 == var14 && var9.irrinsize() == 0) {
                        ...
                        if (var9.size() == 1 && ((IDInstruction)var9.get(0)).isJump()) {
                           ...
                           if (var23 == var16 && var23 != var9 && var9.getEndAddress() != var14.getFirstAddress()) {
                              int var25 = bpl.pC(this.ctx, var8, var4, false);
                              if (var25 >= 0) {
                                 if (var25 == 3) {
                                    bpl.pC(var4, var8);
                                 }
   ...
   private boolean pC(BasicBlock var1, BasicBlock var2) {
      return bpl.pC(this.ctx, var1, var2, true) == 0;
   }
}
