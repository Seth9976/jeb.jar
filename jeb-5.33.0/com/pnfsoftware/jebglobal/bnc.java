...
public class bnc extends AbstractJBlockOptimizer {
   @Override
   ...
   private int pC(IJavaElement var1, IJavaElement var2, Set var3) {
      if (var3.contains(var2)) {
         ...
         var3.add(var2);
         int var4 = 0;
         if (var2 instanceof IJavaCall && this.pC(var1, (IJavaCall)var2)) {
            var4++;
         }

         for (IJavaElement var6 : var2.getSubElements()) {
            var4 += this.pC(var2, var6, var3);
         }
   ...
   private boolean pC(IJavaElement var1, IJavaCall var2) {
      if (!this.pC(var2.getMethodSignature(), "toString")) {
         return false;
      } else {
         ...
         while (true) {
            ...
            if (!this.pC(var5.getMethodSignature(), "append")) {
               return false;
            }
