...
public class aq {
   public static void pC(AbstractRegisterData var0, Tl var1, RegisterLayoutBridge var2) throws IOException {
      for (int var4 : var1.kS()) {
         byte[] var5 = var1.pC(var4);
         if (var5 != null) {
   ...
   public static byte[] A(AbstractRegisterData var0, Tl var1, RegisterLayoutBridge var2) {
      BytePipe var3 = new BytePipe();

      for (int var5 : var1.kS()) {
   ...
   public static Map pC(AbstractRegisterData var0, Tl var1, RegisterLayoutBridge var2, boolean var3) {
      LinkedHashMap var4 = new LinkedHashMap();

      for (int var6 : var1.kS()) {
