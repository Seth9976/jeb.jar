...
public class alq extends alf {
   ...
   public alq(IERoutineContext var1) {
      super(var1);
      this.kS = var1.getCfg();
   }
   ...
   public int A() {
      ...
      for (IEStatement var4 : this.kS.instructions()) {
      ...
      for (IEVar var5 : var2) {
         ...
         if (var6 < 0 && -var6 >= 65536 && -var6 < 1245184) {
            VarSrc var7 = this.A.getSourceForVariable(var6);
      ...
      for (int var16 : var13.keySet()) {
         ...
         List var18 = this.A.getDuplicatesForRegister(var16);
         ...
         while (true) {
            ...
            for (IEStatement var22 : this.kS.instructions()) {
