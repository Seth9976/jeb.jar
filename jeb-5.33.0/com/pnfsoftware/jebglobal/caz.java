...
public class caz extends AbstractDOptimizer {
   public caz() {
         ...
         for (IDInstruction var6 : var4) {
            ...
            if (var7 != null) {
               ...
               for (long var18 : var9) {
                  ...
                  if (var13.isAssign() && var13.getAssignDestination() instanceof IDArrayElt var14 && var14.getArray().equals(var7) || !this.pC(var13, var7)) {
                     continue label71;
                  }
               }

               cbb var17 = new cbb(this, var7, var2);
   ...
   boolean pC(IDInstruction var1, IDVar var2) {
      return var1.visitDepthPost(new cba(this, var2));
   }

   IDVar pC(IDInstruction var1, List var2) {
      if (var1.isAssign()
