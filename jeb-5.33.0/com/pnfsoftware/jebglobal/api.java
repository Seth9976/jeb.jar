...
public class api extends AbstractEExpressionOptimizer {
   public api() {
   ...
   protected AbstractEExpressionOptimizer.EOR optimizeExpression(IEGeneric var1) {
      if (var1 instanceof IEOperation && als.pC(var1)) {
         als var2 = new als(this.ectx);
         if (!var2.A(var1)) {
            return null;
         } else {
            IEGeneric var3 = var2.A();
            if (var3 == null) {
               return null;
            } else {
               boolean var4 = false;

               for (IEGeneric var6 : var2.pC()) {
