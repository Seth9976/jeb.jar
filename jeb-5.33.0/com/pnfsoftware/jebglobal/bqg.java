...
public class bqg extends bph implements IDVar {
   private static final ILogger A = GlobalLog.getLogger(bqg.class);
   private int kS;
   private String wS;

   bqg(IDMethodContext var1, int var2, IJavaType var3) {
      super(var3);
      this.kS = var2;
      pC(var2, var3);
   }

   public int pC(IDVar var1) {
      return Integer.compare(this.kS, var1.getId());
   }

   private static void pC(int var0, IJavaType var1) {
   ...
   public boolean usesSingleRegister() {
      return this.pC.isSingleSlot();
   }

   @Override
   public boolean usesPairOfRegisters() {
      return this.pC.isDoubleSlot();
   }
   ...
   public int hashCode() {
      ...
      return 31 * var1 + this.pC.hashCode();
   }
   ...
   public IDImm evaluate(IDState var1) throws DexDecEvaluationException {
      ...
      if (!var2.getType().compareSimple(this.pC)) {
         IJavaType var3 = var2.getType().compareAndGetMostPrecise(this.pC);
         if (var3 != null && var3 != var2.getType()) {
            var2 = var2.duplicateWithDifferentType(this.pC);
         }
      }
   ...
   public IJavaExpression pC(IDMethodContext var1, IJavaMethod var2) {
      cdi.pC(this.pC);
      bjr var3 = (bjr)var2;
      int var4 = (int)var3.UT.getOffset();
      int var5 = var3.UT.getPhysicalOffset();
      int var6 = var1.retrievePhysicalRegisterId(this.kS);
      if (var6 < 0) {
         var6 = this.kS;
      }

      int var7 = var1.getMethod().getIndex();
      if (var3.E > 0 && var3.A.getDefinition(this.kS) == null) {
         IJavaDefinition var13 = var3.A.pC(var4, this.pC, this.kS, var6, null, this.wS, var7, var5);
         var13.setPhysicalOffset(var5);
         return var13;
      } else {
         IJavaDefinition var8 = var3.A.pC(var4, this.pC, this.kS, var6, null, this.wS, var7, var5);
         IJavaIdentifier var9 = var8.getIdentifier();
         IJavaType var10 = var8.getType();
         var10.getSlotCount();
         this.pC.getSlotCount();
         if (var3.E > 0) {
            return var9;
         } else if (this.pC == var10) {
            return var9;
         } else if (!this.pC.isInt() || !var10.isByte() && !var10.isChar() && !var10.isShort()) {
            if (var10.isClassOrInterface() && this.pC.isClassOrInterface()) {
               try {
                  if (var1.getTypeInfoProvider().isChildOf(var10.getSignature(), this.pC.getSignature())) {
                     return var9;
                  }
               } catch (Exception var12) {
                  com.pnfsoftware.jeb.corei.parsers.dexdec.rQ.pC(var12, var1.getMethodSignature());
               }
            }

            return (IJavaExpression)this.pC(var2.getGlobalContext().createCastOperation(this.pC, var9));
         } else {
            return var9;
         }
      }
   ...
   public void format(DFormattingContext var1) {
      String var2 = this.wS != null && var1.isUsePreferredNames() ? "$" + this.wS : DUtil.formatVarId(this.kS);
