...
@Ser
public abstract class bio extends bim implements IJavaStatement {
   @SerId(1)
   int A = -1;
   @SerTransient
   String kS;
   ...
   public static boolean pC(List var0, int var1, IJavaStatement var2) {
      for (int var3 = 0; var3 < var0.size(); var3++) {
         ...
         if (var4 instanceof bil && ((bil)var4).insertAt(var1, var2)) {
            return true;
         }
      }
