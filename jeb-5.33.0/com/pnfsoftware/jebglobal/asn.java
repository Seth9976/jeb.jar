...
public class asn extends AbstractEOptimizer {
   public asn() {
   ...
   protected int perform() {
      ...
      // 001: istore 1
      // 002: aload 0
      // 003: getfield com/pnfsoftware/jebglobal/asn.cfg Lcom/pnfsoftware/jeb/core/units/code/asm/cfg/CFG;
      ...
      // 067: lload 7
      // 069: lload 9
      // 06b: invokevirtual com/pnfsoftware/jebglobal/asn.pC (JJJ)Z
      // 06e: ifne 074
      // 071: goto 00a
      // 074: aload 3
      ...
      // 078: lstore 11
      // 07a: aload 0
      // 07b: getfield com/pnfsoftware/jebglobal/asn.ectx Lcom/pnfsoftware/jeb/core/units/code/asm/decompiler/IERoutineContext;
      ...
      // 08b: aload 13
      // 08d: aload 0
      // 08e: getfield com/pnfsoftware/jebglobal/asn.ectx Lcom/pnfsoftware/jeb/core/units/code/asm/decompiler/IERoutineContext;
      // 091: lload 11
      // 093: l2i
      // 094: lload 9
      // 096: l2i
      ...
      // 112: goto 00a
      // 115: getstatic com/pnfsoftware/jebglobal/asn.logger Lcom/pnfsoftware/jeb/util/logging/ILogger;
      ...
      // 15f: aconst_null
      // 160: aload 0
      // 161: getfield com/pnfsoftware/jebglobal/asn.ectx Lcom/pnfsoftware/jeb/core/units/code/asm/decompiler/IERoutineContext;
      ...
      // 175: ifeq 1da
      // 178: aload 0
      // 179: getfield com/pnfsoftware/jebglobal/asn.ectx Lcom/pnfsoftware/jeb/core/units/code/asm/decompiler/IERoutineContext;
      ...
      // 184: ifeq 1da
      // 187: aload 0
      // 188: getfield com/pnfsoftware/jebglobal/asn.ectx Lcom/pnfsoftware/jeb/core/units/code/asm/decompiler/IERoutineContext;
      ...
      // 1eb: aload 0
      // 1ec: iload 1
      // 1ed: invokevirtual com/pnfsoftware/jebglobal/asn.postPerform (I)I
      // 1f0: ireturn
   }

   boolean pC(long var1, long var3, long var5) {
      ...
      while (!var8.isEmpty()) {
         ...
         if (var7.add(var9)) {
            ...
            for (BasicBlock var13 : var11.getAllOutputs()) {
