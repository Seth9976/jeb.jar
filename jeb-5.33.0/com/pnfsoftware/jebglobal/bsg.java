...
public class bsg {
   private static final ILogger pC = GlobalLog.getLogger(bsg.class);
   private IDGlobalContext A;
   private IDexUnit kS;
   private static final String wS = ckx.pC(new byte[]{39, 8, 47, 29, 23, 29}, 2, 58);
   private static final String UT = ckx.pC(new byte[]{52, 3, 56, 41, 27, 50, 59, 1, 17, 43, 60, 13, 26}, 1, 80);
   private static List E = Arrays.asList(-389569552, -1614206264, 187736038, -800171234);
   private static String sY = ckx.pC(
      new byte[]{13, 63, 28, 0, 26, 11, 14, 9, 69, 79, 13, 4, 19, 6, 16, 2, 21, 27, 29, 82, 72, 13, 9, 28, 21, 23, 82, 67, 15, 13, 18, 0}, 1, 93
   );

   public void pC(IDGlobalContext var1) {
      Assert.a(var1 != null);
      this.A = var1;
      this.kS = var1.getDex();
   ...
   void pC() {
      if (this.kS
         ...
         if (var1 != null) {
            ...
            for (IDexMethod var4 : this.kS.getMethods()) {
                        ...
                        if (var8 == 26 || var8 == 27) {
                           ...
                           if (var8 == 113) {
                              ...
                              if (var11 == var2) {
                                 ...
                                 if (var12 == var9) {
                                    String var13 = this.kS.getString(var10).getValue();
                                    if (this.pC(var13)) {
                                       this.A.setData(wS, true);
                                       break;
                                    }
                                 }
                              }
   ...
   public static boolean A(IDGlobalContext var0) {
      return Boolean.TRUE.equals(var0.getData(wS));
   }
   ...
   void A() {
      ...
      label96:
      for (IDexClass var3 : this.kS.getClasses()) {
   ...
   public static boolean kS(IDGlobalContext var0) {
      return var0.getData(UT) instanceof Integer var1 && var1 > 0;
   }
   ...
   void kS() {
      ...
      if (var1 != null) {
         ...
         label96:
         for (IDexClass var5 : this.kS.getClasses()) {
                           ...
                           if (var12 == var2) {
                              ...
                              if (var14 == 26 || var14 == 27) {
                                 ...
                                 if (var15 == var13) {
                                    ...
                                    String var17 = this.kS.getString(var16).getValue();
                                    if (var17.length() < 10 && !JavaUtil.isValidClassname(var17)) {
                                       pC.trace("%s: %s", sY, var5.getSignature());
                                       var3.add(var5);
                                       continue label96;
                                    }
                                 }
         ...
         if (!var3.isEmpty()) {
            Set var18 = bya.pC(this.A, true);

            for (IDexClass var20 : var3) {
               String var21 = var20.getSignature(false);
               this.kS.getCommentManager().addMetaComment(var21, new MetaComment(sY), false);
               var18.add(var21);
            }

            this.kS.notifyListeners(new JebEvent(J.UnitChange, new UnitChangeEventData(3, this.kS)));
         }
      }
   }
}
