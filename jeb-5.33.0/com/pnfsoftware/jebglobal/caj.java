...
public class caj extends AbstractDOptimizer {
   private int pC = 0;
      ...
      while (true) {
         ...
         while (var2++ <= var6) {
            ...
            if (var7.kS() != var7.pC()) {
               boolean var8 = false;
               if (!var8) {
                  var8 = this.pC(var7, var3);
               }

               if (!var8) {
                  var8 = this.A(var7, var3);
               }

               if (!var8) {
                  var8 = this.kS(var7, var3);
               }

               if (!var8) {
                  var8 = this.wS(var7, var3);
               }

               if (!var8) {
                  var8 = this.UT(var7, var3);
               }
         ...
         if (var2 > var6) {
            ...
            com.pnfsoftware.jeb.corei.parsers.dexdec.rQ.pC(var10, this.ctx.getMethodSignature());
            break;
         }
   ...
   private boolean pC(bpa var1, boz var2) {
      if (var1.A() != bpb.pC) {
         return false;
      } else {
         int var3 = var1.kS();
         ...
         if (var8.isJcond()) {
            ...
            for (BasicBlock var11 : var7.getInputs()) {
               int var12 = var2.pC(var11.getBase());
               if (var12 > var9) {
                  var9 = var12;
               }
            }
            ...
            if (var17 > var7.getEndAddress()) {
               ...
               if (var23.irrinsize() == 0) {
                  ...
                  for (BasicBlock var14 : var23.getInputs()) {
                     int var15 = var2.pC(var14.getBase());
                  ...
                  for (BasicBlock var34 : var23.getIrregularInputs()) {
                     int var38 = var2.pC(var34.getBase());
   ...
   private boolean A(bpa var1, boz var2) {
      int var3 = var1.kS();
      int var4 = var1.pC();
      if (var3 != var4 && var4 != this.cfg.size() - 1) {
         ...
         if (var7.isJcond() && var7.getBranchTarget() == var5.getBase()) {
            ...
            if (var10 == null) {
               ...
               int var21 = var2.pC(var10.getBase());
               int var22 = var21 - 1;
   ...
   private boolean kS(bpa var1, boz var2) {
      int var3 = var1.kS();
      int var4 = var1.pC();
      if (var3 != var4 && var4 != this.cfg.size() - 1) {
         BasicBlock var5 = this.cfg.get(var3);
         ...
         if (var7.isJump() && var7.getBranchTarget() == var5.getBase()) {
            ...
            if (var10 == null) {
               ...
               int var19 = var2.pC(var10.getBase());
               int var20 = var19 - 1;
   ...
   private boolean wS(bpa var1, boz var2) {
      int var3 = var1.kS();
      int var4 = var1.pC();
      if (var3 != var4 && var4 != this.cfg.size() - 1) {
         BasicBlock var5 = this.cfg.get(var3);
                  ...
                  if (!CFGUtil.canReach(var5, var12, false, Sets.newHashSet(var10))) {
                     ...
                     if (var3 == 0) {
                        ...
                        if (var10.insize() == 1) {
                           ...
                           int var26 = -1;
                           Map var16 = bpl.pC(this.cfg, true);
                        ...
                        if (var14 == null) {
                           ...
                           if (this.dfa.isAlive(var14, 0, var13.getId())) {
                              ...
                              bpv.Av var29 = ((bpv)var27).pC((var1x, var2x, var3x) -> var2x.add(var13.getId()));
   ...
   private boolean pC(boz var1) {
      int var2 = 0;
      var1.wS();

      for (int var4 : var1.kS()) {
         BasicBlock var5 = this.cfg.get(var4);
         BasicBlock var6 = boz.pC(var5);
         if (var6 != null && var6 != var5) {
            IDInstruction var7 = (IDInstruction)var6.getLast();
            if (var7.isJump() && var7.getBranchTarget() == var5.getBase() && this.pC(var6, var5)) {
               var2++;
            }
         }
      }
   ...
   private boolean pC(BasicBlock var1, BasicBlock var2) {
      ...
      if (var1.insize() == 1
         ...
         BasicBlock var7 = bpl.pC(var1, var5, 1);
   ...
   private boolean UT(bpa var1, boz var2) {
      int var3 = var1.kS();
      int var4 = var1.pC();
      if (var3 != 0 && var3 != var4) {
         BasicBlock var5 = this.cfg.get(var3);
