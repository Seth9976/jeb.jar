...
public class JK {
   private static final ILogger pC = GlobalLog.getLogger(JK.class);
   private Ti A = new Ti(true);

   public JK(oi var1) throws IOException, Ae {
      for (int var2 = 0; var2 < 1024; var2++) {
                  ...
                  switch (var14) {
                     ...
                     case "encoding":
                        try {
                           ...
                           pC.error("Unknown register encoding: %s", var15);
                        }
                     case "format":
                     case "set":
                     case "ehframe":
         ...
         this.A.A(var7, var6, var4, var5, var8);
      }
