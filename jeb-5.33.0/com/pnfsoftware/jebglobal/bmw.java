...
public class bmw extends AbstractJOptimizer {
   @Override
   public int perform() {
      if (this.m == null) {
         return 0;
         ...
         for (IJavaIdentifier var22 : var3) {
            ...
            for (int var18 = 0; var18 < var4.size(); var18++) {
               ...
               if (var23 < 0) {
                  if (var15 instanceof bno) {
                     var11.push((bno)var15);
                  } else if (var15 instanceof bnp) {
                     var11.pop();
                  }
               } else if (var15 instanceof bno) {
                  var12++;
               } else if (var15 instanceof bnp) {
               ...
               bmw.Av var16 = (bmw.Av)var2.get(var15);
               if (var16 != null) {
                  if (var16.pC == var22) {
                     var23 = var18;
                     var10 = true;
                  ...
                  if (var16.A != null && !var10 && var16.A.contains(var22)) {
                     var14 = 0;
                  }
               }
            }
   ...
   private Set pC(IJavaStatement var1) {
      HashSet var2 = new HashSet();
      this.pC(var1, var2);
      return var2;
   }

   private void pC(IJavaElement var1, Set var2) {
