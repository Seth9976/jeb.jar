...
public class amv {
   ...
   public IEVar pC(IERoutineContext var1, ICMethod var2) {
      ...
      IEGeneric var7 = this.pC.getWholeExpression();
      int var8 = this.pC.getBitStart();
      int var9 = this.pC.getBitsize();
      boolean var10 = var8 > 0;
      boolean var11 = false;
      boolean var12 = false;
      IWildcardType var13 = null;
      if (EUtil.hasTypeInfo(this.pC) && this.pC.getType().getEffectiveBitsize() > 0) {
         var13 = this.pC.getType().resolveA();
         int var14 = var13.getEffectiveBitsize();
         var11 = var14 != var7.getBitsize();
         var12 = var14 != this.pC.getBitsize();
      }

      if (var13 == null) {
         var13 = var7.getSafeType(var3);
         var13 = var13.updateProperties(this.pC.getType());
      ...
      return aku.pC(var13.getBitsize(), var13, (ICElement)var19);
   }
}
