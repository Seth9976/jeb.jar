...
public class bzv extends AbstractDOptimizer {
   public bzv() {
         ...
         if (var3.size() > 1) {
            for (int var4 = 0; var4 < var3.size() - 1; var4++) {
               ...
               if (var5.isAssign() && var5.getAssignDestination() instanceof IDField var6) {
                  ...
                  if (!var18.hasSideEffects(this.ctx, true) && (var18 instanceof IDImm || bpl.UT(var18))) {
                     for (int var19 = var4 + 1; var19 < var3.size(); var19++) {
                        IDInstruction var10 = (IDInstruction)var3.get(var19);
                        boolean var11 = !var10.visitInstruction(new bzw(this, var6), true);
                        if (!var11) {
                           ...
                           var11 = !var10.visitInstructionPostOrder(new bzx(this, var6, var12), true);
