...
public class bzg extends AbstractDOptimizer {
                           ...
                           if (var12.isAssignToVar() && var12.getAssignSource() instanceof IDImm var13 && var13.isZero()) {
                              ...
                              if (var23 != var5 && var23 == var6) {
                                 ...
                                 if (var24 != null) {
                                    ...
                                    if (this.pC(var25, var5, var6) == 1) {
                                       BasicBlock var26 = this.cfg.getBlockFor(var25);
                                       if (bpl.pC(this.cfg, var26, var9)) {
                                          if (pC) {
                                             bpv.Av var18 = ((bpv)var12).pC((var1x, var2, var3x) -> var2.add(var5.getId()));
   ...
   int pC(IDInstruction var1, IDVar var2, IDVar var3) {
