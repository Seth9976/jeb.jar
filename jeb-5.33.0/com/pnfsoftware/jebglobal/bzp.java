...
public class bzp extends AbstractDOptimizer {
   int pC;
   ...
   boolean pC(BasicBlock var1) {
      ...
      if (!var2.pC()) {
         ...
         BasicBlock var3 = var2.pC;
         this.analyzeChains();
         int var4 = var2.kS.getId();
         Long var5 = this.dfa.checkSingleDef(var2.wS, var4);
         if (var5 == null) {
            return false;
         } else {
            ...
            if (var12.isEmpty()) {
               ...
               for (long var14 : var12) {
                  if (var14 != var2.wS) {
                     ...
                     if (var16 != null) {
                        ...
                        } else if (this.pC(var16, var2.kS, var11)) {
               ...
               if (var9.isEmpty()) {
                  ...
                  var40.add(var2.pC.getBase());
                  var9.forEach(var2x -> var40.add(this.cfg.getBlockFor(var2x).getBase()));
                  bzq var41 = new bzq(this, this.cfg, var37.getBase(), var40, var10);
                  var41.pC(true);
                  if (!var41.kS()) {
                     return false;
                  } else {
                     ...
                     for (long var21 : var41.pC()) {
                        BasicBlock var23 = this.cfg.getBlockAt(var21);
                        if (var6 != null && var23 == var6) {
                           return false;
                        }

                        if (!var23.getIrregularOutputs().contains(var2.pC)) {
                           if (var23.canThrow()) {
                              return false;
                           }
                     ...
                     if (!this.pC(var3, var6)) {
                        ...
                        var41.pC().forEach(var2x -> var42.add(this.cfg.getBlockAt(var2x)));
                        if (var6 == null) {
                           ...
                           IDCallInfo var28 = this.ctx.createCallInfo(DInvokeType.STATIC, var27.getIndex(), Arrays.asList(var2.kS));
                           IDInstruction var29 = this.ctx.createAssign(var2.kS, var28).withOffset(var25);
                        ...
                        IDCallInfo var52 = this.ctx.createCallInfo(DInvokeType.STATIC, var50.getIndex(), Arrays.asList(var2.kS));
   ...
   boolean pC(IDInstruction var1, IDVar var2) {
   ...
   boolean pC(IDInstruction var1, IDVar var2, long[] var3) {
      if (var1.isJcond()
   ...
   boolean pC(BasicBlock var1, BasicBlock var2) {
   ...
   void pC(BasicBlock var1, IDVar var2) {
   ...
   static class Av {
      ...
      static boolean pC(BasicBlock var0) {
         return var0.size() == 3
            && var0.insize() == 0
            && var0.outsize() == 0
            && var0.irrinsize() > 0
      ...
      boolean pC() {
         ...
         if (((IDInstruction)var1.get(2)).getThrowExpression() == var2
            ...
            this.wS = ((IDInstruction)var1.get(1)).getOffset();
            this.kS = (IDVar)var4.getArgument(0);
            this.A = var2;
            return true;
         } else {
            return false;
