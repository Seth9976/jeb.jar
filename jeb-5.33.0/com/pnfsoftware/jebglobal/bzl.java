...
public class bzl extends AbstractDOptimizer {
   public bzl() {
      ...
      for (int var2 = 1; var2 < this.cfg.size(); var2++) {
         ...
         if (var3.size() == 1 && ((IDInstruction)var3.get(0)).isJcond()) {
            ...
            if (var5 instanceof IDCallInfo var6 && var6.getMethodSignature().equals("Ljava/util/Iterator;->hasNext()Z")) {
               ...
               if (var7 instanceof IDVar && this.pC(var2, var7.asVar())) {
                  var1++;
               }
            }
         }
   ...
   private boolean pC(int var1, IDVar var2) {
   ...
   private static boolean pC(IDInstruction var0, IDVar var1, IDVar var2) {
      return var0.visitDepthPre(new bzm(var1, var2));
   }
}
