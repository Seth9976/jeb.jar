...
public class ark extends AbstractEOptimizer {
         ...
         if (((IEStatement)var4.getLast()).isConditionalJump()) {
            for (int var2 = var3 + 1; var2 < this.cfg.size(); var2++) {
               ...
               if (var5.size() != 1 || !((IEStatement)var5.get(0)).isConditionalJump() || var5.insize() != 1) {
                  if (var2 - var3 >= 2 && this.pC(var3, var2)) {
   ...
   private boolean pC(int var1, int var2) {
      ...
      if (var3 == null) {
         ...
         for (int var25 = var1; var25 < var2; var25++) {
            ...
            int var32 = this.pC(var30, var3, var18);
            if (var32 < 0) {
               return false;
            }
   ...
   private boolean pC(IEStatement var1, IEVar var2, Set var3) {
   ...
   private int pC(IEGeneric var1, IEVar var2, Set var3) {
