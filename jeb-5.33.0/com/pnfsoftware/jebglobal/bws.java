...
public class bws extends AbstractDOptimizer {
   private static final ILogger pC = GlobalLog.getLogger(bws.class);
   private IDExpression A;
   private LinkedHashMap kS = new LinkedHashMap();
   private Integer wS;
      ...
      while (true) {
         while (true) {
            ...
            while (true) {
               ...
               if (this.kS.size() >= 2) {
                  this.wS = (int)this.cfg.get(var3).getBase();
                  Object[] var10000 = new Object[]{this.A, this.wS, this.kS.values()};
                  var21 = new ArrayList(this.kS.values());
                  if (var21.size() != 2) {
                     break;
                  }

                  BasicBlock var22 = this.cfg.getBlockAt(var5);
                  BasicBlock var24 = this.cfg.getBlockAt((long)((bws.Av)var21.get(0)).kS);
                  BasicBlock var11 = this.cfg.getBlockAt((long)((bws.Av)var21.get(1)).kS);
            ...
            int var23 = ((bws.Av)var21.get(0)).pC;
            BasicBlock var25 = this.cfg.get(var23);
            int var26 = ((bws.Av)var21.get(1)).pC;
            ...
            if (var23 + 1 == var26) {
               ...
               for (Entry var33 : this.kS.entrySet()) {
                  var28.addCase(var33.getKey(), this.ctx.createTarget(((bws.Av)var33.getValue()).kS), false);
               }

               IDInstruction var31 = this.ctx.createSwitch(this.A, var28);
               ...
               var34.transformToJump(this.ctx.createTarget(this.wS));
               this.cfg.addEdge(var12, this.cfg.getBlockAt((long)this.wS.intValue()));
               break;
            }
            ...
            if (((IDInstruction)var25.getLast()).getSize() >= 2) {
               ...
               for (Entry var16 : this.kS.entrySet()) {
                  var14.addCase(var16.getKey(), this.ctx.createTarget(((bws.Av)var16.getValue()).kS), false);
               }

               IDInstruction var29 = this.ctx.createSwitch(this.A, var14);
               ...
               var32.transformToJump(this.ctx.createTarget(this.wS));
               this.cfg.addEdge(var17, this.cfg.getBlockAt((long)this.wS.intValue()));
               break;
            }
         }
   ...
   private int pC(int var1, IDInstruction var2) {
      if (var2.getJcondCondition() instanceof IDOperation var3) {
         ...
         if (var11 == JavaOperatorType.EQ || var11 == JavaOperatorType.NE) {
            ...
            if (!(var5 instanceof IDImm) && var6 instanceof IDImm var7) {
               ...
               if (this.A == null) {
                  this.A = var5;
               } else if (!this.A.equalsEx(var5, false)) {
                  return -1;
               }
   ...
   private boolean pC(int var1, IDImm var2, int var3, boolean var4) {
      int var5 = (int)var2.getRawValue();
      if (this.kS.get(var5) != null) {
         return false;
      } else {
         this.kS.put(var5, new bws.Av(var1, var2, var3, var4));
         return true;
      }
   }
   ...
   private static class Av {
      ...
      Av(int var1, IDImm var2, int var3, boolean var4) {
         this.pC = var1;
         this.A = var2;
         this.kS = var3;
         this.wS = var4;
      ...
      public String toString() {
         String var1 = Strings.ff("@%d:%s->0x%X", this.pC, this.A, this.kS);
         if (this.wS) {
            var1 = var1 + "[rev]";
         }
