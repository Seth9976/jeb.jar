...
public class air extends AbstractCStatementOptimizer {
   @Override
   ...
   private int pC(ICSwitchStm var1) {
      int var2 = 0;
      ...
      for (ICBlock var6 : var3) {
         if (this.pC(var1, var4, var6, false)) {
            var2++;
         }
      }
   ...
   private int A(ICSwitchStm var1) {
      int var2 = 0;
      List var3 = var1.getConditionalBlocks();
      ...
      for (int var4 = 0; var4 < var1.sizeWithoutDefault(); var4++) {
         ...
         for (int var6 = var4 + 1; var6 < var1.sizeWithoutDefault(); var6++) {
            ...
            if ((var8 == CUtil.BreakFlowStatus.TRUE || var8 == CUtil.BreakFlowStatus.BREAK) && this.pC(var1, var5, var7, true)) {
               var2++;
               var3 = var1.getConditionalBlocks();
               var6--;
            }
   ...
   private boolean pC(ICSwitchStm var1, ICBlock var2, ICBlock var3, boolean var4) {
      if (var2.equals(var3)) {
         if (var4) {
   ...
   private void pC(ICSwitchStm var1, ICBlock var2, ICBlock var3) {
   ...
   private void pC(ICSwitchStm var1, ICBlock var2) {
