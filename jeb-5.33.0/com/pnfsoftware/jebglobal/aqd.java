...
public class aqd extends AbstractEOptimizer {
   private static final StructuredLogger pC = aco.pC(aqd.class);
   private boolean A;
   private boolean kS;
   private boolean wS;
            ...
            for (int var3 = 0; var3 < this.cfg.size(); var3++) {
               ...
               for (int var5 = 0; var5 < var4.size(); var5++) {
                  ...
                  if (var6 instanceof IEAssign var9 && var9.getDstOperand() instanceof IEVar) {
                     ...
                     var7 = this.pC(var9.getSrcOperand());
                  }
                  ...
                  if (var7 != null && var8 != null && var7 != var8 && (var6.getFlags() & 1) == 0) {
                     ...
                     if (var11 != null && (!this.A || var11.size() == 1)) {
                        ...
                        if ((
                           ...
                           if (!var15.isEmpty()) {
                              ...
                              if (!(var22 instanceof IEVar)) {
                                 anq var23 = new anq(var8);
                                 int var28 = 0;

                                 for (long var33 : var15) {
                                    var28 += var23.pC((IEGeneric)this.cfg.getInstruction(var33));
                                    if (var28 >= 2) {
   ...
   private IEVar pC(IEGeneric var1) {
