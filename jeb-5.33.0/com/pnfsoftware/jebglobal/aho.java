...
public class aho extends AbstractCBlockOptimizer {
   @Override
   protected int optimizeBlock(ICBlock var1) {
      ...
      for (int var3 = 0; var3 < var1.size(); var3++) {
         if (var1.get(var3) instanceof ICIfStm var5 && var5.size() == 2 && var5.hasDefaultBlock()) {
            ...
            boolean var8 = !var6.isEmpty() && var6.getLast() instanceof ICCall var9 && var9.isNonReturningCall();
            boolean var12 = !var7.isEmpty() && var7.getLast() instanceof ICCall var13 && var13.isNonReturningCall();
            if (var8 && !var12) {
