...
public class ccs extends AbstractDOptimizer {
   boolean pC;
   boolean A;
   boolean kS;

   public ccs(boolean var1, boolean var2, boolean var3) {
         ...
         while (true) {
            ...
            while (true) {
               ...
               if (var3.size() >= 2 && ((IDInstruction)var3.getLast()).isJump() && (var4 = (IDInstruction)var3.get(var3.size() - 2)).isAssign()) {
                  ...
                  if (this.pC && var6 instanceof IDField) {
                     var5 = true;
                     break;
                  }
               }
            ...
            if (this.A && var7 instanceof IDImm || this.kS && bpl.UT(var7)) {
               ...
               if (var8.size() == 1 && ((IDInstruction)var8.get(0)).isJcondOrSwitch()) {
                  ...
                  if (!var9.hasUseSideEffects(false)
                     && (var6 instanceof IDVar var10 ? pC(var9, var10) : var6 instanceof IDField && var9.find(var6, 0, 1, null) != null)) {
                     IDVar var20 = null;
                     if (var5) {
                        var20 = ((bpx)this.ctx).retrieveTemporaryVariable(var7.getType(), 0);
                     }
   ...
   static boolean pC(IDInstruction var0, IDVar var1) {
