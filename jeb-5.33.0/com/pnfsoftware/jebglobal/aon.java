...
public class aon extends AbstractEExpressionOptimizer {
   private static final StructuredLogger A = aco.pC(aon.class);
   ...
   protected AbstractEExpressionOptimizer.EOR optimizeExpression(IEGeneric var1) {
      ...
      if (var2 != null) {
         ...
         if (var3 == OperationType.LOG_AND && var4 instanceof IEOperation && var5 instanceof IEOperation) {
            ...
            if (A(((IEOperation)var4).getOperationType())) {
               var14 = (IEOperation)var4;
               var20 = (IEOperation)var5;
            } else if (A(((IEOperation)var5).getOperationType())) {
               var14 = (IEOperation)var5;
               var20 = (IEOperation)var4;
            }

            if (var14 != null && this.pC(var14, var20)) {
               OperationType var8 = kS(var20.getOperationType());
               if (var8 != null) {
         ...
         if (var3 == OperationType.LOG_OR && var4 instanceof IEOperation && var5 instanceof IEOperation) {
            ...
            if (pC(((IEOperation)var4).getOperationType())) {
               var15 = (IEOperation)var4;
               var21 = (IEOperation)var5;
            } else if (pC(((IEOperation)var5).getOperationType())) {
               var15 = (IEOperation)var5;
               var21 = (IEOperation)var4;
            }

            if (var15 != null && this.pC(var15, var21)) {
               OperationType var28 = wS(var21.getOperationType());
               if (var28 != null) {
            ...
            if (var3 == OperationType.SAR && EUtil.isImmValue(var5, var4.getBitsize())) {
               ...
               if (var3 == OperationType.CARRY && this.currentStatement != null && !(this.currentStatement instanceof IEAssign)) {
                  ...
                  if (var17 != null) {
                     ...
                     IEImm var34 = ajr.pC(0L, var30)._sub(var17);
   ...
   static boolean pC(OperationType var0) {
      return var0 == OperationType.LOG_EQ || var0 == OperationType.FEQ;
   }

   static boolean A(OperationType var0) {
      return var0 == OperationType.LOG_NEQ || var0 == OperationType.FNE;
   }

   static OperationType kS(OperationType var0) {
      switch (var0) {
         case GE_S:
   ...
   static OperationType wS(OperationType var0) {
      switch (var0) {
         case GE_S:
   ...
   private boolean pC(IEOperation var1, IEOperation var2) {
      if (var1.getOperand2() != null) {
         if (akt.pC(var1.getOperand1(), var2.getOperand1())) {
            return akt.pC(var1.getOperand2(), var2.getOperand2());
         } else {
            return akt.pC(var1.getOperand1(), var2.getOperand2()) ? akt.pC(var1.getOperand2(), var2.getOperand1()) : false;
         }
      } else {
         return var2.getOperand2() == null && akt.pC(var1.getOperand1(), var2.getOperand2());
      }
   }
}
