...
public class aqc extends AbstractEOptimizer {
   private static final StructuredLogger pC = aco.pC(aqc.class);
   private boolean A;
   ...
   private boolean pC(IEStatement var1, IEVar var2, IEVar var3) {
