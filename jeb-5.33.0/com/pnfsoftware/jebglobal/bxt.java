...
public class bxt extends AbstractDOptimizer {
   @Override
   public int perform() {
      int var1 = 0;
      int var2 = 0;
         ...
         for (int var4 = 0; var4 < var3.insize() - 1; var4++) {
            ...
            if (var5.size() != 1 || !((IDInstruction)var5.get(0)).isJump()) {
               for (int var6 = var4 + 1; var6 < var3.insize(); var6++) {
                  ...
                  if (this.pC(var5, var7)) {
                     BasicBlock var8 = null;
                     BasicBlock var9 = null;
                     if (this.pC(var5)) {
                        var8 = var5;
                        var9 = var7;
                     } else if (this.pC(var7)) {
                        var8 = var7;
                        var9 = var5;
                     }
            ...
            if (!this.ctx.getExceptionData().compareHandlers((int)var1.getBase(), (int)var2.getBase())) {
               ...
               if (var3 != var4) {
                  ...
                  for (int var5 = 0; var5 < var3; var5++) {
                     ...
                     if (!((bpv)var6).pC((IDInstruction)var2.get(var5))) {
                        return false;
                     }
                  }
   ...
   private boolean pC(BasicBlock var1) {
