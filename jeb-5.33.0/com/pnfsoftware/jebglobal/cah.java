...
public class cah extends AbstractDOptimizer {
   @Override
   public int perform() {
      int var1 = 0;
   ...
   boolean pC(BasicBlock var1, BasicBlock var2, IDVar var3, IDVar var4) {
      ...
      if (var6.getJcondCondition() instanceof IDOperation var8
         ...
         Integer var18 = cag.pC(var9, var3);
         if (var18 != null) {
            Couple var12 = cag.pC(var10, var4, var18, this.g);
