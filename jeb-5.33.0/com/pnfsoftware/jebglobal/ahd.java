...
public class ahd extends AbstractCBlockOptimizer {
   @Override
         ...
         if (var7.size() == 0) {
            ...
            if (var8 instanceof ICAssignment && ((ICAssignment)var8).getLeft() == var4) {
               ...
               if (var12 instanceof ICCall && var9.equals(var8)) {
                  ...
                  ICPredicate var10 = this.pC(var6.getPredicate(), var4);
                  var7.removeLast();
   ...
   private ICPredicate pC(ICPredicate var1, ICIdentifier var2) {
      if (var1.getExpression() instanceof ICOperation) {
         ...
         ICPredicate var6 = this.pC(var3.getFirstOperand(), var3.getSecondOperand(), var3.getOperator(), var5, false);
         if (var6 != null) {
            return var6;
         }
      }
   ...
   private ICPredicate pC(ICExpression var1, ICExpression var2, ICOperator var3, ICVisitor var4, boolean var5) {
      if (var1 instanceof ICOperation var6) {
         ...
         if (var6.getCountOfOperands() == 2 && (var7 == COperatorType.ADD || var7 == COperatorType.SUB) && !var6.getFirstOperand().visitDepthPost(var4)) {
            ...
            return this.pC(var6.getFirstOperand(), var8, var3, var4, true);
         }
      }
   ...
   private static class Av implements ICVisitor {
      private ICIdentifier pC;

      public Av(ICIdentifier var1) {
         this.pC = var1;
      }
