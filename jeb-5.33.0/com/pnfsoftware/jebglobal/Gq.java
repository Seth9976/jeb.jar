...
public class Gq {
   ...
   public static int pC(byte[] var0, IEncodedMemoryArea var1) {
      return EncodedMemoryAreaUtil.signExtendInt(var0, var1);
   }

   public static int A(byte[] var0, IEncodedMemoryArea var1) {
      return EncodedMemoryAreaUtil.zeroExtend(var0, var1);
   }

   public static long pC(byte[] var0, int var1, int var2) {
   ...
   public static int kS(int var0, int var1) {
      switch (var0) {
         case 0:
            return var1;
         case 1:
   ...
   public static long pC(int var0, int var1, long var2) {
      int var4 = (var1 >>> 1) * 8;
      if (var1 < 8) {
         return var2 << var4;
      } else if (var1 < 12) {
   ...
   public static double pC(int var0) {
      int var1 = (var0 & 128) >> 7;
      int var2 = (var0 & 64) >> 6;
      int var3 = ~var2 & 1;
      int var4 = (var0 & 48) >>> 4;
   ...
   public static long pC(long var0, int var2, int var3) {
      if (var3 % var2 != 0) {
         throw new RuntimeException("Replicate can not operate");
      } else {
         return A(var0, var2, var3 / var2);
      }
   }
   ...
   public static long kS(int var0) {
   ...
   public static int A(NC var0) {
      return Integer.parseInt(var0.UT()) >>> 3;
   }

   public static int kS(NC var0) {
      String var1 = var0.UT();
      switch (var1) {
         case "8":
            return 8;
   ...
   public static boolean wS(NC var0) {
      return var0.UT() != null && var0.UT().startsWith("S");
   }
}
