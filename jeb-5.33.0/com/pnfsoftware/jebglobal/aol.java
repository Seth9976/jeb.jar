...
public class aol extends AbstractEOptimizer {
   public aol() {
         ...
         for (BasicBlock var4 : this.cfg.getBlocks()) {
            if (var4.size() == 1
               ...
               for (BasicBlock var9 : var4.getInputBlocks()) {
                  ...
                  } else if (var10 instanceof IESwitch var25 && akt.pC(var25, this.cfg, var9, var4, var4.getOutputBlock(0))) {
                     var2++;
                  }
         ...
         for (BasicBlock var16 : this.cfg) {
            ...
            if (EUtil.isUnconditionalJump((IEStatement)var18.getInstruction())) {
               ...
               if (var20.getBranchAddress() == var18.getOffset() + var20.getSize()) {
                  if (var16.size() >= 2) {
                     if (akt.pC(this.ectx, var16, var16.size() - 1) != 0) {
                        var2++;
                     }
