...
public class ahz extends AbstractCOptimizer {
   private static final StructuredLogger pC = aco.pC(ahz.class);

   @Override
   protected int perform() {
      int var1 = 0;
      agc var2 = new agc(this.m);
