...
public class KV {
   public static ICompiler pC(ICodeObjectUnit var0) {
      if (var0 instanceof com.pnfsoftware.jeb.corei.parsers.elf.sy) {
      ...
      } else if (var0 instanceof com.pnfsoftware.jeb.corei.parsers.winpe.yt) {
         ...
         return var0 instanceof com.pnfsoftware.jeb.corei.parsers.wincoff.K ? ICompiler.COMP_VISUAL_STUDIO : ICompiler.COMP_UNKNOWN;
      }
   }

   public static ICompiler pC(int var0) {
      switch (var0) {
         case 1:
