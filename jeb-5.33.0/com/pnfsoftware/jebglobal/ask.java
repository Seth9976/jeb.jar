...
public class ask extends aqv {
   ...
   protected int pC(IEVar var1, IEGeneric var2, IEStatement var3, int var4, int var5) {
      var4 = super.pC(var1, var2, var3, var4, var5);
   ...
   private static boolean pC(IEGeneric var0) {
   ...
   private static boolean kS(IEGeneric var0) {
      if (var0 instanceof IEVar) {
         return pC((IEVar)var0);
      } else if (!EUtil.isOperation(var0, OperationType.ADD)) {
         return false;
      } else {
         IEOperation var1 = (IEOperation)var0;
         return var1.getOperand1() instanceof IEVar && kS(var1.getOperand1()) && var1.getOperand2() instanceof IEImm;
      }
   }

   private static boolean pC(IEVar var0) {
