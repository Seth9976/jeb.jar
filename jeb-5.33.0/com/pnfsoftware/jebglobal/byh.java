...
public class byh extends AbstractDOptimizer {
   @Override
   public int perform() {
      byh.Av var1 = new byh.Av();
   ...
   private class Av implements IDVisitor {
         ...
         if (var1.getCustomCanThrow() != null) {
            ...
            if (var1 instanceof IDArrayElt var4 && var4.getIndex().isConstantImm()) {
               ...
               if (var6 < 0) {
                  ...
                  Integer var7 = this.pC(var4.getArray(), this.pC.getOffset());
                  if (var7 != null) {
                     var5 = var6 >= var7;
                  }
               }
      ...
      private Integer pC(IDExpression var1, long var2) {
         if (var1 instanceof IDNewArrayInfo var4 && var4.getSize().isConstantImm()) {
            ...
            if (var1 instanceof IDVar var9) {
               byh.this.analyzeChains();
               int var5 = var9.getId();
               Long var6 = byh.this.dfa.checkSingleDef(var2, var5);
               if (var6 != null && var6 != -1L) {
                  IDInstruction var7 = (IDInstruction)byh.this.cfg.getInstructionAt(var6);
                  if (var7.isAssignToVar(var5)) {
                     IDExpression var8 = var7.getAssignSource();
                     return this.pC(var8, var6);
                  }
               }
            }
