...
public class aju extends ajr {
   ...
   public static aju kS(double var0) {
      aju var2 = (aju)UT.get(var0);
      if (var2 == null) {
         var2 = new aju(var0);
         UT.put(var0, var2);
      }
   ...
   public ajw ys() {
      ajw var1 = ajw.A(Double.doubleToRawLongBits(this.wS), 64);
      if (this.isMutable()) {
