...
class cko implements IEventListener {
   cko(ckn var1) {
      this.pC = var1;
   }
   ...
   public void onEvent(IEvent var1) {
      if (var1.getType() == J.UnitProcessed && var1.getSource() instanceof IApkUnit) {
         ...
         if (!UnitUtil.filterDescendants(var2, -1, new ckp(this)).isEmpty()) {
            String var3 = "";
            var3 = var3
               + S.L(
            ...
            if (this.pC.pC()) {
               var3 = var3 + Strings.ff(S.L("Try running the plugin \"%s\" and see if the protected data can be recovered"), ckn.A.getName());
            }
