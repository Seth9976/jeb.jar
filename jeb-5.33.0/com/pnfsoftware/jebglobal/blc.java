...
public class blc extends AbstractJBlockOptimizer {
   @Override
            ...
            if (var6.getLeft() instanceof IJavaDefinition) {
               ...
               if (var6.getRight() instanceof IJavaCall) {
                  ...
                  if (var10.equals("iterator")) {
                     ...
                     if (this.pC(var1, var4, (IJavaWhile)var5, var7, var8)) {
                        var3++;
                     }
                  }
               }
   ...
   private boolean pC(IJavaBlock var1, int var2, IJavaWhile var3, IJavaDefinition var4, IJavaExpression var5) {
            ...
            if (!var14.isEmpty() && var14.get(0) instanceof IJavaAssignment) {
               ...
               if (var11 == null) {
                  ...
                  for (int var16 = 1; var16 < var14.size(); var16++) {
                     if (!var14.get(var16).visitDepthPost(new bld(this, var4))) {
                        return false;
                     }
                  }
