...
public class arc extends AbstractEOptimizer {
   public arc() {
   ...
   protected int perform() {
      arc.Av var1 = new arc.Av();

      for (IEStatement var3 : this.cfg.instructions()) {
         var1.pC(var3, null);
      }

      return this.postPerform(var1.pC, var1.A);
   }
   ...
   private class Av {
      ...
      void pC(IEGeneric var1, IEGeneric var2) {
      ...
      private int A(IEGeneric var1, IEGeneric var2) {
         Object var3 = null;
         if (EUtil.isZeroExtend(var1)) {
            ...
            if (var5 == OperationType.LOG_NOT) {
               if (var4.getOperand1().isOperation(OperationType.SUB)) {
                  ...
                  var3 = arc.this.ectx.createOperation(OperationType.LOG_EQ, var6.getOperand1(), var6.getOperand2());
                  ((IEGeneric)var3).copyProperties(var1);
               }
            } else if (var5 == OperationType.SUB) {
               var3 = arc.this.ectx.createOperation(OperationType.LOG_NEQ, var4.getOperand1(), var4.getOperand2());
               ((IEGeneric)var3).copyProperties(var1);
            }
         }
