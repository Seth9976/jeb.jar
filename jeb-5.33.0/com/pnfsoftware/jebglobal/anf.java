...
class anf implements IEVisitor {
   anf(anc var1, AtomicInteger var2) {
      this.A = var1;
      this.pC = var2;
   }
      ...
      if (var1.isMem()) {
         ...
         if (var5 != null) {
            ...
            if (var6.getType() != null && var6.getType().getNativeType() != null && TypeUtil.isPointer(var6.getType().getNativeType())) {
               ayt var9 = (ayt)var6.getType().getNativeType();
               if (TypeUtil.getNonAlias(var9.getPointedType()) instanceof ayv) {
                  return;
               }
            }

            long var16 = var6.getAddress();
            IEVar var11 = this.A.pC.getStackManager().getVariable(var16);
            if (var11 == null) {
               return;
            }
               ...
               if (var6.getType().isDefined()) {
                  ...
                  if (TypeUtil.isReference(var19)) {
                     ...
                     if (var19.getSize() * 8 == var13) {
                        var17 = this.A.wS.create(var19);
                        this.A.pC.acquireNativeItem(var17);
                     }
                  }
               }

               if (var17 == null) {
                  var17 = this.A.wS.createWithMaximumBitsize(var13);
               }
