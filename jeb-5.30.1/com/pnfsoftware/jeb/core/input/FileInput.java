...
public final class FileInput implements IInput {
   ...
   private FileInput(File var1, boolean var2) throws IOException {
   ...
   private FileInput(String var1, boolean var2) throws IOException {
      if (var1 == null) {
   ...
   private boolean setup(boolean var1) throws IOException {
      ...
      try (
         ...
         int var4 = var3.read(this.hdr);
         this.hdr.limit(Math.max(0, var4));
         this.hdr.position(0);
      }
