...
import com.pnfsoftware.jeb.corei.parsers.dex.CU;
...
public class DexUtil {
   ...
   private static List getMemberClasses(IDexUnit var0, IDexItem var1) {
      ...
      oL var3 = ((bK)var0).io().q((CU)var1);

      for (oL var5 : var3.getChildren()) {
         if (var5.xK() instanceof IDexClass) {
            var2.add((IDexClass)var5.xK());
         }
      }
   ...
   public static String getStringSafe(IDexUnit var0, int var1, String var2) {
      return ((bK)var0).q(var1, var2, false);
   }
