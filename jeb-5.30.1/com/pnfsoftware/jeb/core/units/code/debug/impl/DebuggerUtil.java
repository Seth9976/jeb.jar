...
import com.pnfsoftware.jeb.corei.debuggers.android.vm.LR;
...
public class DebuggerUtil {
   ...
   public static boolean valueEquals(IDebuggerVariable var0, IDebuggerVariable var1) {
      if (var0 != var1 && !var0.equals(var1)) {
         try {
            if (var0 instanceof LR && var1 instanceof LR) {
               ch var5 = ((LR)var0).q();
               ch var6 = ((LR)var1).q();
               if (var5 != null && var6 != null) {
                  return var5.RF == var6.RF && isCompatibleJDWPTag(var5.q, var6.q);
               }

               return false;
            }
         } catch (IOException | zy var4) {
            return false;
         }
   ...
   private static boolean isCompatibleJDWPTag(byte var0, byte var1) {
      return var0 == var1 ? true : var0 == 76 && Pi.Uv(var1) || var1 == 76 && Pi.Uv(var0);
   }
}
