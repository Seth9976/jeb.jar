...
public class CDocument extends CodeDocument {
   private static final StructuredLogger logger = aeg.q(CDocument.class);
   ...
   public CDocument(INativeSourceUnit var1) {
      this.srcUnit = var1;
      this.decomp = (adw)var1.getParent();
   ...
   public COutputSink getDocumentPart(long var1, int var3, int var4) {
      ...
      if (!(var6 instanceof ICClass) && !(var6 instanceof ICMethod) && !(var6 instanceof ICField)) {
         ...
         var5.setDynamicContentManager(this.decomp.q());
         var5.setSourceCustomizer(this.decomp.Uv());
         var6.generate(var5);
         var5.validate();
