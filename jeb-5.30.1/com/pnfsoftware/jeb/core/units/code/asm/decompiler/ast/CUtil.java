...
public class CUtil {
   ...
   public static boolean canFallthrough(ICStatement var0, ICStatement var1, boolean var2) {
      if (var0 == null || var1 == null) {
         ...
         return false;
      } else if (var0 instanceof ICBlock) {
         return canFallthrough(((ICBlock)var0).getLast(), var1, var2);
      } else if (var0 instanceof ICConditionalStatement && ((ICConditionalStatement)var0).hasDefaultBlock()) {
         boolean var3 = true;

         for (ICBlock var5 : ((ICConditionalStatement)var0).getBlocks()) {
            if (var5.isEmpty()) {
               var3 = false;
               break;
            }

            if (!var5.isEmpty() && canFallthrough(var5, var1, var2 || var0 instanceof ICSwitchStm)) {
               var3 = false;
               break;
            }
         }
   ...
   public static List getPreviouslyExecutedStatements(ICMethod var0, ICStatement var1) {
      ...
      if (var2 == null) {
         ...
         return getPreviouslyExecutedStatements(var0, (ICBlock)var2, var1);
      } else {
   ...
   public static ICStatement getParentBlock(ICMethod var0, ICStatement var1) {
      ICElement var2 = getParentBlockInner(var0.getBody(), var1, null);
      return var2 instanceof ICStatement ? (ICStatement)var2 : null;
   }
      ...
      if (var0 == var1) {
         ...
         for (ICElement var4 : var0.getSubElements()) {
            ...
            if (var4 instanceof ICCompound) {
               ICElement var5 = getParentBlockInner((ICCompound)var4, var1, var0);
               if (var5 != null) {
                  return var5;
               }
            }
      ...
      if (!(var0 instanceof ICReturn)
         ...
         if (!(var0 instanceof ICAssignment) && !(var0 instanceof ICLabel) && !(var0 instanceof ICCustomStatement) && !(var0 instanceof ICDecl)) {
            if (var0 instanceof ICBreak) {
               return ((ICBreak)var0).getLabel() == null ? CUtil.BreakFlowResult.BREAK : CUtil.BreakFlowResult.TRUE;
            } else if (var0 instanceof ICConditionalStatement) {
               boolean var7 = false;
               boolean var8 = false;
               if (!((ICConditionalStatement)var0).hasDefaultBlock()) {
                  var8 = true;
               }
               ...
               for (ICBlock var5 : ((ICConditionalStatement)var0).getBlocks()) {
                  CUtil.BreakFlowResult var6 = getBreakingFlowResult(var5);
                  switch (var6.getStatus()) {
                     case TRUE:
                        var7 = true;
                        var3 &= var6.isLastInstruction();
                        break;
                     case FALSE:
                        var8 = true;
                        var3 = false;
               ...
               if (var7 && var8) {
                  return new CUtil.BreakFlowResult(CUtil.BreakFlowStatus.BOTH, var3);
               } else {
                  return var7 ? new CUtil.BreakFlowResult(CUtil.BreakFlowStatus.TRUE, var3) : CUtil.BreakFlowResult.FALSE;
               }
            } else if (!(var0 instanceof ICBlock)) {
               return CUtil.BreakFlowResult.UNKNOWN;
            } else if (((ICBlock)var0).isEmpty()) {
               return CUtil.BreakFlowResult.FALSE;
            } else {
               for (int var1 = 0; var1 < ((ICBlock)var0).size(); var1++) {
                  CUtil.BreakFlowResult var2 = getBreakingFlowResult(((ICBlock)var0).get(var1));
                  if (var2.getStatus() == CUtil.BreakFlowStatus.TRUE) {
                     return new CUtil.BreakFlowResult(var2.getStatus(), var2.isLastInstruction() && var1 == ((ICBlock)var0).size() - 1);
                  }

                  if (var2.getStatus() != CUtil.BreakFlowStatus.FALSE) {
                     return new CUtil.BreakFlowResult(var2.getStatus(), var2.isLastInstruction() && var1 == ((ICBlock)var0).size() - 1);
                  }
               }
   ...
   public static ICExpression notLDeepReplace(ICMethod var0, ICExpression var1) {
      ...
      if (var2 instanceof ICOperation) {
         ICExpression var3 = resolveNotOperation(var0, (ICOperation)var2, null);
         if (var3 != null) {
            return var3;
         }
      }
   ...
   public static ICExpression resolveNotOperation(ICMethod var0, ICOperation var1, ICElement var2) {
      if (var1.getOperatorType() == COperatorType.LOG_NOT && var1.getFirstOperand() instanceof ICOperation) {
         ICOperation var3 = (ICOperation)var1.getFirstOperand();
         ICOperation var4 = var3.duplicate();
         if (var4.reverse(var0.getGlobalContext().getOperatorFactory())) {
            if (var2 == null || var2.replaceSubElement(var1, var4)) {
               return var4;
            }
         } else if (var4.getOperatorType() == COperatorType.LOG_AND) {
            var4 = orL(var0, notL(var0, var4.getFirstOperand()), notL(var0, var4.getSecondOperand()));
            if (var2 == null || var2.replaceSubElement(var1, var4)) {
               resolveNotOperationG(var0, var4.getFirstOperand(), var4);
               resolveNotOperationG(var0, var4.getSecondOperand(), var4);
               return var4;
            }
         } else if (var4.getOperatorType() == COperatorType.LOG_OR) {
            var4 = andL(var0, notL(var0, var4.getFirstOperand()), notL(var0, var4.getSecondOperand()));
            if (var2 == null || var2.replaceSubElement(var1, var4)) {
               resolveNotOperationG(var0, var4.getFirstOperand(), var4);
               resolveNotOperationG(var0, var4.getSecondOperand(), var4);
               return var4;
   ...
   private static ICExpression resolveNotOperationG(ICMethod var0, ICExpression var1, ICElement var2) {
      return var1 instanceof ICOperation ? resolveNotOperation(var0, (ICOperation)var1, var2) : null;
   }
   ...
   public static ICDecl getDefinition(ICElement var0) {
      ICDecl var1 = null;
      if (var0 instanceof ICDecl) {
         var1 = (ICDecl)var0;
      }

      if (var0 instanceof ICAssignment var2 && var2.getLeft() instanceof ICDecl) {
         var1 = (ICDecl)var2.getLeft();
      }
   ...
   private static void visitICStatementDepthPostInternal(ICVisitor var0, ICStatement var1, ICStatement var2, CVisitResults var3) {
      ...
      for (ICElement var6 : var4) {
         if (!isClassMethodField(var6) && var6 instanceof ICStatement) {
            visitICStatementDepthPostInternal(var0, (ICStatement)var6, var1, var3);
            if (var3.isInterruptedVisit()) {
               return;
            }
         }
   ...
   public static boolean containsStatement(ICStatement var0, Class var1) {
      if (var1.isInstance(var0)) {
         ...
         if (var0 instanceof ICCompound) {
            for (ICBlock var3 : ((ICCompound)var0).getBlocks()) {
               for (ICStatement var5 : var3) {
                  if (containsStatement(var5, var1)) {
                     return true;
                  }
               }
            }
