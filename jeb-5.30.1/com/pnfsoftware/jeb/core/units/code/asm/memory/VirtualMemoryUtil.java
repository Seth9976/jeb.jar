...
public class VirtualMemoryUtil {
   ...
   public static int read(IVirtualMemory var0, long var1) {
      try {
         return var0.readByte(var1) & 0xFF;
   ...
   public static boolean readSafe(IVirtualMemory var0, long var1, byte[] var3) {
      try {
         var0.read(var1, var3.length, var3, 0);
         return true;
   ...
   public static boolean writeSafe(IVirtualMemory var0, long var1, byte[] var3) {
      try {
         var0.write(var1, var3.length, var3, 0);
         return true;
      } catch (MemoryException var4) {
         return false;
      }
   ...
   public static boolean readShortSafe(Endianness var0, IVirtualMemory var1, long var2, short[] var4) {
      try {
         var4[0] = var0.isLittle() ? var1.readLEShort(var2) : var1.readBEShort(var2);
         return true;
      } catch (MemoryException var5) {
         return false;
      }
   ...
   public static boolean readIntSafe(Endianness var0, IVirtualMemory var1, long var2, int[] var4) {
      try {
         var4[0] = var0.isLittle() ? var1.readLEInt(var2) : var1.readBEInt(var2);
         return true;
      } catch (MemoryException var5) {
         return false;
      }
   ...
   public static boolean readLongSafe(Endianness var0, IVirtualMemory var1, long var2, long[] var4) {
      try {
         var4[0] = var0.isLittle() ? var1.readLELong(var2) : var1.readBELong(var2);
         return true;
      } catch (MemoryException var5) {
         return false;
      }
   ...
   public static boolean writeShortSafe(Endianness var0, IVirtualMemory var1, long var2, short var4) {
      try {
         if (var0.isLittle()) {
            var1.writeLEShort(var2, var4);
         } else {
            var1.writeBEShort(var2, var4);
         }
   ...
   public static boolean writeIntSafe(Endianness var0, IVirtualMemory var1, long var2, int var4) {
      try {
         if (var0.isLittle()) {
            var1.writeLEInt(var2, var4);
         } else {
            var1.writeBEInt(var2, var4);
         }
   ...
   public static boolean writeLongSafe(Endianness var0, IVirtualMemory var1, long var2, long var4) {
      try {
         if (var0.isLittle()) {
            var1.writeLELong(var2, var4);
         } else {
            var1.writeBELong(var2, var4);
         }
   ...
   public static boolean writeBytes(IVirtualMemory var0, long var1, byte[] var3, int var4, int var5) {
      try {
         var0.write(var1, var5, var3, var4);
         return true;
      } catch (MemoryException var6) {
         return false;
      }
   ...
   public static boolean readBytes(IVirtualMemory var0, long var1, byte[] var3, int var4, int var5) {
      try {
         var0.read(var1, var5, var3, var4, true);
         return true;
      } catch (MemoryException var6) {
         return false;
      }
   ...
   public static Long readAsLongSafe(IVirtualMemory var0, Endianness var1, long var2, int var4) {
      ...
      try {
         var6 = var0.read(var2, var4, var5, 0);
