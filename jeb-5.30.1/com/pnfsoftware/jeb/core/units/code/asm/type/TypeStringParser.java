...
import com.pnfsoftware.jebglobal.bch;
...
public class TypeStringParser {
   ...
   public TypeStringParser.Decl parseDeclaration(String var1, boolean var2) throws TypeStringParseException {
      ...
      if (var3 == null) {
         ...
         return new TypeStringParser.Decl(var3.q(), var3.RF());
      }
   }
   ...
   public IPrototypeItem parsePrototype(String var1) throws TypeStringParseException {
      ...
      if (var2 == null) {
         ...
         if (!Strings.isBlank(var4)) {
            ...
            var4 = var5.toString();
            ICallingConvention var6 = this.typeman.Dw().getConvention(var4);
            if (var6 == null) {
   ...
   private bbd parseForType(String var1) {
      return this.parseSingleDeclaration(var1).q();
   }

   private bch parseSingleDeclaration(String var1) {
      return (bch)Lists.get(this.parseInternal(var1, false), 0);
   }

   public List parseTypesRaw(String var1) throws TypeStringParseException {
      try {
         return (List)this.parseInternal(var1, true).stream().map(var0 -> var0.q()).collect(Collectors.toList());
   ...
   private List parseInternal(String var1, boolean var2) {
      bcn var3 = new bcn(CharStreams.fromString(var1));
      ...
      if (this.typeman == null) {
         ...
         bca var8 = new bca(1, var2);
         bcj var9 = new bcj(var6, var8, this.typeman);
         return var9.Dw();
      }
   }
