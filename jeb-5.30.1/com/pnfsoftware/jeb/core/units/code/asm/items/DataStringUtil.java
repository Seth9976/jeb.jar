...
import com.pnfsoftware.jebglobal.aaj;
import com.pnfsoftware.jebglobal.axw;
   ...
   private static StringEntry getStringItemFromMemory(
      ...
      if (var7 > var8) {
         ...
         for (StringEncoding var13 : var9) {
            ...
            long var16 = var2 + var15;
            if (var4 >= 0L) {
               var16 = Math.min(var4, var16);
               var15 = (int)(var16 - var2);
               var8 = var15 / var14;
            }

            Couple var18 = determineSize(var1, var2, var16, var15, var14, var13);
            if (var18 != null) {
               int var19 = (Integer)var18.getFirst();
               var13 = (StringEncoding)var18.getSecond();
               String var20 = determineValue(var13, var1, var2, var19, var10);
               if (var20 != null && var20.length() >= var7 && var20.length() <= var8 && (!var10 || heurIsValidString(var20, var7))) {
                  StringEntry var21 = new StringEntry(var20, var2, var19, var13, null);
                  var11.add(var21);
               }
            }
         }
         ...
         if (var11.isEmpty()) {
            ...
            StringEntry var22 = chooseBestStringType(var11);
            if (var0 == null) {
               return var22;
            } else {
               int var24 = var22.encoding.getBasicCharSize();
               ITypeManager var25 = var0.getTypeManager();
               IPrimitiveType var26 = var25.getPrimitives().getIntegerBySize(var24, true);
               IArrayType var27 = var25.createArray(var26, var22.size / var24);
               axw var17 = (axw)var0.createString(var2, var22.size, var27, var22.encoding, null);
               var17.xK(var22.str);
               String var28 = createItemNameFromString(var22.str, 16);
               if (var28 != null) {
                  var17.setName(var28);
               }
