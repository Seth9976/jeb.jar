...
import com.pnfsoftware.jeb.corei.parsers.asm.nativesig.siggen.Vj;
import com.pnfsoftware.jeb.corei.parsers.asm.nativesig.siggen.oL;
import com.pnfsoftware.jeb.corei.parsers.asm.nativesig.siggen.vb;
...
public class SiglibGen {
   ...
   public static void main(String[] var0) throws UnsupportedEncodingException {
      ...
      if (var0.length != 1) {
         ...
         try {
            vb.q(var12, var11, var13, true, true);
