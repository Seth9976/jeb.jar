...
public class RegisterBankArm64 extends AbstractRegisterBank {
   ...
   private static final String[][] _2_3_9 = new String[][]{
      ...
      null,
      null,
      {"SPMCR_EL0", "SPMCNTENSET_EL0", "SPMCNTENCLR_EL0", "SPMOVSCLR_EL0", null, "SPMSELR_EL0"},
      null,
   ...
   private static final String[][] _sysRegs_3_0_0 = new String[][]{
      ...
      {"ID_AA64PFR0_EL1", "ID_AA64PFR1_EL1", "ID_AA64PFR2_EL1", null, "ID_AA64ZFR0_EL1", "ID_AA64SMFR0_EL1"},
      {"ID_AA64DFR0_EL1", "ID_AA64DFR1_EL1", null, null, "ID_AA64AFR0_EL1", "ID_AA64AFR1_EL1"},
   ...
   private static final String[][] _3_0_9 = new String[][]{
      ...
      {"PMBLIMITR_EL1", "PMBPTR_EL1", null, "PMBSR_EL1", "PMSDSFR_EL1", null, null, "PMBIDR_EL1"},
   ...
   private static final String[][] _3_0_10 = new String[][]{
      ...
      {"LORSA_EL1", "LOREA_EL1", "LORN_EL1", "LORC_EL1", "MPAMIDR_EL1", null, null, "LORID_EL1"},
      {"MPAM1_EL1", "MPAM0_EL1", null, "MPAMSM_EL1"}
   };
   ...
   private static final String[][] _special_3_3_4 = new String[][]{
      null, null, {"NZCV", "DAIF", "SVCR", null, null, "DIT", "SSBS", "TCO"}, null, {"FPCR", "FPSR"}, {"DSPSR_EL0", "DLR_EL0"}
   };
   ...
   private static final String[][] _3_4_9 = new String[][]{null, null, null, null, null, null, null, null, null, {"PMSCR_EL2"}};
   ...
   private static final String[][] _3_4_12 = new String[][]{
      ...
      null,
      null,
      {"ICH_AP0R0_EL2", "ICH_AP0R1_EL2", "ICH_AP0R2_EL2", "ICH_AP0R3_EL2"},
      {"ICH_AP1R0_EL2", "ICH_AP1R1_EL2", "ICH_AP1R2_EL2", "ICH_AP1R3_EL2", null, "ICC_SRE_EL2"},
      null,
      {"ICH_HCR_EL2", "ICH_VTR_EL2", "ICH_MISR_EL2", "ICH_EISR_EL2", null, "ICH_ELRSR_EL2", null, "ICH_VMCR_EL2"},
      {"ICH_LR0_EL2", "ICH_LR1_EL2", "ICH_LR2_EL2", "ICH_LR3_EL2", "ICH_LR4_EL2", "ICH_LR5_EL2", "ICH_LR6_EL2", "ICH_LR7_EL2"},
      {"ICH_LR8_EL2", "ICH_LR9_EL2", "ICH_LR10_EL2", "ICH_LR11_EL2", "ICH_LR12_EL2", "ICH_LR13_EL2", "ICH_LR14_EL2", "ICH_LR15_EL2"}
   };
   private static final String[][] _3_4_13 = new String[][]{
      {null, "CONTEXTIDR_EL2", "TPIDR_EL2", null, null, null, null, "SCXTNUM_EL2"},
      null,
      null,
      null,
      null,
   ...
   private static final String[][] _system_3_5_1 = new String[][]{
      {"SCTLR_EL12", null, "CPACR_EL12", "SCTLR2_EL12"}, null, {"ZCR_EL12", "TRFCR_EL12", null, "TRCITECR_EL12", null, null, "SMCR_EL12"}
   };
   private static final String[][] _system_3_5_2 = new String[][]{
      {"TTBR0_EL12", "TTBR1_EL12", "TCR_EL12", "TCR2_EL12"}, null, null, null, null, {"GCSCR_EL12", "GCSPR_EL12"}
   };
   ...
   private static final String[][] _system_3_5_9 = new String[][]{null, null, null, null, null, null, null, null, null, {"PMSCR_EL12"}};
   private static final String[][] _system_3_5_10 = new String[][]{
      null, null, {"MAIR_EL12", "MAIR2_EL12", "PIRE0_EL12", "PIR_EL12", "POR_EL12"}, {"AMAIR_EL12", "AMAIR2_EL12"}, null, {"MPAM1_EL12"}
   };
   ...
   private static final String[][] _3_6_1 = new String[][]{
      ...
      {"SCR_EL3", "SDER32_EL3", "CPTR_EL3"},
      {"ZCR_EL3", null, null, null, null, null, "SMCR_EL3"},
      {null, "MDCR_EL3"}
   };
   private static final String[][] _3_6_2 = new String[][]{
      {"TTBR0_EL3", null, "TCR_EL3"}, {null, null, null, null, "GPTBR_EL3", null, "GPCCR_EL3"}, null, null, null, {"GCSCR_EL3", "GCSPR_EL3"}
   };
   private static final String[][] _special_3_6_4 = new String[][]{{"SPSR_EL3", "ELR_EL3"}, {"SP_EL2"}};
   private static final String[][] _3_6_5 = new String[][]{null, {"AFSR0_EL3", "AFSR1_EL3"}, {"ESR_EL3"}, null, null, null, {"TFSR_EL3"}};
