   ...
   public static int removeUnreachableBlocks(CFG var0, Deque var1) {
      ...
      while (!var1.isEmpty()) {
         ...
         if (var6 != var3 && var2.add(var6)) {
            ...
            for (BasicBlock var17 : var5.getIrregularOutputBlocks()) {
               var0.deleteIrregularEdges(var5, var17);
            }

            for (BasicBlock var18 : var8) {
               if (var18.allinsize() == 0) {
                  var1.add(var18);
               }
            }
         }
      ...
      for (long var12 : var2) {
         BasicBlock var13 = var0.getBlockAt(var12);
         var0.removeBlock(var13);
         BasicBlock var16 = var0.getBlockEndingAt(var13.getFirstAddress());
         if (var16 != null) {
            IInstruction var19 = var16.getLast();
            if (var19 instanceof IResizableInstruction) {
               ((IResizableInstruction)var19).adjustSize(var13.getSizeOfInstructions());
            }
         }
      }
