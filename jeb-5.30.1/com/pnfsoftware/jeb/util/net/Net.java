...
public class Net implements INet {
   ...
   OkHttpClient buildClient(String var1) {
      return this.buildClient(var1, null);
   }

   OkHttpClient buildClient(String var1, IProgressCallback var2) {
      Builder var3 = new Builder()
         .connectTimeout(this.timeoutConnect, TimeUnit.MILLISECONDS)
         .readTimeout(this.timeoutRead, TimeUnit.MILLISECONDS)
         .writeTimeout(this.timeoutWrite, TimeUnit.MILLISECONDS);
      if (var2 != null) {
         var3.addNetworkInterceptor(new Net$2(this, var2));
      }

      NetProxyInfo var4 = this.getProxyInformation();
      if (var4 != null && !var4.isWhitelisted(var1)) {
         var3.proxy(var4.getProxy());
         okhttp3.Authenticator var5 = var4.getAuthenticator();
         if (var5 != null) {
            var3.proxyAuthenticator(var5);
         }
      }

      if (this.ssinfo != null) {
         SSLContext var6 = this.ssinfo.getSslContext();
         if (this.ssinfo.getTrustManager() != null) {
            var3.sslSocketFactory(var6.getSocketFactory(), this.ssinfo.getTrustManager());
         } else {
            var3.sslSocketFactory(var6.getSocketFactory());
         }

         if (this.ssinfo.getHostnameVerifier() != null) {
            var3.hostnameVerifier(this.ssinfo.getHostnameVerifier());
         }
      }
