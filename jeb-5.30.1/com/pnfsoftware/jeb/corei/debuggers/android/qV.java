...
class qV extends AbstractCommandHandler {
   qV(nI var1, ICommandManager var2, String var3, String var4) {
   ...
   public ExecutionResult execute(List var1) {
      return getParameter(var1, 0) != null ? ExecutionResult.NOT_IMPLEMENTED : ExecutionResult.fromBoolean(this.q.Uv.run());
   }
}
