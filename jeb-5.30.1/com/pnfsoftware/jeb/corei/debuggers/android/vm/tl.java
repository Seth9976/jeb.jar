...
public class tl extends DebuggerMachineInformation {
   Uz q;

   public tl(Uz var1, String var2, String var3, int var4, String var5) {
   ...
   public List getProcesses() {
      ...
      AdbDevice var2 = this.q(this.getName());
      if (var2 != null) {
         AdbWrapper var3 = this.q.q().createWrapper(var2.getSerial());
         ...
         if (var4 != null) {
            for (AdbProcess var6 : var4) {
               ...
               byte var9 = 0;
               var1.add(new Nz(var7, var8, var9));
            }
         }
      }
   ...
   private AdbDevice q(String var1) {
      List var2 = this.q.q().listDevices();
      if (var2 != null) {
