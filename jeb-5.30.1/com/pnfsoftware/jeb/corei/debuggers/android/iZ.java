...
class iZ extends AbstractCommandHandler {
   iZ(nI var1, ICommandManager var2, String var3, String var4) {
   ...
   public ExecutionResult execute(List var1) {
      if (!var1.isEmpty()) {
         ...
         long var7 = this.q.q(var6);
         return var7 == -1L ? ExecutionResult.fromObject(this.q.Uv.setBreakpoint(var6, null)) : ExecutionResult.fromObject(this.q.Uv.setBreakpoint(var7));
      } else {
         StringBuilder var2 = new StringBuilder();
         int var3 = 0;

         for (IDebuggerBreakpoint var5 : this.q.Uv.getBreakpoints()) {
