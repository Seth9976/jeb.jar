...
public class tw {
   ...
   private static final char[] RF = new char[]{'<', '>'};
   private final ITypeManager xK;
   private final INativeCodeModel Dw;
   private final INativeCodeUnit Uv;
   private final IELFUnit oW;

   public tw(IELFUnit var1, INativeCodeUnit var2, INativeCodeAnalyzer var3) {
      this.oW = var1;
      this.Uv = var2;
      this.xK = var3.getTypeManager();
      this.Dw = var3.getModel();
   }
   ...
   private void RF(IDIE var1) {
      String var2 = this.xK(var1);
      if (var2 != null) {
         INativeType var3 = this.xK.getType(var2);
         ...
         if (var4 != null && var5 != null) {
            ...
            if (var3 == null) {
               switch (var6) {
                  case DW_ATE_boolean:
                     var3 = this.xK.getType("boolean");
                     break;
                  case DW_ATE_signed_char:
                  case DW_ATE_signed:
                     var3 = this.xK.getInteger(var4.getRawForm().intValue(), true);
                     break;
                  case DW_ATE_unsigned_char:
                  case DW_ATE_unsigned:
                     var3 = this.xK.getInteger(var4.getRawForm().intValue(), false);
                     break;
                  default:
   ...
   private IDIE q(IDIE var1, List var2) {
      ...
      if (var3.equals(Dwarf.DwarfTag.DW_TAG_pointer_type.name())) {
         ...
         if (!this.q(var3)) {
            ...
            if (Dwarf.DwarfTag.DW_TAG_typedef.name().equals(var3)) {
               ...
               IDIE var6 = this.q(var4.getReference(), var5);
      ...
      return var4 == null ? var1 : this.q(var4.getReference(), var2);
   }

   private String xK(IDIE var1) {
   ...
   private void Dw(IDIE var1) {
      if (var1.getTagName().equals(Dwarf.DwarfTag.DW_TAG_namespace.name())) {
         for (IDIE var3 : var1.getChildren()) {
            ...
            if (var9 == null) {
               q.error("Can not find namespace for DIE at offset %xh", var1.getOffset());
               return;
            }
         ...
         if (var1.getTagName().equals(Dwarf.DwarfTag.DW_TAG_subprogram.name())) {
            ...
            long var5 = this.Uv.getVirtualImageBase() - this.oW.getLoaderInformation().getImageBase() + (Long)var2.getForm();
            axp var7 = ((aaf)this.Dw).oW(var5);
            if (var7 != null) {
               var7.Dw(var4.toString());
   ...
   private String Uv(IDIE var1) {
      ...
      if (var2 == null) {
         ...
         if (var11 != null && var11.getType() == Dwarf.DwarfFormType.string) {
            ...
            q.error("Can not find routine name for DIE at offset %xh (CU Offset: %xh)", var1.getOffset(), var1.getCompileUnit().getOffset());
            return null;
         }
      } else {
         StringBuilder var3 = new StringBuilder();
         Object var4 = null;
         CharSequence var5 = this.q(var1, (String)var4, false);
         ...
         for (IDIE var8 : var1.getChildren()) {
            if (var8.getTagName().equals(Dwarf.DwarfTag.DW_TAG_formal_parameter.name())) {
               ...
               if (!Strings.isContainedIn(var9, "this")) {
                  ...
                  CharSequence var10 = this.q(var8, (String)var4, true);
   ...
   private CharSequence q(IDIE var1, String var2, boolean var3) {
      ...
      if (var5 == null) {
         ...
         if (var6 == null) {
            ...
            if (var2 != null && var8.startsWith(var2)) {
               int var9 = Strings.indexOfNotInGroup(var8, ':', var2.length(), RF);
               if (var9 == -1) {
