...
public class DataUriIdentifier extends AbstractUnitIdentifier {
   public static final String TYPE = "dataUri";
   static final String PREFIX = "data:";

   public DataUriIdentifier() {
      super("dataUri", 0.0);
   }

   @Override
   public IPluginInformation getPluginInformation() {
      return new PluginInformation(S.L("Data Uri Scheme handler"), S.L("Data Uri containing Base64 object"), "PNF Software", Version.create(1, 0, 0));
   }

   @Override
   public boolean canIdentify(IInput var1, IUnitCreator var2, String var3, Map var4) {
      return checkBytes(var1, 0, "data:");
   }
