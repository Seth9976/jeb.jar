...
public class CU implements nI {
   ...
   public List q(File var1) throws IOException, JebException {
      try {
         ...
         try (
            ...
            try {
               CU.eo var6 = new CU.eo(var4, var5.getAbsolutePath(), false, new String[]{var1.getAbsolutePath()});
               int var7 = new Main(var4).runDx(var6);
               this.RF = var3.toString("UTF-8");
               if (var7 != 0) {
   ...
   private static class eo extends Arguments {
      public eo(DxContext var1, String var2, boolean var3, String[] var4) {
         super(var1);
         this.outName = var2;
         this.fileNames = var4;
         this.jarOutput = var3;
