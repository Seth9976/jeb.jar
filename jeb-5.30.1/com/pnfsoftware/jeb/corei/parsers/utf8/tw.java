...
@Ser
public class tw extends AbstractInteractiveBinaryUnit {
   ...
   public tw(String var1, IInput var2, IUnitProcessor var3, IUnitCreator var4, IPropertyDefinitionManager var5) {
   ...
   protected boolean processInternal() {
      ...
      try (ByteArrayInputStream var16 = new ByteArrayInputStream(var1, 3, var1.length - 3)) {
         this.RF = IO.readLines(var16, Charset.forName("UTF-8"));
      ...
      for (String var3 : this.RF) {
         ...
         for (String var8 : var4) {
            if (!var8.isEmpty()) {
               Integer var9 = (Integer)this.xK.get(var8);
               if (var9 == null) {
                  var9 = 0;
               }

               var9 = var9 + 1;
               this.xK.put(var8, var9);
            }
         }
      }
   ...
   public IUnitFormatter getFormatter() {
      ...
      if (((IUnitFormatter)var1).getPresentationCount() == 0) {
         ...
         var2.addDocumentPresentation(new EE(this, S.L("Formatted Text"), true));
         var2.addDocumentPresentation(new qV(this, S.L("All Words"), false));
         var2.addDocumentPresentation(new vn(this, S.L("All Words (static)"), false));
         var2.addDocumentPresentation(new PY(this, S.L("Table of Contents"), false));
         var2.addDocumentPresentation(new vb(this, S.L("Table of Contents (Table Tree)"), false));
         var2.addDocumentPresentation(new oL(this, S.L("Additional Bin"), false));
         var2.addDocumentPresentation(new Vj(this, S.L("Text View"), false));
         var2.addDocumentPresentation(new Bu(this, S.L("Text View"), false));
         var1 = var2;
      }
