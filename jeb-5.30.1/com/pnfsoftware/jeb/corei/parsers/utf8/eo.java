...
@SerDisabled
public class eo extends JebEventSource implements ITableDocument {
   private TreeMap q;

   public eo(tw var1) {
      this.q = new TreeMap(var1.RF());
   }
   ...
   public TableDocumentPart q() {
      return this.q(0, this.getRowCount());
   }

   public TableDocumentPart q(int var1, int var2) {
      if (var1 < 0) {
         var1 = 0;
      }
      ...
      int var4 = var3 - var1;
      Iterator var5 = this.q.keySet().iterator();
      ...
      while (var4-- > 0) {
         ...
         int var8 = (Integer)this.q.get(var7);
