...
public class NativeDecompilerPseudoIdentifier extends AbstractUnitIdentifier {
   ...
   public NativeDecompilerPseudoIdentifier(INativeDecompilerPlugin var1) {
      ...
      this.nativeDecompilerPlugin = var1;
   }
   ...
   public boolean canIdentify(IInput var1, IUnitCreator var2, String var3, Map var4) {
      if (!(var2 instanceof abg)) {
         return false;
      } else {
         String var5 = "dcmp_" + ((abg)var2).getFormatType();
   ...
   public IUnit prepare(String var1, IInput var2, IUnitProcessor var3, IUnitCreator var4, Map var5) {
      abg var6 = (abg)var4;
      adw var7 = new adw(this.getFormatType(), var1, var3, var6, this.pdm);
      var7.q(this.nativeDecompilerPlugin.getConverter(var6));
      var7.RF(this.nativeDecompilerPlugin.getPrimaryExtension(var7));
      var7.q(this.nativeDecompilerPlugin.getGlobalAnalyzer(var7));
      var7.q(this.nativeDecompilerPlugin.getSourceCustomizer(var7));
      var6.addChild(var7);
      var7.process();
      return var7;
   }
