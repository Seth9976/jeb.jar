...
public class CodelessSigsMain {
   private static final ILogger q;
      ...
      if (Strings.equals(var0[0], "--generate")) {
         ...
         if (var17) {
            ...
            if (var22 == null || var24 == null) {
               q.error("> couldn't find library id and/or library version");
               return;
            }
         }

         vn var27 = new vn();
         ej var29 = var27.q(var0[var17 ? 4 : 2], var17, var22, var24);
         ej.q(var29, var0[var17 ? 5 : 3]);
      } else if (Strings.equals(var0[0], "--match")) {
         qV var11 = new qV();
         var11.q(var0[1], var0[2], true, true, true, 0);
      } else if (Strings.equals(var0[0], "--import")) {
         EE var12 = new EE();
         var12.q(var0[1], var0[2]);
         ...
         ej var25 = ej.q(var0[var13]);
         Nt var6 = new Nt();
         var6.q(var25, var0[var13 + 1], var18, var23);
      } else if (Strings.equals(var0[0], "--stats")) {
         ej var14 = ej.q(var0[1]);
         oM var19 = new oM();
         var19.q(var14, var0[2]);
      } else if (Strings.equals(var0[0], "--print-gephi-reference-callgraph")) {
         ej var15 = ej.q(var0[1]);
         Nt var20 = new Nt();
         var20.RF(var15, var0[2]);
      } else if (Strings.equals(var0[0], "--print-gephi-reference-features")) {
         ej var16 = ej.q(var0[1]);
         Nt var21 = new Nt();
         var21.xK(var16, var0[2]);
      } else {
         q.error("> invalid argument (%s)", var0[0]);
      }
   }
   ...
   static {
      ...
      q = GlobalLog.getLogger(CodelessSigsMain.class, 30);
   }
}
