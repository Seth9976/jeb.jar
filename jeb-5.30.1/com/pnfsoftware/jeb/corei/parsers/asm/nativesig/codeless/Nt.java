...
public class Nt {
   ...
   public void q(ej var1, String var2) {
      this.q(var1, var2, null, null);
   }

   public void q(ej var1, String var2, Long var3, Long var4) {
      Set var5 = var1.q();
      int var6 = 0;
   ...
   public void RF(ej var1, String var2) {
   ...
   public void xK(ej var1, String var2) {
      File var3 = new File(var2, "nodes.csv");
      StringBuilder var4 = new StringBuilder();
      var4.append("Id,Label,timeset,module");
      var4.append(Strings.LINESEP);
      ...
      for (tw var10 : var1.xK.keySet()) {
         var12.put(var10, var7);
         var4.append(String.format("%d, %s,,%s", var7, var10.xK(), "FEATURE"));
         var4.append(Strings.LINESEP);
         var7++;
      }
      ...
      this.q(var1, var2, var6, var12);
   }

   private void q(ej var1, String var2, Map var3, Map var4) {
   ...
   private void q(ej var1, String var2, Map var3) {
