...
import com.pnfsoftware.jebglobal.aap;
import com.pnfsoftware.jebglobal.abg;
import com.pnfsoftware.jebglobal.bay;
import com.pnfsoftware.jebglobal.ctk;
...
public class NativeCodePseudoIdentifier extends AbstractUnitIdentifier {
   ...
   public void initialize(IPropertyDefinitionManager var1) {
      ...
      setupCommonProperties(this.pdm);
      this.nativeCodePlugin.setupCustomProperties(this.pdm);
   }

   public static void setupCommonProperties(IPropertyDefinitionManager var0) {
      ...
      var0.addDefinition(
         ...
         PropertyTypeSelection.Builder.create()
            ...
            .addEntry(aap.eo.q.ordinal(), S.L("Disabled"), null)
            .addEntry(aap.eo.RF.ordinal(), S.L("Safe heuristics only"), null)
            .addEntry(aap.eo.xK.ordinal(), S.L("Aggressive heuristics"), null)
            .build(),
      ...
      var0.addDefinition(
         ...
         PropertyTypeSelection.Builder.create()
            .addDefaultEntry(-1, S.L("Automatic"), null)
            .addEntry(ctk.eo.q.ordinal(), S.L("Disabled"), null)
            .addEntry(ctk.eo.RF.ordinal(), S.L("Safe heuristics only"), null)
            .addEntry(ctk.eo.xK.ordinal(), S.L("Aggressive heuristics"), null)
            .build(),
   ...
   public boolean canIdentify(IInput var1, IUnitCreator var2, String var3, Map var4) {
      if (var2 instanceof ICodeObjectUnit) {
         ...
         if (var2 instanceof IELFUnit && ((IELFUnit)var2).getHeader() != null) {
            if (var5.limit() >= 20 && ELFIdentifier.canIdentify(var1)) {
               int var8 = ((IELFUnit)var2).getHeader().getMachine();
               boolean var9 = ((IELFUnit)var2).isELF64();
               if (this.getPlugin().canProcessELF(var8, var9)) {
                  return true;
               }
            }
         } else if (var2 instanceof IPECOFFUnit && ((IPECOFFUnit)var2).getCOFFHeader() != null && PEIdentifier.canIdentify(var1)) {
            int var6 = ((IPECOFFUnit)var2).getCOFFHeader().getMachine();
            boolean var7 = ((IPECOFFUnit)var2).isPE64();
            if (this.getPlugin().canProcessPE(var6, var7)) {
               return true;
            }
         }
      }
   ...
   public IUnit prepare(String var1, IInput var2, IUnitProcessor var3, IUnitCreator var4, Map var5) {
      abg var6 = new abg(var1, this.getFormatType(), var2, var3, var4, this.pdm);
      var6.setMemory(this.nativeCodePlugin.getMemory(var4));
      var6.setProcessor(this.nativeCodePlugin.getProcessor(var4));
      var6.setCallingConvention(this.nativeCodePlugin.getCallingConvention(var4));
      var6.setCodeFormatter(this.nativeCodePlugin.getCodeFormatter());
      var6.setAnalyzerExtension(this.nativeCodePlugin.getAnalyzerExtension());
      return var6;
   }
