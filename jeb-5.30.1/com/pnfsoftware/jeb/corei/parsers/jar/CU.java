...
import com.pnfsoftware.jeb.corei.parsers.classfile.ej;
...
@Ser
public class CU extends AbstractBinaryUnit implements IArchiveUnit {
   ...
   protected boolean processInternal() {
      try {
         ...
         File var4 = ej.q(var9, var3).Dw(var1);
