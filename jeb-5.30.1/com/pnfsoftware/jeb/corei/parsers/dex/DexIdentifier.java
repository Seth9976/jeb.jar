...
public class DexIdentifier extends AbstractUnitIdentifier {
   ...
   public static final String propnameCallgraphAsyncBuildGracePeriod = "CallgraphAsyncBuildGracePeriod";
   public static final String propnameCallgraphAsyncRecDetGracePeriod = "CallgraphAsyncRecDetGracePeriod";
   ...
   public static final String propnameCIDBAsyncGenGracePeriod = "CIDBAsyncGenGracePeriod";
   ...
   public IUnit prepare(String var1, IInput var2, IUnitProcessor var3, IUnitCreator var4, Map var5) {
      return new bK(var1, var2, var3, var4, this.pdm);
   }
}
