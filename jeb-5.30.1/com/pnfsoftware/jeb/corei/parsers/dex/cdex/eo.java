...
public class eo extends AbstractBinaryUnit {
   ...
   protected eo(String var1, IInput var2, IUnitProcessor var3, IUnitCreator var4, IPropertyDefinitionManager var5) {
      super(null, var2, "cdex", var1, var3, var4, var5);
   }
   ...
   public String getDescription() {
      ...
      var1.append("\n");
      Strings.ff(var1, "Android CDEX file, version %s:\n", this.RF == null ? "?" : this.RF.toString());
      Strings.ff(var1, "\n");
      Strings.ff(var1, "!! JEB does not provide support for parsing CDEX files !!\n");
      Strings.ff(var1, "\n");
