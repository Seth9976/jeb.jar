...
public class Nt extends AbstractEOptimizer {
   public Nt() {
   ...
   protected int perform() {
      tl var1 = (tl)this.ectx.getGlobalContext().getConverter();
      int var2 = 0;
      ...
      for (BasicBlock var4 : this.cfg) {
         for (int var5 = 0; var5 < var4.size(); var5++) {
            ...
            if (tl.q(var6, 241)) {
               ...
               if (this.q(var4, var5, var8) && this.q(var4, var5, var9)) {
                  ...
                  if (var12.isMatch(var10)) {
                     ...
                     if (var7.getParameterExpression(2) == var13) {
                        ...
                        IEUntranslatedInstruction var15 = tl.q(this.ectx, var7.getNativeAddress(), -2147483645, var14, var13);
         ...
         for (int var18 = 0; var18 < var17.size() - 1; var18++) {
            ...
            if (tl.q(var19, -2147483645)) {
               ...
               if (var22 instanceof IEJump var23) {
                  ...
                  if (EUtil.isMatchDuaryOperation(var24, OperationType.LOG_NEQ, var21, var1.If) && var16 < this.cfg.size()) {
                     BasicBlock var25 = this.cfg.get(var16 + 1);
                     if (tl.RF((IEStatement)var25.getLast())) {
                        for (int var26 = 0; var26 < var25.size() - 1; var26++) {
                           if (tl.q((IEStatement)var25.get(var26), 62, 61) == null) {
                              continue label77;
                           }
                        }

                        CI var27 = zJ.q(-2147483644);
                        var20.setNativeMnemonic(var27.xK());
                        var20.setTag(var27.q());
   ...
   private boolean q(BasicBlock var1, int var2, IEGeneric var3) {
