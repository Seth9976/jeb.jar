...
import com.pnfsoftware.jebglobal.bbr;
...
@Ser
public class tl extends AbstractConverter {
   private static final ILogger Rr = GlobalLog.getLogger(tl.class);
   @SerId(1)
   ReferenceCounter q;
   @SerId(2)
   int RF;
   ...
   public static final String za = "par";
   public static final String lm = "var";
   public static BigInteger zz = BigInteger.ZERO;
   public static BigInteger JY = BigInteger.ONE;
   public static BigInteger HF = BigInteger.valueOf(2L);
   public static BigInteger LK = BigInteger.valueOf(3L);
   public static BigInteger io = BigInteger.valueOf(4L);
   public static BigInteger qa = BigInteger.valueOf(5L);
   public static BigInteger Hk = BigInteger.valueOf(6L);
   public static BigInteger Me = BigInteger.valueOf(7L);
   public static BigInteger PV = BigInteger.valueOf(8L);
   public static BigInteger oQ = BigInteger.valueOf(9L);
   public static BigInteger xW = BigInteger.ONE.shiftLeft(160).subtract(BigInteger.ONE);
   @SerId(20)
   IEVar KT;
   @SerId(21)
   IEVar Gf;
   ...
   private void Uv() {
      if (this.TX == null) {
         this.TX = new IEVar[16];

         for (int var1 = 0; var1 < 16; var1++) {
            this.TX[var1] = this.gCtx.createVirtualRegister("r" + var1, this.regNormalBitsize);
         }
      }
   }

   public tl(PY var1, INativeCodeUnit var2) {
      super(var1.q(), 256);
      this.Uv = var1;
      if (var2 == null) {
         ...
         this.oW = (abg)var2;
         this.KT = this.gCtx.createRegister(0, "pc", this.regNormalBitsize);
         this.Gf = this.gCtx.createRegister(256, "sp", this.regNormalBitsize);
         this.Ef = this.gCtx.createVirtualRegister("tmp", this.regNormalBitsize);
         this.cC = this.gCtx.createVirtualRegister("m0", this.regNormalBitsize);
         this.sH = this.gCtx.createVirtualRegister("m1", this.regNormalBitsize);
         this.Uv();
         this.If = this.gCtx.createImm(0L, 256);
         this.Dz = this.gCtx.createImm(1L, 256);
         this.mI = this.gCtx.createImm(255L, 256);
         this.jq = this.gCtx.createImm(256L, 256);
         this.ui = this.gCtx.createImm("0xFFFFFFFF_FFFFFFFF_FFFFFFFF_FFFFFFFF_FFFFFFFF_FFFFFFFF_FFFFFFFF_FFFFFFE0", 256);
         this.wF = this.gCtx.createVirtualRegister("msg.value", 256);
         this.wF.setFlags(16);
         this.CE = this.gCtx.createVirtualRegister("msg.sig", 32);
         this.CE.setFlags(16);
   ...
   private IEVar q(String var1) {
      IEVar var2 = this.q(var1 != null ? var1 : "var" + this.EB.size(), this.regNormalBitsize);
      this.EB.add(var2);
      return var2;
   }
   ...
   protected void preRoutineConversion(INativeMethodItem var1, IERoutineContext var2, List var3) {
      ...
      int var5 = 1;
      qx var6 = this.Uv.xK(var1.getMemoryAddress());
      if (var6 instanceof Fw) {
         var5 += ((Fw)var6).Uv();
      }

      ry var7 = new ry(this.Uv, var4);
      boolean var8 = var7.q(var5);
      if (!var8) {
         ...
         if (var6 instanceof Fw) {
            ...
            for (int var9 = 0; var9 < ((Fw)var6).Uv(); var9++) {
               this.q("par" + (var9 + 1));
            }

            this.Xo = this.EB.size();

            for (int var10 = 0; var10 < var7.q(); var10++) {
               this.q("var" + var10);
            }
         } else if (var6 instanceof GA) {
            this.q("par0");
            this.Xo = this.EB.size();

            for (int var11 = 0; var11 < var7.q(); var11++) {
               this.q("var" + var11);
            }
         }
      }
   ...
   protected void convertBlock(BasicBlock var1, List var2) {
      ...
      try {
         if (this.EB != null) {
            Integer var10 = (Integer)this.IN.get(var3);
            if (var10 == null) {
               var10 = 0;
            }

            this.Bu = this.Xo + var10;
         }

         for (int var29 = 0; var29 < var1.size(); var29++) {
            this.RF++;
            vX var9 = (vX)var1.get(var29);
            var7.clear();
            int var11 = var2.size();
            var8.insn = var9;
            var8.address = var5;
            var8.irAddress = var11;
            Integer var12 = this.Uv.q(var5);
            if (var12 == null) {
            ...
            switch (var13) {
               ...
               case 254:
               case 255:
                  int var41 = var9.nf.Dw;
                  Assert.a(var41 <= 16);
                  int var56 = var9.nf.Uv;
                  Assert.a(var56 <= 1);
                  IEGeneric[] var62 = new IEGeneric[var41];

                  for (int var67 = 0; var67 < var41; var67++) {
                     var62[var67] = this.q(var8, var67);
                  }
                  ...
                  if (this.EB == null) {
                     ...
                     IEUntranslatedInstruction var78 = q(this.ctx, var5, var9, var62);
                     ...
                     IEUntranslatedInstruction var79 = q(this.ctx, var5, var9, var62);
               ...
               case 23:
               case 24:
                  OperationType var40 = this.RF(var13);
                  IEVar var55 = this.q(var8, 0);
                  IEVar var61 = this.q(var8, 1);
               ...
               default:
                  this.xK++;
                  if (this.q != null) {
                     this.q.inc(var9.getMnemonic());
                  }

                  throw new UnsupportedConversionException("Cannot convert instruction: " + var9);
               case 21:
                  IEVar var39 = this.q(var8, 0);
                  IEOperation var54 = this.ctx.createOperation(OperationType.LOG_EQ, var39, this.gCtx.createImm(0L, 256));
                  this.q(var8, var54);
                  break;
               case 25:
                  IEVar var38 = this.q(var8, 0);
                  IEOperation var53 = this.ctx.createOperation(OperationType.NOT, var38);
                  this.q(var8, var53);
                  break;
               case 26:
                  IEVar var37 = this.q(var8, 0);
                  IEVar var52 = this.q(var8, 1);
                  IEOperation var60 = this.ctx.createOperation(OperationType.AND, var37, this.ui);
                  IEImm var65 = this.If;
                  IEGeneric var74 = this.ctx.createOperation(OperationType.ADD, var37, this.Dz).leftShift(3);
                  IEOperation var75 = this.ctx.createOperation(OperationType.SUB, this.jq, var74);
                  IEOperation var76 = this.ctx.createOperation(OperationType.SHR, var52, var75);
                  IEOperation var77 = this.ctx.createOperation(OperationType.AND, var76, this.mI);
                  this.q(var8, this.ctx.createCond(var60, var65, var77));
                  break;
               case 27:
               case 28:
               case 29:
                  OperationType var36 = this.RF(var13);
                  IEVar var51 = this.q(var8, 0);
                  IEVar var59 = this.q(var8, 1);
               ...
               case 80:
                  ...
                  break;
               case 81:
                  IEVar var35 = this.q(var8, 0);
                  IEMem var50 = this.ctx.createMem(var35, 256);
                  this.q(var8, var50);
                  break;
               case 82:
                  IEVar var34 = this.q(var8, 0);
                  IEVar var49 = this.q(var8, 1);
                  var8.r.add(this.ctx.createAssign(this.ctx.createMem(var34, 256), var49));
                  break;
               case 83:
                  IEVar var33 = this.q(var8, 0);
                  IEVar var48 = this.q(var8, 1);
                  var8.r.add(this.ctx.createAssign(this.ctx.createMem(var33, 8), var48.part(8)));
                  break;
               case 86:
                  IEVar var32 = this.q(var8, 0);
                  if (this.EB == null) {
                     Object var43 = var32;
                     if (var9.HF != null) {
                        var43 = this.gCtx.createImm(var9.HF.intValue(), this.regNormalBitsize);
                     }

                     var8.r.add(this.ctx.createBranchAssign(this.KT, (IEGeneric)var43, (var9.JY & 1) != 0));
                  } else if ((var9.JY & 2) != 0) {
                     IEVar var44 = null;
                     ...
                     qx var45 = this.Uv.xK(var9.HF.intValue());
                     INativeMethodItem var58 = this.getNativeContext().getRoutine(var9.HF.intValue());
                     IEVar var63 = this.ctx.createSymbolForRoutine(var58);
                     Object var72 = null;
                     ArrayList var81 = new ArrayList();
                     ArrayList var82 = new ArrayList();
                     if (var45 instanceof GA) {
                        IECall var83 = this.ctx.createCall(var63, (IEGeneric)var72, var82, var81, 0, null, null);
                        var8.r.add(var83);
                     } else {
                        if (!(var45 instanceof Fw var84)) {
                           throw new RuntimeException();
                        }

                        for (int var85 = 0; var85 < var84.Uv(); var85++) {
                           var81.add(this.xK());
                        }

                        var72 = this.xK();

                        for (int var86 = 0; var86 < var84.oW(); var86++) {
                           var82.add(this.RF());
                        }
                     ...
                     IEUntranslatedInstruction var46 = q(this.ctx, var5, Integer.MIN_VALUE);
                     var46.setBreakingFlow(new FlowInformation());
                     var8.r.add(var46);
                  } else {
                     Object var47;
                     if (var9.HF != null) {
                        var47 = this.gCtx.createImm(var9.HF.intValue(), this.regNormalBitsize);
                     } else {
                        var47 = var32.part(this.regNormalBitsize);
                     }

                     var8.r.add(this.ctx.createBranchAssign(this.KT, (IEGeneric)var47, false));
                  }
                  break;
               case 87:
                  IEVar var31 = this.q(var8, 0);
                  IEVar var42 = this.q(var8, 1);
                  int var57 = var12 + 1;
                  IEImm var17 = this.gCtx.createImm(var57, this.regNormalBitsize);
                  if (this.EB == null) {
                     Object var18 = var31;
                     if (var9.HF != null) {
                        var18 = this.gCtx.createImm(var9.HF.intValue(), this.regNormalBitsize);
                     }

                     var8.r.add(this.ctx.createBranchAssign(this.KT, this.gCtx.createCond(var42, (IEGeneric)var18, var17), (var9.JY & 1) != 0));
                  } else {
                     if ((var9.JY & 2) != 0) {
                     ...
                     if ((var9.JY & 1) != 0) {
                        qx var69 = this.Uv.xK(var9.HF.intValue());
                        var8.r.add(this.ctx.createJump(var8.irAddress + 2, EUtil.notL(var42)));
                        INativeMethodItem var19 = this.getNativeContext().getRoutine(var9.HF.intValue());
                        IEVar var20 = this.ctx.createSymbolForRoutine(var19);
                        ArrayList var21 = new ArrayList();
                        ArrayList var22 = new ArrayList();
                        if (!(var69 instanceof GA)) {
                        ...
                        var8.r.add(this.ctx.createJump(var8.irAddress + 2, EUtil.notL(var42)));
                        IEUntranslatedInstruction var70 = q(this.ctx, var5, Integer.MIN_VALUE);
                        var70.setBreakingFlow(new FlowInformation());
                        var8.r.add(var70);
                     } else {
                        Object var71;
                        if (var9.HF != null) {
                           var71 = this.gCtx.createImm(var9.HF.intValue(), this.regNormalBitsize);
                        } else {
                           var71 = var31.part(this.regNormalBitsize);
                        }

                        IECond var80 = this.ctx.createCond(var42, (IEGeneric)var71, var17);
                        var8.r.add(this.ctx.createBranchAssign(this.KT, var80, false));
                     }
                  }
                  break;
               case 88:
                  this.q(var8, this.gCtx.createImm(var12.intValue(), this.regNormalBitsize));
                  break;
               case 91:
               ...
               case 126:
               case 127:
                  this.q(var8, this.gCtx.createImm(var9.lm, 256));
                  break;
               case 128:
               case 129:
               case 130:
               ...
               case 142:
               case 143:
                  IEVar var30 = this.q(var9.xK(), var8, 0);
                  this.q(var8, var30);
                  break;
               case 144:
               case 145:
               ...
               case 159:
                  int var14 = 1 + var9.RF();
                  IEVar var15 = this.q(1, var8, 0);
                  IEVar var16 = this.q(var14, var8, 1);
                  if (this.EB == null) {
                     this.q(1, var8, var16);
                     this.q(var14, var8, var15);
                  } else {
                     var8.r.add(this.ctx.createAssign(this.Ef, var15));
                     var8.r.add(this.ctx.createAssign(var15, var16));
                     var8.r.add(this.ctx.createAssign(var16, this.Ef));
                  }
            }
   ...
   void q(ConverterInstructionEntry var1, IEGeneric var2) {
      if (this.EB == null) {
         IEAssign var5 = this.ctx.createAssign(this.Gf, EUtil.sub(this.Gf, EUtil.imm(32L, 256)));
         IEAssign var4 = this.ctx.createAssign(this.createStackMemoryAccess(this.Gf, 256), var2.zeroExtend(256));
         var1.r.add(var5);
         var1.r.add(var4);
      } else {
         IEVar var3 = this.RF();
   ...
   IEVar RF() {
      if (this.EB == null) {
         ...
         if (this.Bu < 0 || this.Bu >= this.EB.size()) {
            Object[] var10000 = new Object[0];
         }

         IEVar var1 = (IEVar)this.EB.get(this.Bu);
         this.Bu++;
         return var1;
      }
   }
   ...
   IEVar xK() {
      return this.q(null, -1);
   }

   IEVar q(ConverterInstructionEntry var1, int var2) {
      if (this.EB == null) {
         IEVar var3 = var2 < 0 ? this.Ef : this.TX[var2];
         IEAssign var4 = this.ctx.createAssign(var3, this.createStackMemoryAccess(this.Gf, 256));
         var1.r.add(var4);
         IEAssign var5 = this.ctx.createAssign(this.Gf, EUtil.add(this.Gf, EUtil.imm(32L, 256)));
         var1.r.add(var5);
         return var3;
      } else {
         Assert.a(this.Bu > 0, "Empty evm operand stack");
         this.Bu--;
         if (this.Bu < 0 || this.Bu >= this.EB.size()) {
            Object[] var10000 = new Object[0];
         }

         return (IEVar)this.EB.get(this.Bu);
      }
   }
   ...
   IEVar q(int var1, ConverterInstructionEntry var2, int var3) {
      Assert.a(var1 >= 1, "Illegal evm operand stack position");
      if (this.EB == null) {
         IEVar var7 = var3 < 0 ? this.Ef : this.TX[var3];
         Object var5 = this.Gf;
         if (var1 >= 2) {
         ...
         int var4 = this.Bu - var1;
         if (var4 < 0 || var4 >= this.EB.size()) {
            Object[] var10000 = new Object[0];
         }

         return (IEVar)this.EB.get(var4);
      }
   }

   private void q(int var1, ConverterInstructionEntry var2, IEVar var3) {
      Object var4 = this.Gf;
      if (var1 >= 2) {
   ...
   public void Dw() {
      for (INativeMethodItem var2 : this.oW.getMethods()) {
         this.q(var2, false);
      }
   }
   ...
   public IPrototypeItem q(INativeMethodItem var1, boolean var2) {
      ...
      if (var3 == null || var2) {
         qx var4 = this.Uv.xK(var1.getMemoryAddress());
         if (var4 != null) {
            var3 = this.q(var4);
   ...
   IPrototypeItem q(qx var1) {
      ...
      if (var3 == null) {
         ...
         return this.oW.RF().q(var4, var5, var6, null);
      }
   }
            ...
            default:
               if (var5 == 241) {
                  ...
                  if (var19 instanceof IEImm) {
                     ...
                     if (var29.equals(JY)) {
                        var39 = 1073741825;
                     } else if (var29.equals(HF)) {
                        var39 = 1073741826;
                     } else if (var29.equals(LK)) {
                        var39 = 1073741827;
                     } else if (var29.equals(io)) {
                        var39 = 1073741828;
                     } else if (var29.equals(qa)) {
                        var39 = 1073741829;
                     } else if (var29.equals(Hk)) {
                        var39 = 1073741830;
                     } else if (var29.equals(Me)) {
                        var39 = 1073741831;
                     } else if (var29.equals(PV)) {
                        var39 = 1073741832;
                     } else if (var29.equals(oQ)) {
                        var39 = 1073741833;
                     }

                     if (var39 != null) {
                        var6 = var6 + "_" + zJ.q(var39).xK().toLowerCase();
                     }
                  }
               }
   ...
   public static Integer q(IEStatement var0, int... var1) {
   ...
   public static boolean q(IEStatement var0, int var1) {
      if (!(var0 instanceof IEUntranslatedInstruction)) {
         return false;
      } else {
         Object var2 = ((IEUntranslatedInstruction)var0).getTag();
   ...
   public static boolean q(IEStatement var0) {
      return q(var0, 254);
   }

   public static boolean RF(IEStatement var0) {
      return !q(var0, 253) ? false : EUtil.isZero(((IEUntranslatedInstruction)var0).getParameterExpression(0));
   }

   public static boolean xK(IEStatement var0) {
      return !q(var0, 253)
         ? false
   ...
   public static boolean Dw(IEStatement var0) {
      return q(var0, Integer.MIN_VALUE);
   }

   public static IEUntranslatedInstruction q(IERoutineContext var0, long var1, int var3, IEGeneric... var4) {
      CI var5 = zJ.q(var3);
      IEUntranslatedInstruction var6 = var0.createUntranslatedInstruction(var1, var5.xK(), var4);
      var6.setTag(var3);
      return var6;
   }

   public static IEUntranslatedInstruction q(IERoutineContext var0, long var1, vX var3, IEGeneric... var4) {
