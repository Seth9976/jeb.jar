...
public class nI extends AbstractBinaryUnit {
   ...
   public boolean isProcessed() {
      return super.isProcessed() && this.q != null;
   }
   ...
   protected boolean processInternal() {
      ...
      if (var24 != 60) {
         ...
         try {
            this.q = Jsoup.parse(var21, "", var23);
         ...
         if (this.q == null || var1 && !this.q.getElementsByTag("html").isEmpty()) {
            try (InputStream var26 = this.getInput().getStream()) {
               this.q = Jsoup.parse(var21);
         ...
         if (!this.hasChildren()) {
            ...
            for (Element var7 : this.q.getElementsByTag("script")) {
   ...
   public String getFormatType() {
      if (this.RF != null) {
         ...
         Elements var1 = this.q.children();
         if (var1.size() == 1) {
            this.RF = "svg".equalsIgnoreCase(((Element)var1.get(0)).tagName()) ? "svg" : super.getFormatType();
         } else {
            this.RF = super.getFormatType();
         }
   ...
   public IUnitFormatter getFormatter() {
      ...
      if (UnitFormatterUtil.getPresentationByIdentifier(var1, 1L) == null) {
         var1.addPresentation(new ej(this, 1L, S.L("Formatted Text"), true), false);
      }
