...
public class qV extends AbstractEOptimizer {
   int q;
   ...
   public int perform() {
      int var1 = 0;
      this.q = this.ectx.getStackPointerId();
                  ...
                  if (var11 != null) {
                     ...
                     for (int var17 = var4 - 1; var17 >= 0; var17--) {
                        ...
                        if (var18 instanceof IEAssign) {
                           ...
                           Couple var20 = this.q(var19.getDstOperand());
                           if (var20 != null) {
                     ...
                     if (var12 == 3) {
                        Object var23 = this.q(var13, var14);
                        if (var23 != null) {
                           if (var9 != var10) {
                              FunctionOptype var24 = this.ectx.getGlobalContext().createFunctionType("ToMC7PPTR", 16, 1, 1, 32);
   ...
   IEGeneric q(int var1, int var2) {
      ...
      if (var6 == S7.AreaType.V) {
         ...
         FunctionOptype var7 = this.ectx.getGlobalContext().createFunctionType("GetDBAddress", 0, 1, 1, 32);
      ...
      if (var5 != 0) {
         FunctionOptype var8 = this.ectx.getGlobalContext().createFunctionType("BitAddr", 0, 2, 2, 32);
