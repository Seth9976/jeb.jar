...
@Ser
public class Vj extends AbstractProcessor {
   ...
   protected PY q(byte[] var1, int var2, int var3) throws ProcessorException {
      if (var2 >= 0 && var2 < var3 && var2 < var1.length) {
         int var4 = var2 + 1;
         int var5 = var1[var2] & 255;
         if (var5 >= bK.CW.length) {
            throw new RuntimeException();
         } else {
            bK.eo var6 = bK.CW[var5];
            vb var7 = null;
            int var8 = 0;
            int var9 = 0;
            int var10 = 0;
            int var12 = var6.RF & 0xFF;
            switch (var12) {
               case 0:
                  break;
               case 1:
                  ...
                  Assert.a(var6 != null && (var6.RF & 0xFF) == 2);
                  int var42 = var32 & 127;
                  if ((var42 & 8) != 0) {
               ...
               case 24:
               default:
                  throw new RuntimeException(Strings.ff("insnflags= 0x%X", var6.RF));
               case 4:
               ...
               case 7:
                  ...
                  if (var30 != 0) {
                     ...
                     var6 = var6.oW[var40];
                     Assert.a(var6 != null && (var6.RF & 0xFF) == 8);
                     int var46 = var30 & 7;
               ...
               case 15:
                  ...
                  if (var25 != 0) {
                     var6 = var6.oW[0];
                     Assert.a(var6 != null && (var6.RF & 0xFF) == 16);
                     if ((var25 & 8) == 0) {
                        var10 |= 32;
                     } else {
                        var10 |= 33;
               ...
               case 17:
                  ...
                  if (var24 != 0) {
                     var6 = var6.oW[var24 >> 2 & 1];
                     Assert.a(var6 != null && (var6.RF & 0xFF) == 18);
                     int var37 = var24 & 3;
                     if (var37 == 0) {
                        throw new RuntimeException();
                     }
               ...
               case 19:
                  ...
                  if (var23 != 0) {
                     var6 = var6.oW[0];
                     Assert.a(var6 != null && (var6.RF & 0xFF) == 20);
                     if (var5 == 186) {
                        Assert.a((var23 & 8) == 0);
                        var9 |= 4096;
                     } else if (var5 == 187) {
               ...
               case 21:
                  ...
                  if (var22 != 0) {
                     var6 = var6.oW[0];
                     Assert.a(var6 != null && (var6.RF & 0xFF) == 22);
                     if ((var22 & 8) == 0) {
                        var10 |= 32;
                     } else {
                        var10 |= 33;
               ...
               case 23:
                  ...
                  if (var21 != 0) {
                     var6 = var6.oW[0];
                     Assert.a(var6 != null && (var6.RF & 0xFF) == 24);
            ...
            if (var9 != 0) {
               switch (var6.Dw & 983040) {
                  ...
                  case 65536:
                     ...
                     break;
                  case 131072:
                     var8 = EndianUtil.bytesToShort(var1, var4, q) & '\uffff';
                     var4 += 2;
                     break;
                  case 196608:
                  case 458752:
                     var8 = EndianUtil.bytesToInt(var1, var4, q);
                     var4 += 4;
                     break;
                  case 262144:
                     var8 = var1[var4++] & 127;
                  ...
                  case 393216:
                     ...
                     break;
                  default:
                     throw new RuntimeException(Strings.ff("opndflags=0x%X", var6.Dw));
               }

               var7 = new vb(var9, var8, var10);
            }

            BytesBlock var43 = new BytesBlock(Arrays.copyOfRange(var1, var2, var4));
            vb[] var48 = var7 == null ? new vb[0] : new vb[]{var7};
            return new PY(var43, var6, var48);
         }
      } else {
         return null;
      }
