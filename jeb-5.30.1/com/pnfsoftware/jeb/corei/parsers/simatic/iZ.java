...
public class iZ extends AbstractEExpressionOptimizer {
         ...
         if (!var2.isCustomOperation()) {
            ...
            switch (var4) {
               ...
               case "ExtractBit":
                  ...
                  break;
               case "GetDBAddress":
                  return this.q(var2, S7.BlockType.DB);
               case "GetFBAddress":
                  return this.q(var2, S7.BlockType.FB);
               case "GetFCAddress":
                  return this.q(var2, S7.BlockType.FC);
            }
   ...
   private AbstractEExpressionOptimizer.EOR q(IEOperation var1, S7.BlockType var2) {
      ...
      if (var3 instanceof IEImm) {
         ...
         if (this.ectx.getNativeContext() instanceof INativeCodeUnit) {
            ...
            LR var6 = (LR)var5.getCodeObjectContainer();
            long var7;
            if (var2.isLogicBlock()) {
               var7 = var6.getAddressOfCode(var2, var4);
               if (var7 == -1L) {
                  String var9 = KZ.q().q(var2, var4);
                  if (var9 != null) {
   ...
   private AbstractEExpressionOptimizer.EOR q(IEOperation var1) {
