...
@Ser
public abstract class Uz implements IS7Block {
   @Override
   ...
   protected String q(byte[] var1, int var2) {
      return q(8, var1, var2);
   }

   public static String q(int var0, byte[] var1, int var2) {
   ...
   protected long RF(byte[] var1, int var2) {
   ...
   public String getName() {
      return q(this.getType(), this.getNumber());
   }

   public static String q(S7.BlockType var0, int var1) {
