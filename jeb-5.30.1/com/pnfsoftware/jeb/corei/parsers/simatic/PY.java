...
@Ser
public class PY extends AbstractInstruction {
   @SerTransient
   bK.eo q;
   @SerId(1)
   int RF;
   ...
   private void q() {
      this.q = bK.q(this.RF, super.getMnemonic());
   }

   public PY(BytesBlock var1, bK.eo var2, vb[] var3) {
      super(var1, var2.xK, var3, 32);
      this.RF = var2.q;
      this.q = var2;
   }
   ...
   public IFlowInformation getBreakingFlow(long var1) {
      ...
      switch (var3) {
         case "JU":
            ...
            int var12 = ((vb)this.getOperand(0)).xK();
         ...
         case "JL":
            ...
            int var11 = ((vb)this.getOperand(0)).xK();
         ...
         case "LOOP":
            ...
            int var7 = ((vb)this.getOperand(0)).xK();
   ...
   public List q(long var1, IVirtualMemory var3) {
      if (!Strings.isContainedIn(this.getMnemonic(), "UC", "CC")) {
         ...
         int var4 = ((vb)this.getOperand(0)).RF();
         if (var4 != 10 && var4 != 12) {
            return null;
         } else {
