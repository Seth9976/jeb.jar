...
class qa implements Comparator {
   qa(LR var1) {
      this.q = var1;
   }

   public int q(IS7Block var1, IS7Block var2) {
      S7.BlockType var3 = S7.BlockType.fromId(var1.getTypeId());
      S7.BlockType var4 = S7.BlockType.fromId(var2.getTypeId());
      int var5 = (Integer)LR.LK.getOrDefault(var3, -1);
      int var6 = (Integer)LR.LK.getOrDefault(var4, -1);
