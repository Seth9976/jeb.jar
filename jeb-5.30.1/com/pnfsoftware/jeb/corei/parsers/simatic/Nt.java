...
public class Nt extends AbstractNativeDecompilerPlugin {
   public static final String q = "dcmp_simatic_mc7";
   ...
   public IEConverter getConverter(INativeCodeUnit var1) {
      if (var1.getParent() instanceof LR) {
         LR var2 = (LR)var1.getParent();
         return new CU(var2, var1);
      } else {
