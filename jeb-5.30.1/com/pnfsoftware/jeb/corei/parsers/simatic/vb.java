...
@Ser
public class vb implements IInstructionOperand {
   private static final String[] q = new String[]{"P", "I", "Q", "M", "DB", "DI", "L", "V"};
   private static final String[] RF = new String[]{"P", "I", "Q", "M", "DBX", "DIX", "L", "V"};
   @SerId(1)
   private int xK;
   @SerId(2)
   private int Dw;
   ...
   public vb(int var1, int var2) {
      this(var1, var2, 0);
   }

   public vb(int var1, int var2, int var3) {
      if (var1 == 0) {
   ...
   public int[] oW() {
      Assert.a(this.Dw() && this.Uv() == 32 || this.Uv() == 33);
      return new int[]{this.Dw >>> 24 & 0xFF, this.Dw >>> 3 & 2097151, this.Dw & 7};
   }
   ...
   public long q(long var1) {
      if (this.q() == 768) {
         return var1 + 2 * this.Dw;
      } else {
         return this.q() == 1024 ? var1 + 4 * (this.Dw + 1) : 0L;
      }
   }

   public int[] lm() {
      Assert.a(this.q() == 256);
      int var1 = (this.xK & 15728640) >>> 20;
      return new int[]{this.Dw, var1};
   }

   public int zz() {
      switch (this.xK & 61440) {
         case 4096:
            return 8;
         case 8192:
            return 16;
   ...
   public String format(IInstruction var1, long var2) {
      ...
      if (var4 == 1280) {
         ...
         this.q(this.xK, var7, var9, var6);
         this.RF(this.xK, var6);
         if (var4 == 512) {
            this.q(var6);
            var6.append("[");
            if (!this.q(this.Uv, var6)) {
               this.q(this.Uv, var7, false, var6);
            }

            this.RF(this.Uv, var6);
            int var8 = this.JY();
            this.q(this.Dw, var8, this.xK, var6);
            var6.append("]");
         } else {
            int var10 = this.JY();
            if (var10 > 0) {
               this.q(this.Dw, var10, this.xK, var6);
            }
         }

         return var6.toString();
      } else {
         long var5 = this.q(var2);
         return Strings.ff("0x%X", var5);
      }
   }

   private void q(int var1, String var2, boolean var3, StringBuilder var4) {
      int var5 = var1 & 0xFF;
      switch (var5) {
         case 0:
            break;
   ...
   private boolean q(int var1, StringBuilder var2) {
      switch (var1 & 0xFF) {
         case 32:
            var2.append("AR1, ");
            return true;
   ...
   private void RF(int var1, StringBuilder var2) {
      switch (var1 & 61440) {
         case 0:
            break;
         case 4096:
   ...
   private void q(int var1, int var2, int var3, StringBuilder var4) {
      this.q(var4);
      if (this.q() == 1792) {
         ...
         switch (var3 & -268435456) {
            case Integer.MIN_VALUE:
               this.oW(var1, var2, var4);
               break;
            case -1879048192:
               this.za(var1, var2, var4);
               break;
            case -1610612736:
               this.zz(var1, var2, var4);
               break;
            case -1342177280:
               this.lm(var1, var2, var4);
               break;
            case -1073741824:
               this.JY(var1, var2, var4);
               break;
            case 268435456:
            ...
            case 805306368:
               ...
               break;
            case 1073741824:
               this.gO(var1, var2, var4);
               break;
            case 1342177280:
               this.nf(var1, var2, var4);
               break;
            case 1610612736:
               this.Dw(var1, var2, var4);
               break;
            case 1879048192:
               this.Uv(var1, var2, var4);
               break;
            default:
               var4.append(var1);
         }
   ...
   private void q(int var1, int var2, StringBuilder var3) {
      Assert.a(var2 == 32);
      Strings.ff(var3, "%.6f", Float.intBitsToFloat(var1));
   }

   private void RF(int var1, int var2, StringBuilder var3) {
      var3.append("2#");
      if (var1 == 0) {
         var3.append('0');
      } else {
   ...
   private void xK(int var1, int var2, StringBuilder var3) {
      if (var2 == 8) {
   ...
   private void Dw(int var1, int var2, StringBuilder var3) {
      if (var2 == 16) {
   ...
   private void Uv(int var1, int var2, StringBuilder var3) {
      if (var2 == 32) {
         var3.append("DW");
      } else if (var2 == 16) {
         var3.append('W');
   ...
   private void oW(int var1, int var2, StringBuilder var3) {
      Assert.a(var2 == 16);
      int var4 = var1 >> 8 & 15;
      int var5 = var1 >> 4 & 15;
      int var6 = var1 & 15;
   ...
   private void gO(int var1, int var2, StringBuilder var3) {
      int var4 = var1 >>> 24;
      String var5;
      if (var4 == 0) {
         var5 = "";
   ...
   private void nf(int var1, int var2, StringBuilder var3) {
      if (var2 == 8) {
   ...
   private void za(int var1, int var2, StringBuilder var3) {
      Assert.a(var2 == 32);
      var3.append(S7.Time.create(var1).toString());
   }

   private void lm(int var1, int var2, StringBuilder var3) {
      var3.append(S7.TimeOfDay.create(var1));
   }

   private void zz(int var1, int var2, StringBuilder var3) {
      var3.append(S7.Date.create(var1));
   }

   private void JY(int var1, int var2, StringBuilder var3) {
