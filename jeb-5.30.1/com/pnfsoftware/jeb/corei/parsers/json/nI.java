...
@Ser
public class nI extends AbstractBinaryUnit implements IJsonUnit {
   ...
   public boolean isProcessed() {
      return super.isProcessed() && this.RF != null;
   }
   ...
   protected boolean processInternal() {
      ...
      String var1;
      try (nI.eo var3 = new nI.eo(this.getInput().getStream())) {
      ...
      try {
         this.RF = var11.parse(var1, new ej(this));
         return true;
   ...
   public IUnitFormatter getFormatter() {
      ...
      if (UnitFormatterUtil.getPresentationByIdentifier(var1, 1L) == null) {
         var1.addPresentation(new oM(this, 1L, S.L("Formatted Text"), true), false);
      }
