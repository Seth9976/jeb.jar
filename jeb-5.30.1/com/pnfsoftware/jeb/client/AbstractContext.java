...
import com.pnfsoftware.jebglobal.qV;
import java.io.File;
...
public abstract class AbstractContext extends EventSource {
   ...
   @SerStaticOk
   public static final Version app_ver = new Version(5, 30, 1, 202506141830L, 0);
   ...
   public static final void terminate() {
      try {
         Class.forName(cvm.q(new byte[]{-35, 11, 23, 23, 79, 66, 13, 15, 9, 73, 125, 42, 10, 7, 17, 8}, 1, 183))
            .getMethod(cvm.q(new byte[]{115, 29, 17, 29}, 1, 22), int.class)
            .invoke(null, 0);
