...
class ccp implements IDVisitor {
   ccp(cco var1, IDInstruction var2) {
      this.RF = var1;
      this.q = var2;
   }
   ...
   public void q(IDExpression var1, IDExpression var2, IVisitResults var3) {
      if (var1 instanceof IDInstanceField var4 && var4.isArrayLength()) {
         ...
         if (var5 instanceof IDVar var7) {
            Collection var10 = this.RF.dfa.getUseDefs(this.q.getOffset(), var7.getId(), 3);
            if (var10.isEmpty() || var10.size() >= 3) {
               return;
            }

            for (Long var12 : var10) {
               IDInstruction var13 = (IDInstruction)this.RF.cfg.getInstruction(var12);
