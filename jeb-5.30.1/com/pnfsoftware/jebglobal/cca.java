...
public class cca extends AbstractDOptimizer {
      ...
      for (BasicBlock var3 : this.cfg) {
         for (int var4 = 0; var4 < var3.size(); var4++) {
            ...
            if (var5.isInvoke()
               ...
               if (var8 != null) {
                  cca.eo var14 = new cca.eo();
                  var1 += var14.q(var5, var8);
               }
            }
         }
      }
   ...
   class eo {
      ...
      int q(IDInstruction var1, IDVar var2) {
         IDInstruction var3 = var1;
         cca.this.analyzeChains();
         bww var5 = new bww(var1.getOffset(), var2.getId(), true);
         ...
         while (!var6.isEmpty()) {
            var5 = (bww)var6.remove();
            if (var7.add(var5.Dw())) {
               IDInstruction var9 = (IDInstruction)cca.this.cfg.getInstruction(var5.Dw());
               if (var9 == null) {
                  return 0;
               }

               IDVar var4 = cca.this.ctx.getVar(var5.Uv());
               if (var9 != var1) {
               ...
               for (long var12 : cca.this.dfa.getUseDefs(var3.getOffset(), var4.getId())) {
                  var6.add(new bww(var12, var4.getId()));
               }
            }
         }
         ...
         if (var8 == null) {
            return 0;
         } else if (!this.q(var8, var1, var2)) {
            return 0;
         } else {
            ArrayList var24 = new ArrayList();
            var24.add(var1);
            var24.addAll(this.RF);

            for (IDInstruction var29 : var24) {
               IDVar var31 = q(var29);
               if (var31 == null || !this.q.contains(var31)) {
                  return 0;
               }
            }

            TreeSet var27 = new TreeSet(this.q);
            int var30 = var27.size() - 1;

            for (IDInstruction var13 : var24) {
               Couple var14 = cca.this.cfg.getInstructionLocation(var13.getOffset());
               BasicBlock var15 = (BasicBlock)var14.getFirst();
               int var16 = (Integer)var14.getSecond();
               IDVar var17 = q(var13);
               DUtil.modifyInstructionSize(cca.this.ctx, var13, 1 + var30);
               var13.adjustSize(-var30);
               long var18 = var13.getOffsetEnd();

               for (IDVar var21 : var27) {
                  if (var21 != var17) {
                     IDInstruction var22 = cca.this.ctx.createAssign(var21, var17).withOffset(var18);
                     var15.add(++var16, var22);
                     var18++;
                  }
               }

               IDNewInfo var33 = cbz.q(cca.this.g, (IDAllocObjectInfo)var8.getAssignSource(), (IDCallInfo)var13.getInvokeData());
               var13.morph(DOpcodeType.IR_ASSIGN, var2, var33);
            }

            var8.setAssignSource(cca.this.g.createNull());
            cca.this.invalidateChains();
            return var24.size();
         }
      }

      boolean q(IDInstruction var1, IDInstruction var2, IDVar var3) {
         IDVar var5 = (IDVar)var1.getAssignDestination();
         HashSet var6 = new HashSet();
         var6.add(var5);
         Couple var7 = cca.this.cfg.getInstructionLocation(var1.getOffset());
      ...
      static IDVar q(IDInstruction var0) {
