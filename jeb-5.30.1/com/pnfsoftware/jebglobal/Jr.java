...
class Jr extends AbstractCommandHandler {
   Jr(if var1, ICommandManager var2, String var3, CommandParameter[] var4, String var5, String var6) {
   ...
   public ExecutionResult execute(List var1) {
      ...
      if (var3 == -1L || var5 <= 0L) {
         ...
         if (var7 != null && var7.length != 0) {
            long var9 = ((um)if.Uv(this.q)).getMemory().findBytes(var3, var5, var7);
            if (var9 < 0L) {
