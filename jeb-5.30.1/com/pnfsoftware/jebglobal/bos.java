...
public class bos extends AbstractJOptimizer {
   @Override
   public int perform() {
      if (this.m == null) {
         return 0;
         ...
         var1 += this.q(this.m.getBody(), var2);
         return var1 + this.RF(this.m.getBody(), var2);
      }
   }

   private int q(IJavaBlock var1, Map var2) {
      int var3 = 0;
   ...
   private int RF(IJavaBlock var1, Map var2) {
      int var3 = 0;
