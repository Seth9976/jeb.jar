...
public class arm extends AbstractEOptimizer {
   private static final StructuredLogger q = aeg.q(arm.class);
   ...
   protected int perform() {
      return this.q(1, false, this.getMasterOptimizerSafe().getDisregardedOutputRegisters());
   }

   public int q(IERoutineContext var1, int var2, boolean var3, Collection var4) {
      this.ectx = var1;
   ...
   private int q(int var1, boolean var2, Set var3) {
      int var4 = 0;
   ...
   private int q(boolean var1, Set var2) {
      int var3 = 0;
      boolean var4 = false;
               ...
               if (!(var6.get(var8) instanceof IEAssign)) {
                  ...
                  if (var13 != this.ectx.getProgramCounter() && var13 != this.ectx.getStackPointer()) {
                     ...
                     if (var15 == 0 || var15 == 1 && !this.getMasterOptimizerSafe().canDiscardUnusedDefinition(this.ectx, var10, var16)) {
                        var8--;
                     } else if (amw.q(this.ectx, var6, var8) == 0) {
                        var8--;
                     } else {
