...
public class chn extends AbstractDOptimizer {
   public chn() {
   ...
   @Override
   public int perform() {
      return this.q(false, null);
   }

   public int q(boolean var1, IDVar var2) {
      if (!var1 || bws.xK(this.g) && Boolean.TRUE.equals(this.ctx.getData("unvirtualized"))) {
         int var3 = 0;
                  ...
                  if ((var8 = (IDInstruction)var39.get(var20)).isAssignToVar(var11.getId())
                     ...
                     if (var42.size() >= 2) {
                        ...
                        if (var4.size() >= 2) {
                           ...
                           if (var43 >= 2 && var43 <= 100 && this.q(var39, var20, var18, var11, var22, var43, var16)) {
   ...
   private boolean q(BasicBlock var1, int var2, IDVar var3, IDVar var4, IDVar var5, int var6, IDImm var7) {
   ...
   private BasicBlock q(List var1) {
