...
public class cel extends AbstractDOptimizer {
   @Override
   public int perform() {
   ...
   boolean q(BasicBlock var1) {
      ...
      if (!var2.q()) {
         ...
         int var3 = var2.xK.getId();
         BasicBlock var4 = var2.q;
         this.analyzeChains();
         Collection var5 = this.dfa.getUseDefs(var2.Dw, var3);
         if (var5.size() != 2) {
            return false;
         } else {
            ...
            if (var11 != null && var11.getOffsetEnd() == var9) {
               if (var11.isAssignToVar(var3) && var11.getAssignSource() instanceof IDImm var12 && var12.isZero()) {
                  ...
                  if (var16 + 1 >= var15.size() || var15.get(var16 + 1) != var17) {
                     return false;
                  } else if (!bto.q(this.ctx, var15, var4)) {
                     return false;
