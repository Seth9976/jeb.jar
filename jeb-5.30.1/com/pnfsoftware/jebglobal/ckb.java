...
public class ckb {
   ...
   public static final int xK = 80;
   public static final int Dw = 88;
   public static final int Uv = 8;
   public static final int oW = 12;
   public static final int gO = 24;
   public static final int nf = 48;

   public static boolean q(com.pnfsoftware.jeb.corei.parsers.macho.oM var0, String var1) {
      switch (var1) {
         case "__cls_refs":
   ...
   public static boolean RF(com.pnfsoftware.jeb.corei.parsers.macho.oM var0, String var1) {
      if (q(var0, var1)) {
         return true;
      } else {
         switch (var1) {
