...
public class cdt extends AbstractDOptimizer {
   public cdt() {
            ...
            if (var3.isAssignToVar()
               ...
               if (var13 != null && (var6 = var13.getData()) != null && var6.getCodeItem() != null && var6.getInlineMode() == 0) {
                  ...
                  for (long var11 : this.dfa.getDefUses(var3.getOffset(), var7.getId(), 6)) {
                     var8 += this.q((IDInstruction)this.cfg.getInstruction(var11), var7);
                     if (var8 >= 2) {
                        break;
                     }
                  }
   ...
   private int q(IDInstruction var1, IDVar var2) {
      if (var1 == null) {
         return 0;
      } else if (var1.isAssignToVar() && this.q(var1.getAssignSource(), var2)) {
         return 1;
      } else {
         return var1.isJcond()
               && var1.getJcondCondition() instanceof IDOperation var3
               && var3.getOperatorType().isAnyOf(JavaOperatorType.EQ, JavaOperatorType.NE)
               && this.q(var3.getOperand1(), var2)
               && this.q(var3.getOperand2(), var2)
            ? 2
            : 0;
      }
   }

   private boolean q(IDExpression var1, IDVar var2) {
