...
@Ser
public abstract class ane implements IEGeneric {
   private static final StructuredLogger q = aeg.q(ane.class);
   static AtomicBoolean nf = new AtomicBoolean();
   @SerId(1)
   protected int gP;
   @SerId(2)
   protected IWildcardType za;

   public static boolean q(boolean var0) {
      return nf.getAndSet(var0);
   }
   ...
   public boolean hasFlags(int var1) {
      return (this.gP & var1) == var1;
   }

   @Override
   public boolean addFlags(int var1) {
      int var2 = this.gP | var1;
      if (var2 == this.gP) {
         return false;
      } else {
         this.gP = var2;
   ...
   public boolean equalsEx(Object var1, boolean var2) {
      if (this == var1) {
         ...
         return false;
      } else if (!(var1 instanceof ane var3)) {
         return false;
      } else {
         if (var2) {
            if (this.za == null) {
            ...
            } else if (!this.za.equals(var3.za)) {
               return false;
            }
         }
   ...
   public abstract void q(and var1);
   ...
   public boolean setType(IWildcardType var1, ETypeInfo var2, boolean var3) {
      if ((var1 != null || this.za != null) && (var1 == null || !var1.equals(this.za))) {
         if (var1 != null && var1.isVoid()) {
            if (var2 != null) {
               var2.recordConflict("Refusing to apply type `void`", this, this.za, var1);
            }

            return false;
         } else {
            String var4 = "Generic conflict";
            if (this.za == null || var3 || this.za.isLessSpecializedThan(var1)) {
               boolean var5 = false;
            ...
            if (var2 != null) {
               var2.recordConflict(var4, this, this.za, var1);
            }
   ...
   private static void q(IEVisitor var0, IEGeneric var1, IEGeneric var2, EVisitResults var3) {
   ...
   private static void RF(IEVisitor var0, IEGeneric var1, IEGeneric var2, EVisitResults var3) {
      var3.pushParent(var1);

      for (IEGeneric var5 : EUtil.getSubExpressions(var1)) {
         if (var3.parents == null || !var3.parents.contains(var5)) {
            RF(var0, var5, var1, var3);
            if (var3.isInterruptedVisit()) {
               return;
            }
         }
   ...
   public abstract ane RF();

   public ane q(ane var1) {
      var1.gP = this.gP;
      var1.za = this.za;
      return var1;
   }
   ...
   protected static void q(IEGeneric... var0) throws IllegalIntermediateExpressionException {
   ...
   protected static void RF(IEGeneric var0, IEGeneric var1) throws IllegalIntermediateExpressionException {
   ...
   protected static void q(IEGeneric var0) {
   }
   ...
   public IEGeneric q(long var1) {
      return new amf(OperationType.ADD, this, alu.q(var1, this.getBitsize()));
   }

   public IEGeneric RF(long var1) {
      return new amf(OperationType.SUB, this, alu.q(var1, this.getBitsize()));
   }
   ...
   public IEGeneric slice(int var1, int var2) {
      ...
      if (var1 < 0 || var1 >= var2 || var2 > var3) {
         ...
         return (IEGeneric)(var4.size() == 1 ? ((IEGeneric)var4.get(0)).slice(var1, var2) : new amn(new alo(var4), var1, var2));
      } else {
         return new amn(this, var1, var2);
      }
   }
   ...
   public IEGeneric zeroExtend(int var1) {
      ...
      if (var1 < var2) {
         ...
         alu var3 = alu.q(0L, var1);
         return new alo(this, var3.slice(var2, var1));
      }
   }
   ...
   public IEGeneric signExtend(int var1) {
      ...
      if (var1 < var2) {
         ...
         alu var3 = alu.q(0L, var1 - var2);
         alu var4 = alu.q(-1L, var1 - var2);
         return new alo(this.RF(), new alp(this.msb(), var4, var3));
      }
   }

   @Override
   public IEGeneric leftShift(int var1, int var2) {
      return (IEGeneric)(var1 == 0 ? this.slice(0, var2) : new alo(alu.q(0L, var1), this.slice(0, var2 - var1)));
   }
   ...
   public IEGeneric rightShift(int var1, int var2) {
      return (IEGeneric)(var1 == 0 ? this.slice(0, var2) : new alo(this.slice(var1, var2), alu.q(0L, var1)));
   }
   ...
   public void LK() {
      ...
      this.visitDepthPre(new anf(this, var1));

      for (int var2 = 0; var2 < var1.size(); var2++) {
         for (int var3 = var2 + 1; var3 < var1.size(); var3++) {
            if (var1.get(var2) == var1.get(var3)) {
               IllegalIntermediateExpressionException var4 = new IllegalIntermediateExpressionException(
                  Strings.f("Element %s contains duplicates", var1.get(var2))
               );
               JebCoreService.notifySilentExceptionToClient(var4, Maps.toMap("ir_with_dup", this.toString()));
               q.catching(var4);
            }
         }
      }
   ...
   public IECond countSuccessiveBits(boolean var1, boolean var2, int var3) {
      alu var4 = alu.q(this.getBitsize(), var3);
      alu var5 = alu.q(this.getBitsize() - 1, var3);
      int var6 = var2 ? 0 : this.getBitsize() - 1;
      alp var7 = new alp(this.RF().slice(var6, var6 + 1), var1 ? var4 : var5, var1 ? var5 : var4);

      for (int var8 = 1; var8 < this.getBitsize(); var8++) {
         var6 = var2 ? var8 : this.getBitsize() - var8 - 1;
         alu var9 = alu.q(this.getBitsize() - var8 - 1, var3);
         var7 = new alp(this.RF().slice(var6, var6 + 1), (IEGeneric)(var1 ? var7 : var9), (IEGeneric)(var1 ? var9 : var7));
      }
   ...
   public IWildcardType q(IWildcardTypeManager var1, boolean var2) {
      if (this.getType() == null) {
         ...
         if (!this.setType(var3, null)) {
            q.warn("Cannot set type %s on IR %s", var3, this);
            return var3;
         }
      }
   ...
   protected static boolean q(IEGeneric var0, IEGeneric var1, boolean var2) {
      if (var0 == var1) {
         return true;
      } else {
   ...
   protected static boolean q(List var0, List var1, boolean var2) {
      if (var0 == var1) {
         return true;
      } else if (var0 != null && var1 != null) {
   ...
   public Couple find(IEGeneric var1, int var2, int var3, IEGeneric var4) {
      ...
      if (!this.visitDepthPre(new ang(this, var3, var1, var2, var5))) {
         return null;
      } else {
         Couple var6 = var5[0];
   ...
   public IEGeneric findByType(Class var1, int var2) {
      ...
      return !this.visitDepthPre(new anh(this, var1, var2, var3)) ? null : var3[0];
   }

   protected static void q(IEGeneric var0, IEGeneric var1, Collection var2) {
      Assert.a(var0 != null);
      if (var1 != null) {
   ...
   protected static void RF(IEGeneric var0, IEGeneric var1, Collection var2) {
      Assert.a(var0 != null);
      if (var1 != null) {
         if (var1 instanceof IEMem) {
            var2.add(new Couple(var1, var1.asMem().getReference()));
         } else {
            var2.add(new Couple(var0, var1));
         }
      }
