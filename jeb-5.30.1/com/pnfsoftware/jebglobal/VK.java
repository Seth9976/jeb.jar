...
class VK extends AbstractCommandHandler {
   VK(if var1, ICommandManager var2, String var3, CommandParameter[] var4, String var5, String var6) {
      ...
      if (var5 == null) {
         ...
         for (IDebuggerVariable var9 : var6.getVariables()) {
            if (var9.getName().equals(var3) && var9.getTypedValue().getTypeName().equals("raw")) {
               ...
               ByteOrder var12 = ((um)if.zz(this.q)).RF().gP().toByteOrder();
