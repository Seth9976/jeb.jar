...
public class ajk extends AbstractCBlockOptimizer {
   private static final StructuredLogger q = aeg.q(ajk.class);
         ...
         if (var5 != null && var5 instanceof ICIdentifier && var4 instanceof ICAssignment && ((ICAssignment)var4).isSimpleAssignment()) {
            ...
            if (var5 == var6) {
               ...
               if (!q(var6, var7, var8)) {
                  ...
                  boolean var10 = this.q(var1, var3 + 1, var5, var6, var7, var9, new AtomicBoolean());
                  if (var10) {
                     var2++;
                  }
   ...
   private boolean q(ICBlock var1, int var2, ICExpression var3, ICExpression var4, List var5, AtomicBoolean var6, AtomicBoolean var7) {
      boolean var8 = false;
      ...
      for (int var9 = var2; var9 < var1.size(); var9++) {
         ...
         if (!(var10 instanceof ICAssignment) && !(var10 instanceof ICReturn)) {
            if (var10 instanceof ICBlock) {
               ...
               var8 |= this.q((ICBlock)var10, 0, var3, var4, var5, new AtomicBoolean(), var19);
               if (!var19.get()) {
                  break;
               }
               continue;
            ...
            for (int var16 = 0; var16 < var15.size(); var16++) {
               if (var12) {
                  if (var16 < var15.size() - 1 || !var11.hasDefaultBlock()) {
                     var8 |= this.q(((ICIfStm)var11).getBranchPredicate(var16), var3, var4, var5, var13);
                     if (var13.get()) {
                        break;
                     }
                  }
                  ...
                  if (var17 == var3) {
                     ...
                     var8 |= this.q(var17, var3, var4, var5, var13);
                     if (var13.get()) {
                        break;
                     }
                  }
               ...
               var8 |= this.q((ICBlock)var15.get(var16), 0, var3, var4, var5, new AtomicBoolean(), var20);
               if (!var20.get()) {
                  var14 = false;
               }
            }
         ...
         var8 |= this.q(var10, var3, var4, var5, var18);
         if (var18.get()) {
            break;
         }
   ...
   private boolean q(ICElement var1, ICExpression var2, ICExpression var3, List var4, AtomicBoolean var5) {
      boolean var6 = false;
      ICLeftExpression var7 = q(var1);
      if (var7 != null) {
         if (var7.equals(var2)) {
            var5.set(true);
            return false;
         ...
         if (!Boolean.FALSE.equals(q(var2, var7, false))) {
            var5.set(true);
            return false;
         }
   ...
   static Boolean q(ICExpression var0, ICExpression var1, boolean var2) {
      if (var0 instanceof ICInstanceField) {
         return q(((ICInstanceField)var0).getInstance(), var1, true);
         ...
         for (ICElement var6 : var0.getSubElements()) {
            ...
            Boolean var7 = q((ICExpression)var6, var1, true);
            if (var7 == null) {
               return null;
            }
         ...
         return var0 instanceof ICOperation && ((ICOperation)var0).getOperatorType() == COperatorType.PTR
            ? q(((ICOperation)var0).getFirstOperand(), var1, true)
            : null;
      }
   }

   static ICLeftExpression q(ICElement var0) {
   ...
   static boolean q(ICElement var0, List var1, List var2) {
      CVisitResults var3 = new CVisitResults(2);
      ajl var4 = new ajl(var1, var2);
      return q(var4, var0, var3);
   }

   public static boolean q(ICVisitor var0, ICElement var1, CVisitResults var2) {
      if (var2 == null) {
         var2 = new CVisitResults();
      }

      q(var0, var1, null, var2);
   ...
   private static void q(ICVisitor var0, ICElement var1, ICElement var2, CVisitResults var3) {
      ...
      if (var1 instanceof ICAssignment) {
         ...
         if (!var5 && !(var6 instanceof ICArrayElement) && !(var6 instanceof ICOperation) && !(var6 instanceof ICInstanceField)) {
            var4 = ahf.q(((ICAssignment)var1).getRight());
         }
      }
