...
public class bqa extends AbstractJOptimizer {
   @Override
   public int perform() {
   ...
   int q(IJavaBlock var1) {
      ...
      for (int var3 = 0; var3 < var1.size(); var3++) {
         ...
         if (var4 instanceof IJavaTry var5 && this.q(var5)) {
            var2++;
         }
   ...
   boolean q(IJavaTry var1) {
      ...
      while (true) {
         ...
         IJavaIdentifier var4 = this.q(var3.get(var2 + 1));
         if (var4 != null && this.q(var3.get(var2), var4)) {
            var3.remove(var2 + 1);
            IJavaAssignment var5 = (IJavaAssignment)var3.remove(var2);
            IJavaExpression var6 = this.RF(var5);
            if (var2 == 0) {
   ...
   IJavaIdentifier q(IJavaStatement var1) {
   ...
   boolean q(IJavaStatement var1, IJavaIdentifier var2) {
   ...
   int q(IJavaBlock var1, IJavaIdentifier var2) {
      int var3 = 0;
      int var4 = 0;
   ...
   IJavaExpression RF(IJavaStatement var1) {
      if (var1 instanceof IJavaAssignment && ((IJavaAssignment)var1).isSimpleAssignment()) {
