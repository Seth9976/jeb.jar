...
@Ser
public class bmp extends bml implements IJavaBreak {
   @SerId(1)
   private IJavaLabel oW;

   public bmp(IJavaLabel var1) {
      this.oW = var1;
   }
   ...
   public String toString() {
      return "break" + (this.oW == null ? "" : " " + this.oW.getName());
   }

   public bmp Dw() {
      bmp var1 = new bmp(this.oW == null ? null : this.oW.duplicate());
      this.q(var1);
      return var1;
   }
}
