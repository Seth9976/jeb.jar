...
public class aro extends AbstractEExpressionOptimizer {
   private static final StructuredLogger RF = aeg.q(aro.class);
   private static INodeHandler xK = new arp();
   public static final SubstitutionDefinition[] q = new SubstitutionDefinition[]{
      ...
      Util.SD(Util.N(O.SLICE_HALF1, Util.N(O.DIV_U, Util.N(O.COMPOSE_2EQ, Util.L(0), Util.LC(0L)), Util.L(1, 0, 1, xK))), Util.N(O.DIV_U, Util.L(0), Util.L(1))),
      Util.SD(Util.N(O.SLICE_HALF1, Util.N(O.REM_U, Util.N(O.COMPOSE_2EQ, Util.L(0), Util.LC(0L)), Util.L(1, 0, 1, xK))), Util.N(O.REM_U, Util.L(0), Util.L(1))),
      Util.SD(Util.N(O.SLICE_HALF1, Util.N(O.DIV_S, Util.N(O.COMPOSE_2EQ, Util.L(0), Util.LC(0L)), Util.L(1, 0, 1, xK))), Util.N(O.DIV_S, Util.L(0), Util.L(1))),
      Util.SD(Util.N(O.SLICE_HALF1, Util.N(O.REM_S, Util.N(O.COMPOSE_2EQ, Util.L(0), Util.LC(0L)), Util.L(1, 0, 1, xK))), Util.N(O.REM_S, Util.L(0), Util.L(1)))
   };
