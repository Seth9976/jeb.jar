...
public class cgd extends AbstractDOptimizer {
   boolean q;
   ...
   public int perform() {
      ...
      while (true) {
         ...
         while (true) {
            ...
            if (var14.Dw != 0 && var14.xK != null && !var14.xK.isJavaLangObject()) {
               var13 = var14.xK;
               break;
            }
         }
   ...
   class eo implements IDVisitor {
      IDTypeInfoProvider q;
      IDVar RF;
      IJavaType xK;
      int Dw;

      public void q(IDExpression var1, IDExpression var2, IVisitResults var3) {
         if (var1 == this.RF && var2 instanceof IDOperation var4 && var4.isCast()) {
            IJavaType var5 = var4.getType();
            if (this.xK == null) {
               this.xK = var5;
            } else if (!this.xK.equals(var5)) {
               if (!this.q.isCompatible(this.xK.getSignature(), var5.getSignature())) {
                  this.Dw = 0;
