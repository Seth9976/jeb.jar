...
public class brh extends AbstractJOptimizer {
   public brh() {
         ...
         if (var1 == null) {
            ...
            if (var14.isEmpty()) {
               ...
               if (var4 == null) {
                  ...
                  while (true) {
                     var5 = var18.oW();
                     if (var5 == null || !var19.add(var18.Uv())) {
                        this.c.setReconEnummap(var17);
                        return 1;
                     }

                     if (!(var5 instanceof bsj) && var5 instanceof IJavaAssignment && ((IJavaAssignment)var5).isSimpleAssignment()) {
