...
public class aji extends AbstractCBlockOptimizer {
   @Override
   protected int optimizeBlock(ICBlock var1) {
      ...
      for (int var3 = 0; var3 < var1.size(); var3++) {
         ...
         if (var4 instanceof ICIfStm && ((ICIfStm)var4).hasDefaultBlock()) {
            while (this.q(var1, var3, true)) {
               var2++;
               var3++;
            }

            while (this.q(var1, var3, false)) {
               var2++;
            }
         }
      }
   ...
   private boolean q(ICBlock var1, int var2, boolean var3) {
      if (var2 >= var1.size()) {
         return false;
      } else {
         ...
         if (var4 instanceof ICIfStm && ((ICIfStm)var4).hasDefaultBlock()) {
            ...
            if (CUtil.hasEmptyBranch(var5)) {
               ...
               ICStatement var6 = this.q(var5, var3);
               if (var6 == null) {
                  return false;
               } else {
   ...
   private ICStatement q(ICIfStm var1, boolean var2) {
   ...
   private Set q(ICElement var1) {
      HashSet var2 = new HashSet();
      ArrayList var3 = new ArrayList();
      var3.add(var1);
      this.q(var1.getSubElements(), var2);
      return var2;
   }

   private void q(List var1, Set var2) {
      for (ICElement var4 : var1) {
         if (!CUtil.isClassMethodField(var4)) {
            if (var4 instanceof ICIdentifier) {
               var2.add((ICIdentifier)var4);
            } else {
               this.q(var4.getSubElements(), var2);
            }
         }
      }
   }
