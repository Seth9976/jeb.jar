...
public class bom extends AbstractJOptimizer {
   @Override
   public int perform() {
      ...
      for (int var3 = 0; var3 < var1.size(); var3++) {
         ...
         if (var4 instanceof IJavaCompound
            ...
            if (!var5.isEmpty()) {
               if (this.RF(var5)) {
                  var2++;
               } else if (this.xK(var5)) {
                  var2++;
               } else if (this.Dw(var5)) {
                  var2++;
               } else if (this.Uv(var5)) {
                  var2++;
               } else if (this.oW(var5)) {
                  var2++;
               }
            }
         }
   ...
   private boolean RF(IJavaBlock var1) {
      if (var1.size() < 2) {
         return false;
      } else {
   ...
   private boolean xK(IJavaBlock var1) {
      if (var1.size() < 2) {
         return false;
      } else {
         int var2 = var1.size() - 1;
   ...
   private boolean Dw(IJavaBlock var1) {
      if (var1.size() < 2) {
         return false;
      } else {
   ...
   private boolean Uv(IJavaBlock var1) {
      if (var1.size() < 2) {
         return false;
      } else {
         int var2 = var1.size() - 1;
   ...
   private boolean oW(IJavaBlock var1) {
