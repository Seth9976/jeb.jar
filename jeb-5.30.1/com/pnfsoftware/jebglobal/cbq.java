...
public class cbq extends AbstractDOptimizer {
   @Override
   public int perform() {
      int var1 = 0;
               ...
               if (var8 instanceof IDVar && var8.equals(var18.getSwitchExpression())) {
                  ...
                  if (var9.compareHandlers((int)var3.getAddress(), (int)var4.getAddress())) {
                     if (var4.insize() != 1) {
                        ...
                        if (!this.q(var4, var5, var10.getId())) {
                           continue;
                        }
   ...
   private boolean q(BasicBlock var1, BasicBlock var2, int var3) {
      bwd var4 = new bwd(this.ctx);
      bwd.nI var5 = var4.RF();
      ...
      while (true) {
         ...
         if (var8 != var2) {
            Map var9 = var5.q(var8.getBase()).Dw();
