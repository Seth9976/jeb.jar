...
public class akb extends AbstractCOptimizer {
   @Override
   protected int perform() {
      ...
      for (int var5 = 0; var5 < var4.size(); var5++) {
         ...
         akb.eo var7 = new akb.eo();
         var2.put(var6, var7);
         ICIdentifier var8 = afc.q(var6);
         if (var8 != null) {
            var7.q = var8;
            var3.add(var8);
         }
      ...
      for (ICIdentifier var19 : var3) {
         ...
         for (int var17 = 0; var17 < var4.size(); var17++) {
            ...
            if (var20 < 0) {
               if (var14 instanceof ahl) {
                  var10.push((ahl)var14);
               } else if (var14 instanceof ahm) {
                  var10.pop();
               }
            } else if (var14 instanceof ahl) {
               var11++;
            } else if (var14 instanceof ahm) {
               if (--var11 < var12 && var9) {
                  var9 = false;
            ...
            akb.eo var15 = (akb.eo)var2.get(var14);
            if (var15 != null) {
               if (var15.q == var19) {
                  var20 = var17;
                  var9 = true;
               ...
               if (var15.RF != null && !var9 && var15.RF.contains(var19)) {
                  var13 = 0;
               }
            }
         }
         ...
         if (var13 >= 0 && var20 >= 0) {
            ...
            if (var21 instanceof ICAssignment) {
               ...
               var22 = CUtil.getDefinition(var21);
            } else if (var21 instanceof ahp) {
               var22 = CUtil.getDefinition(((ahp)var21).RF());
               var16 = (ICAssignment)((ahp)var21).RF();
            }
