...
class asp implements IEVisitor {
   asp(aso var1, IWildcardTypeManager var2, AtomicInteger var3) {
      this.xK = var1;
      this.q = var2;
      this.RF = var3;
   }
   ...
   public void q(IEGeneric var1, IEGeneric var2, IVisitResults var3) {
      if (var1.isMem()) {
         ...
         if (var5 != null) {
            ...
            IEVar var11 = aso.q(this.xK).getStackManager().getVariable(var16);
            if (var11 == null) {
               return;
            }
               ...
               if (var6.getType().isDefined()) {
                  ...
                  if (TypeUtil.isReference(var19)) {
                     ...
                     if (var19.getSize() * 8 == var13) {
                        var17 = this.q.create(var19);
                        aso.RF(this.xK).acquireNativeItem(var17);
                     }
                  }
               }

               if (var17 == null) {
                  var17 = this.q.createWithMaximumBitsize(var13);
               }
