...
public class bqy extends AbstractJBlockOptimizer {
   @Override
   public int optimizeBlock(IJavaBlock var1, IJavaElement var2) {
      ...
      while (var4 < var1.size()) {
         ...
         if (var5 instanceof IJavaReturn && !((IJavaReturn)var5).returnsVoid()) {
            ...
            if (this.q(var1, var4, var6) || this.xK(var1, var4, var6)) {
               var3++;
               continue;
            }
         }
   ...
   boolean q(IJavaBlock var1, int var2, IJavaReturn var3) {
   ...
   boolean RF(IJavaBlock var1, int var2, IJavaReturn var3) {
      IJavaIdentifier var4 = JUtil.getVarLike(var3.getExpression());
      if (var4 == null) {
         return false;
      } else {
         if (var2 >= 1) {
            ...
            if (var5 instanceof IJavaSynchronizedBlock) {
               IJavaBlock var6 = ((IJavaSynchronizedBlock)var5).getBody();
               if (!var6.isEmpty()) {
                  IJavaStatement var7 = var6.getLast();
                  if (var7 instanceof IJavaAssignment
                     && ((IJavaAssignment)var7).isSimpleAssignment()
                     && JUtil.isIdentOrDefinition(((IJavaAssignment)var7).getLeft(), var4)) {
                     IJavaExpression var8 = ((IJavaAssignment)var7).getRight();
                     var3.setExpression(var8);
                     var1.remove(var2);
                     var6.removeLast();
                     var6.add(var3);
                     return true;
   ...
   boolean xK(IJavaBlock var1, int var2, IJavaReturn var3) {
