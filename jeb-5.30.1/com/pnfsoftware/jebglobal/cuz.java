...
public class cuz extends AbstractEnginesPlugin {
   private static final ILogger q = GlobalLog.getLogger(cuz.class);
                  ...
                  while (true) {
                     ...
                     while (true) {
                        ...
                        if (var5.length() <= 0 || var5.equals("*") || Strings.starMatches(var13, var5)) {
                           q.info(S.L("Processing library: %s"), UnitUtil.buildFullyQualifiedUnitPath(var12));
                     ...
                     for (String var20 : var17.keySet()) {
                        if (var10.add(var20)) {
                           ...
                           q.info(S.L("Registered by %s: method= %s @ RVA: 0x%X"), var12.getName(), var20, var21 - var15);
                           var18++;
                        }
                     }

                     if (var18 == 0) {
                        q.info(S.L("Nothing found"));
                     }
                  }
               }
            }
