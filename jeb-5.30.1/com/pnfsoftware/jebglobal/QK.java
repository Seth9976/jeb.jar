...
@SerDisabled
public class QK extends AbstractTextDocument {
   private static final ILogger gO = GlobalLog.getLogger(QK.class);
   IDebuggerUnit q;
   long RF;
   int xK;
   int Dw;
   ...
   public QK(IDebuggerUnit var1) throws JebException {
      this.q = var1;
      ...
      if (var2 != null) {
         ...
         if (var3 != null) {
            if (var3 == ProcessorType.ARM || var3 == ProcessorType.X86 || var3 == ProcessorType.MIPS) {
               ...
               this.xK = 4096;
               this.RF = Long.MAX_VALUE;
            }
         }
      }

      if (this.xK != 0 && this.RF != 0L) {
         this.Dw = 0;
         this.Uv = 16;
      } else {
   ...
   public ITextDocumentPart getDocumentPart(long var1, int var3, int var4) {
      if (this.Dw != 0) {
         ...
         int var7 = var4 * this.oW;
         long var8 = var1 - var7;
         if (var8 < 0L) {
            var8 = 0L;
         }

         int var10 = var3 * this.oW;
         long var11 = var1 + var10;
         byte[] var13 = new byte[this.xK];

         while (var8 < var11) {
            long var14 = var8 + this.xK & ~(this.xK - 1);
            int var16 = (int)(var14 - var8);
            if (var14 > var11) {
               var16 = (int)(var11 - var8);
            }

            int var17 = this.q.readMemory(var8, var16, var13, 0);
            int var18 = 0;
            if (var17 <= 0) {
               var17 = var16;
               ...
               while (var18 < var17) {
                  ...
                  var26.add(new TextItem(var27.length(), this.Uv, ItemClassIdentifiers.ADDRESS));
                  if (this.Uv == 8) {
               ...
               while (var18 < var17) {
                  ...
                  var20.add(new TextItem(var21.length(), this.Uv, ItemClassIdentifiers.ADDRESS));
                  if (this.Uv == 8) {
   ...
   public String coordinatesToAddress(ICoordinates var1, AddressConversionPrecision var2) {
      if (var1 == null) {
         ...
         var3 += var1.getLineDelta() * this.oW;
