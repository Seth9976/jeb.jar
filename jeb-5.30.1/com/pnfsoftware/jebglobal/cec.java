...
public class cec extends AbstractDOptimizer {
   private boolean q;
   ...
   public int perform() {
      ...
      if (!"<clinit>".equals(var1.getName())) {
         ...
         if (var3 != null && var3.isEnumeration()) {
            ...
            for (BasicBlock var8 : this.cfg) {
               ...
               for (int var9 = 0; var9 < var8.size(); var9++) {
                  ...
                  if (var10.isAssign()) {
                     ...
                     if (var11 instanceof IDVar var13 && this.q(var12, var6) && var9 + 1 < var8.size()) {
            ...
            if (!this.q && !bto.q(this.g)) {
               ced var21 = new ced(this, this.ctx, 10);
               int var22 = var21.q();
               if (var22 > 0) {
                  this.q = true;
                  var4 += var22;
   ...
   boolean q(IDExpression var1, String var2) {
