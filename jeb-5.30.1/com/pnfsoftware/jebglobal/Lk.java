...
class Lk extends AbstractCommandHandler {
   Lk(if var1, ICommandManager var2, String var3, CommandParameter[] var4, String var5, String var6) {
      ...
      if (var4 == null) {
         ...
         if (var5 == null) {
            ...
            if (var6 >= var5.size()) {
               ...
               ByteBuffer var8 = ByteBuffer.wrap(var7).order(((um)if.za(this.q)).RF().gP().toByteOrder());
