...
public class cdg extends AbstractDOptimizer {
   public static final String q = "Ljava/lang/Throwable;->addSuppressed(Ljava/lang/Throwable;)V";
            ...
            if (var3.irrinsize() > 0 && var3.size() == 2 && DUtil.checkBlock(var3, DOpcodeType.IR_STORE_EXCEPTION, DOpcodeType.IR_INVOKE)) {
               ...
               if (var5.getInvokeData() instanceof IDCallInfo) {
                  ...
                  if (var6.getInvokeType() == DInvokeType.STATIC
                     ...
                     IDexMethod var7 = bto.q(var6, this.dex);
                     if (var7 != null) {
                        IDVar var8 = (IDVar)var6.getArgument(0);
                        this.analyzeChains();
                        Long var9 = this.dfa.checkSingleDef(var5.getOffset(), var8.getId());
                        IDInstruction var10;
                        if (var9 != null && (var10 = (IDInstruction)this.cfg.getInstruction(var9)) != null && var10.isStoreException() && this.q(var7)) {
                           var6 = this.ctx
                              .createCallInfo(
                                 DInvokeType.VIRTUAL,
   ...
   private boolean q(IDexMethod var1) {
                     ...
                     label130: {
                        label129: {
                           try {
                              ...
                              if (!Boolean.FALSE.equals(((com.pnfsoftware.jeb.corei.parsers.dex.bK)this.dex).Rr().xK(var1.getIndex()))) {
                                 var25 = false;
                                 var18 = false;
                                 break label132;
                              }

                              bud var5 = ((com.pnfsoftware.jeb.corei.parsers.dexdec.ej)this.ctx.getGlobalContext().getDecompiler()).q(var1);
                              var5.RF(false);
                              var5.q(this.ctx.isParseExceptions());
                              var5.q(this.ctx.getWatchdog());
                              var5.q(this.ctx.getDecompilationFlags());
                              var5.q(this.ctx);

                              try {
                                 var5.Dw();
                              } catch (Exception var19) {
                                 com.pnfsoftware.jeb.corei.parsers.dexdec.tw.q(var19, var1.getSignature(false));
                                 var7 = false;
                                 var18 = false;
                                 break label131;
                              }
                              ...
                              var26.perform();
                              ((chl)var26.findOptimizer(chl.class)).perform(var5);
