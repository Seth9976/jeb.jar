...
class sq extends AbstractCommandHandler {
   sq(if var1, ICommandManager var2, String var3, CommandParameter[] var4, String var5, String var6) {
   ...
   public ExecutionResult execute(List var1) {
      ...
      if (var3 >= 0L && var5 != null) {
         int var6 = ((um)if.xK(this.q)).writeMemory(var3, var5.length, var5, 0);
