...
public class cvf extends AbstractNativeDecompilerExtension {
   public cvf() {
   ...
   public ChainedOperationResult resolveVariableArgumentInformation(IERoutineContext var1, CFG var2, int var3, IWildcardPrototype var4) {
      if (this.q(var1.getNativeContext()) && var4.getReturnType().toString().equals("EFI_STATUS")) {
         String var5 = var4.getSignature();
         if (var5.equals("EFI_STATUS(EFI_HANDLE*,...)") && this.q(var1, var2, var3)) {
   ...
   private boolean q(INativeContext var1) {
      return var1.getProcessor().getType() == ProcessorType.X86_64;
   }

   private boolean q(IERoutineContext var1, CFG var2, int var3) {
