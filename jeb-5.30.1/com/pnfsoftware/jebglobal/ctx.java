...
@Ser
public class ctx extends AbstractAnalyzerExtension {
   private static final ILogger Dw = GlobalLog.getLogger(ctx.class);
   @SerTransient
   adk q;
   @SerTransient
   ctk RF;
   ...
   public ChainedOperationResult q(long var1, ctc var3, IBasicBlockSkeleton var4) {
      if (this.RF == null) {
         this.RF = ctu.q(this.gca);
      }

      return this.RF != null && this.RF.q(var1, var3, var4) ? ChainedOperationResult.TRUE_STOP : ChainedOperationResult.FALSE_CONTINUE;
   }

   @Override
   public ChainedOperationResult determineSwitchInformation(long var1, IBasicBlockSkeleton var3, List var4) {
      if (this.RF != null) {
         SwitchInformation var5 = this.RF.q(var1, var3, var4);
         if (var5 != null) {
   ...
   public ChainedOperationResult postprocessImage(int var1) {
      try {
         if (this.xK == null) {
            this.xK = new ctz(this.gca, ((aae)this.gca).Dw().lm());
         }
   ...
   public ChainedOperationResult sigMatchingPostProcess(int var1) {
      ...
      try {
         if (this.q == null) {
            this.q = adj.q(this.gca);
         }

         if (this.q != null && this.q.q(false, true, true)) {
            return ChainedOperationResult.TRUE_CONTINUE;
         }
