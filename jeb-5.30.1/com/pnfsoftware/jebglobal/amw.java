...
public class amw {
   private static final ILogger q = GlobalLog.getLogger(amw.class);

   public static String q(IMasterOptimizer var0) {
      long var1 = 0L;
      List var3 = var0.getRegisteredOptimizers();

      for (OptimizerEntry var5 : var3) {
         var5.getStatistics().getRunCount();
         var5.getStatistics().getOptimizationCount();
         var1 += var5.getStatistics().getExecutionTimeMillis();
      }

      Collections.sort(var3, new amx());
      StringBuilder var14 = new StringBuilder();

      for (OptimizerEntry var6 : var3) {
         String var7 = var6.getOptimizer().getPluginInformation().getName();
         OptimizerEntry.Stat var8 = var6.getStatistics();
         int var9 = var8.getRunCount();
         int var10 = var8.getOptimizationCount();
         long var11 = var8.getExecutionTimeMillis();
         int var13 = var1 == 0L ? 0 : (int)(var11 * 100L / var1);
         Strings.ff(var14, "- \"%s\": rc=%d oc=%d t=%d(%s) (%d%%)\n", var7, var9, var10, var11, TimeFormatter.formatTimestampDelta(var11), var13);
      }

      return var14.toString();
   }

   public static boolean q(IERoutineContext var0, BasicBlock var1) {
   ...
   public static int q(IERoutineContext var0, BasicBlock var1, int var2) {
      return q(var0, var1, var2, false);
   }

   public static int q(IERoutineContext var0, BasicBlock var1, int var2, boolean var3) {
      ...
      } else if (var1.size() == 1 || var2 == 0 && !var3 || var2 == 0 && !q(var0, var1)) {
         if (var4.isNop()) {
            return 0;
         } else {
   ...
   public static void q(IERoutineContext var0, IBasicBlock var1, int var2, int var3) {
   ...
   public static boolean q(IERoutineContext var0, BasicBlock var1, int var2, List var3) throws JebException {
      if (!q(var1, var3.size())) {
         q(var0, var1, var2, var3.size());
   ...
   public static boolean q(IBasicBlock var0, int var1) {
      return var1 + var0.size() <= var0.getEndAddress() - var0.getBase();
   }

   public static boolean q(IEGeneric var0, IEGeneric var1) {
      return var0 == null ? var1 == null : var0.equalsEx(var1, false);
   }

   public static boolean q(IDFA var0, int var1) {
      for (IBasicBlock var3 : var0.getCfg().getExitBlocks()) {
         if (var0.getOutputMap(var3).containsKey(var1)) {
            return true;
         }
      }
   ...
   public static boolean q(IDFA var0, long var1, int var3) {
      return RF(var0, var1, var3) >= 0;
   }

   public static int RF(IDFA var0, long var1, int var3) {
      for (IBasicBlock var5 : var0.getCfg().getExitBlocks()) {
         Collection var6 = var0.getOutputMap(var5, var3);
         if (var6 != null) {
            ...
            for (Long var8 : var6) {
               IEStatement var9 = (IEStatement)var0.getCfg().getInstruction(var8);
               if (var9 instanceof IEAssign && !((IEAssign)var9).isRoutineCall() && !((IEAssign)var9).isBreakingFlow()) {
                  EDefUseInfo var10 = new EDefUseInfo();
                  ((IEAssign)var9).getLeftOperand().getDefinedOrUsedAsDestination(var10);
                  if (!var10.getDef().containsVarFull(var3)) {
                     return 0;
                  }

                  Collection var11 = var0.getUseDefs(var8, var3);
                  if (var11 != null && var11.contains((long)var3)) {
                     return 0;
                  }
               }
            }
   ...
   public static boolean q(IERoutineContext var0, IDFA var1, long var2, int var4) {
      for (IBasicBlock var6 : var1.getCfg().getExitBlocks()) {
         Collection var7 = var1.getOutputMap(var6, var4);
         if (var7 != null && var7.contains(var2)) {
            VarSrc var8 = var0.getSourceForVariable(var4);
            if (var8 == null) {
               return true;
            }

            ArrayList var9 = new ArrayList();
            var8.collectSourceIds(var9);
            if (var9.size() != 1) {
               return true;
            }

            IEVar var10 = var0.getVariableById((Integer)var9.get(0));
            IEGeneric var11 = var0.getOutputVariableForRegister(var1, var6.getLastAddress(), var10);
            if (var11 == null) {
               return true;
            }

            if (var11 instanceof IEVar && ((IEVar)var11).getId() == var4) {
               return true;
            }
   ...
   public static boolean q(CFG var0, BasicBlock var1) {
   ...
   public static int q(CFG var0, boolean var1, boolean var2) {
      int var3 = 0;
   ...
   public static int RF(CFG var0, boolean var1, boolean var2) {
      int var3 = 0;
      if (var1) {
      ...
      if (var2) {
         var3 += q(var0, true, false);
      }

      return var3;
   }

   public static int q(CFG var0) {
      return RF(var0, true, true);
   }

   public static IEMem q(IERoutineContext var0, IEMem var1, IEMem var2) {
   ...
   public static boolean q(IESwitch var0, CFG var1, BasicBlock var2, BasicBlock var3, BasicBlock var4) {
      boolean var5 = false;
