...
public class bol extends AbstractJOptimizer {
   @Override
   public int perform() {
   ...
   int q(IJavaBlock var1) {
      ...
      for (int var3 = 0; var3 < var1.size(); var3++) {
         ...
         if (var4 instanceof IJavaIf var5) {
            if (this.q(var1, var3, var5)) {
               var2++;
            } else if (this.RF(var1, var3, var5)) {
               var2++;
            }
         }
   ...
   private boolean RF(IJavaBlock var1, int var2, IJavaIf var3) {
      IJavaBlock var4;
         ...
         if (var7 instanceof IJavaIf && (var6 = (IJavaIf)var7).size() == 1) {
            ...
            if (var9 < 0) {
               ...
               if (var9 > 0 && JUtil.isFlowBreaker(var8.get(var9 - 1))) {
                  ...
                  IJavaDefinition var10 = ((bnd)this.m.getIdentifierManager()).createDefinition(this.tf.getBoolean(), null);
