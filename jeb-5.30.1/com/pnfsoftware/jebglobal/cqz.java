...
class cqz extends ELFRelocationContext {
   cqz(ELFRelocationApplicator... var1) {
      super(var1);
   }

   @Override
   public boolean canApply(IELFUnit var1, long var2) {
      return var1.getHeader().getMachine() == 62 && (var1.getHeader().getType() == 3 || var1.getHeader().getType() == 2);
   }
}
