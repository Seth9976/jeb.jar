...
public class aql extends aqj {
   private static final int za = RegisterBankX86.getInstance().getDescriptionEntryByName("ecx").getNumber();
   private boolean lm;
   private String zz;
   private ICallingConvention JY;

   public aql(INativeCodeUnit var1, INativeDecompilerUnit var2) {
      this(var1, var2, false);
   }

   public aql(INativeCodeUnit var1, INativeDecompilerUnit var2, boolean var3) {
      super(var1, var2);
      this.lm = var3;
      this.zz = CallingConventionName.THISCALL.toString();
      this.JY = this.oW.getCallingConventionManager().getConvention(this.zz);
   }
   ...
   protected boolean q() {
      if (this.RF.getProcessor().getType() != ProcessorType.X86) {
         ...
         if (this.lm) {
            ICompiler var1 = this.RF.getCodeAnalyzer().getDetectedCompiler();
   ...
   protected boolean q(long param1, INativeMethodItem param3) {
      ...
      // 005: invokevirtual com/pnfsoftware/jebglobal/aql.q (Lcom/pnfsoftware/jeb/core/units/code/asm/items/INativeMethodItem;Lcom/pnfsoftware/jeb/core/units/code/asm/decompiler/NativeDecompilationStage;)Lcom/pnfsoftware/jeb/core/units/code/asm/decompiler/IDecompiledMethod;
      // 008: astore 4
      // 00a: aload 4
      // 00c: ifnull 019
      // 00f: aload 4
      ...
      // 01a: istore 5
      // 01c: aload 0
      // 01d: getfield com/pnfsoftware/jebglobal/aql.xK Lcom/pnfsoftware/jeb/core/units/code/asm/decompiler/INativeDecompilerUnit;
      // 020: aload 3
      ...
      // 045: aload 6
      // 047: getstatic com/pnfsoftware/jebglobal/aql.za I
      // 04a: i2l
      ...
      // 0b6: lload 11
      // 0b8: bipush 1
      // 0b9: invokevirtual com/pnfsoftware/jebglobal/aql.q (JZ)Ljava/lang/Long;
      // 0bc: ifnull 0cf
      // 0bf: bipush 1
      // 0c0: istore 13
      // 0c2: aload 0
      // 0c3: getfield com/pnfsoftware/jebglobal/aql.xK Lcom/pnfsoftware/jeb/core/units/code/asm/decompiler/INativeDecompilerUnit;
      // 0c6: aload 3
      ...
      // 0d7: istore 7
      // 0d9: aload 0
      // 0da: getfield com/pnfsoftware/jebglobal/aql.xK Lcom/pnfsoftware/jeb/core/units/code/asm/decompiler/INativeDecompilerUnit;
      // 0dd: aload 3
      ...
      // 0e8: istore 5
      // 0ea: aload 0
      // 0eb: getfield com/pnfsoftware/jebglobal/aql.xK Lcom/pnfsoftware/jeb/core/units/code/asm/decompiler/INativeDecompilerUnit;
      // 0ee: aload 3
      ...
      // 0f7: astore 14
      // 0f9: aload 0
      // 0fa: getfield com/pnfsoftware/jebglobal/aql.xK Lcom/pnfsoftware/jeb/core/units/code/asm/decompiler/INativeDecompilerUnit;
      // 0fd: aload 3
   ...
   protected boolean q(IClassType var1, INativeMethodItem var2) {
      ...
      if (var3 == null) {
         ...
         IPrototypeItem var8 = this.oW.createPrototype(this.JY, var7, var5, null);
