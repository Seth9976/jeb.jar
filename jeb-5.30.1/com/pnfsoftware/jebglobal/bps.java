...
public class bps extends AbstractJBlockOptimizer {
   public bps() {
         ...
         if (var5 instanceof IJavaMonitor && ((IJavaMonitor)var5).isEnter()) {
            ...
            if (var6 != null) {
               ...
               if (var7 != null) {
                  ...
                  if (this.q(var1, var4, var6, var8, var7)) {
                     var3++;
                     continue;
                  }

                  if (this.RF(var1, var4, var6, var8, var7)) {
                     var3++;
                     continue;
                  }

                  if (this.xK(var1, var4, var6, var8, var7)) {
                     var3++;
                     continue;
                  }
               }
   ...
   private boolean q(IJavaBlock var1, int var2, IJavaExpression var3, IJavaBlock var4, IJavaCatchBlock var5) {
      if (var4.isEmpty()) {
         return false;
      } else {
   ...
   private boolean RF(IJavaBlock var1, int var2, IJavaExpression var3, IJavaBlock var4, IJavaCatchBlock var5) {
      boolean var6 = false;
         ...
         while (true) {
            ...
            if (var6) {
               if (var6) {
                  ...
                  JUtil.removeStatementsDeep(var16, new bpt(this, var3));
                  return true;
               }
   ...
   private boolean xK(IJavaBlock var1, int var2, IJavaExpression var3, IJavaBlock var4, IJavaCatchBlock var5) {
      boolean var6 = false;
