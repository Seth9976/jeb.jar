...
public class aud extends AbstractEExpressionOptimizer {
   ...
   public static final SubstitutionDefinition[] RF = new SubstitutionDefinition[]{
      Util.SD(
         Util.N(
            O.SUB,
            Util.L(0),
   ...
   protected AbstractEExpressionOptimizer.EOR optimizeExpression(IEGeneric var1) {
      if (!(var1 instanceof IEOperation var2)) {
         ...
         if (var3 == OperationType.ADD || var3 == OperationType.SUB) {
            ...
            } else if (var6 != null && amw.q(var6, var5)) {
               var11 = var5;
               IEImm var21 = this.ectx.createImm(1L, var8.getBitsize());
               var10 = var3 == OperationType.ADD ? this.q(var8, var21) : this.RF(var8, var21);
               var12 = ((IEOperation)var4).getOperationType();
            } else if (var7 != null && amw.q(var4, var7)) {
               var11 = var4;
               IEImm var13 = this.ectx.createImm(1L, var9.getBitsize());
               var10 = var3 == OperationType.ADD ? this.q(var13, var9) : this.RF(var13, var9);
               var12 = ((IEOperation)var5).getOperationType();
            } else if (var6 != null && var7 != null && ((IEOperation)var4).getOperationType() == ((IEOperation)var5).getOperationType() && amw.q(var6, var7)) {
               var11 = var6;
               var10 = var3 == OperationType.ADD ? this.q(var8, var9) : this.RF(var8, var9);
               var12 = ((IEOperation)var4).getOperationType();
            }
         ...
         IEGeneric var15 = this.doSubstitution(var1, q);
         if (var15 != null) {
            ...
            IEGeneric var17 = this.doSubstitution(var1, RF);
            return var17 != null ? AbstractEExpressionOptimizer.EOR.create(var17) : null;
         }
      }
   }

   private IEImm q(IEImm var1, IEImm var2) {
      boolean var3 = false;
   ...
   private IEImm RF(IEImm var1, IEImm var2) {
      boolean var3 = false;
      if (var1._testbit(var1.getBitsize() - 1) != var2._testbit(var2.getBitsize() - 1)) {
         var3 = true;
      }
