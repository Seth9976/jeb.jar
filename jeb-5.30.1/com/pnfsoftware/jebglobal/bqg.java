...
public class bqg extends AbstractJBlockOptimizer {
   @Override
   public int optimizeBlock(IJavaBlock var1, IJavaElement var2) {
      ...
      for (int var4 = 0; var4 < var1.size(); var4++) {
         ...
         var3 += this.q(var1, var5);
      }

      return var3;
   }

   private int q(IJavaElement var1, IJavaElement var2) {
      if (JUtil.isClassMethodField(var2)) {
         return 0;
      } else {
         Wrapper var3 = null;
         if (var2 instanceof IJavaCall var4) {
            var3 = this.q(var4, var1);
         }
   ...
   private Wrapper q(IJavaCall var1, IJavaElement var2) {
            ...
            if ((var4.getAccessFlags() & 4096) == 0) {
               ...
               if (var5 != null && var5.isBuilt()) {
                  ...
                  if ((var6 = this.q(var5)) != null) {
                     ...
                     if ((var7 = this.RF(var5)) != null) {
                        var9 = this.jctx.createAssignment(var7.duplicate(), ((IJavaExpression)var1.getArguments().get(0)).duplicate());
                     } else if ((var6 = this.xK(var5)) != null) {
                        var9 = this.jctx.createInstanceField(((IJavaExpression)var1.getArguments().get(0)).duplicate(), var6);
                     } else if ((var7 = this.Dw(var5)) != null) {
                        var9 = var7.duplicate();
                     } else {
                        IJavaCall var8;
                        if ((var8 = this.Uv(var5)) != null) {
                           var9 = this.jctx.createCall(var8.getMethodSignature(), var8.getCallType(), blr.q(var1.getArguments()));
                        }
                     }
                  }
                  ...
                  if (var9 == null) {
                     ...
                     com.pnfsoftware.jeb.corei.parsers.dexdec.tw.q(this.decomp, this.dex.getMethod(var5.getSignature()), S.L("Synthetic accessor"));
   ...
   private String q(IJavaMethod var1) {
   ...
   private IJavaStaticField RF(IJavaMethod var1) {
      IJavaBlock var2 = var1.getBody();
      if ((var2.size() == 1 || var2.size() == 2 && var2.get(1) instanceof IJavaReturn) && var2.get(0) instanceof IJavaAssignment) {
         IJavaAssignment var3 = (IJavaAssignment)var2.get(0);
         if (var3.isSimpleAssignment()) {
   ...
   private String xK(IJavaMethod var1) {
      IJavaBlock var2 = var1.getBody();
   ...
   private IJavaStaticField Dw(IJavaMethod var1) {
      IJavaBlock var2 = var1.getBody();
      if (var2.size() == 1 && var2.get(0) instanceof IJavaReturn) {
         IJavaReturn var3 = (IJavaReturn)var2.get(0);
   ...
   private IJavaCall Uv(IJavaMethod var1) {
      IJavaBlock var2 = var1.getBody();
      if (var2.size() == 1) {
         IJavaCall var3 = null;
