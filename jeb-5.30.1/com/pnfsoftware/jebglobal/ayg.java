...
public class ayg {
   ...
   public ayf q(int var1, int var2) {
      ...
      return new ayf(this.RF, var3, var1, var2);
   }

   public ayf q(long var1) {
      if ((var1 & -72057594037927936L) != -8863084066665136128L) {
         ...
         if ((var1 & 281474976710656L) != 0L) {
            int var5 = (int)var1;
            Long var6 = (Long)this.Uv.get(var5);
            if (var6 == null) {
               return null;
            }
         ...
         return new ayf(this.RF, var1, var3, var4);
      }
   }
}
