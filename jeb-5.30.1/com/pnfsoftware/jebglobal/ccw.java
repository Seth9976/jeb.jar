...
public class ccw extends AbstractDOptimizer {
   ...
   IDExpression q(IDOperation var1, IDInstruction var2) {
      if (var1.getLeft() instanceof IDOperation var3) {
         if (!var3.getOperator().is(JavaOperatorType.REM)) {
            return null;
         } else {
            Integer var16 = this.q(var3.getRight(), var2, true);
            if (var16 != null && var16 == 2) {
               var16 = this.q(var1.getRight(), var2, true);
               if (var16 == null) {
                  return null;
                     ...
                     if (!var6.getOperator().is(JavaOperatorType.MUL)) {
                        ...
                        if (!var19.getOperator().is(JavaOperatorType.ADD)) {
                           ...
                           if (var9.equalsEx(var8, false)) {
                              ...
                              Integer var13 = this.q(var9, var2, true);
                              if (var13 == null) {
                                 return null;
                              }

                              Integer var14 = this.q(var8, var2, true);
                              if (var14 == null) {
                                 return null;
                              }
                              ...
                              if (var13.equals(var14)) {
                                 ...
                                 Integer var15 = this.q(var10, var2, true);
                                 if (var15 == null) {
                                    return null;
                                 }
   ...
   Integer q(IDExpression var1, IDInstruction var2, boolean var3) {
      return this.q(var1, var2, var3, 2);
   }

   Integer q(IDExpression var1, IDInstruction var2, boolean var3, int var4) {
      if (var4 < 0 || var1.getType() != this.tf.getInt()) {
         ...
         if (var13 != null) {
            ...
            if (var7 != null && var7.isAssign()) {
               return this.q(var7.getAssignSource(), var2, var3, var4 - 1);
            }
         }
         ...
         if (var1 instanceof IDCallInfo var11 && var3) {
            IDExpression var6 = bto.q(this.ctx, var11);
            if (var6 != null) {
               return this.q(var6, null, var3, var4 - 1);
            }
         }
   ...
   class eo implements IDVisitor {
      ...
      public void q(IDExpression var1, IDExpression var2, IVisitResults var3) {
         if (var1 instanceof IDOperation var4 && var4.getOperatorType().isAnyOf(JavaOperatorType.EQ, JavaOperatorType.NE)) {
            IDExpression var5 = ccw.this.q(var4, this.q);
