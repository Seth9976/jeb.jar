...
public class aqt extends AbstractEOptimizer {
   ...
   private Set RF = new IdentityHashSet();
   ...
   protected int perform() {
      ...
      var1 += this.q(0);
      if (!this.q.isEmpty()) {
         this.cfg = EUtil.expandStatementSizes(this.ectx, this.q, 2);
         var1 += this.q(1);
      }
   ...
   private int q(int var1) {
      ...
      for (int var3 = 0; var3 < this.cfg.size(); var3++) {
         ...
         if ((var1 != 1 || this.RF.contains(var5)) && var5.isJump()) {
            ...
            if (var7 instanceof IEAssign) {
               ...
               if (var9.isVar() && var10.isImm()) {
                  ...
                  for (var16 = false;
                     ...
                     if (q(var17.getDefinedVarIds(), var11.getId()) || q(var17.getUsedVarIds(), var11.getId())) {
                        break;
                     }
   ...
   public static IEStatement q(CFG var0, BasicBlock var1, int var2) {
      if (var1.size() >= 2) {
         return (IEStatement)var1.get(var1.size() - 2);
      } else {
         return var2 >= 1 ? (IEStatement)var0.get(var2 - 1).getLast() : null;
      }
   }

   public static boolean q(List var0, Integer var1) {
