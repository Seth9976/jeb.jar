...
public class aiw extends AbstractCStatementOptimizer {
   @Override
   protected ICStatement optimizeStatement(ICStatement var1) {
      return var1 instanceof ICIfStm ? q(this.ef, (ICIfStm)var1, 3) : null;
   }

   static ICSwitchStm q(ICElementFactory var0, ICIfStm var1, int var2) {
      if (var1.size() < var2) {
         return null;
      } else {
         ICPredicate var3 = var1.getBranchPredicate(0);
         ICExpression var4 = q(var3.getExpression());
         if (var4 == null) {
            return null;
         } else {
            ...
            for (int var7 = 0; var7 < var1.sizeWithoutDefault(); var7++) {
               ...
               if (!q(var8.getExpression(), var4, var9)) {
                  if (var7 < var2) {
                     return null;
                  }
               ...
               ICBlock var10 = q(var0, var1.getBranchBody(var7));
               if (var10 == null) {
                  return null;
               }
            ...
            if (var6 != -1) {
               ...
               ICBlock var14 = q(var0, var0.createBlock(var11));
               if (var14 == null) {
                  return null;
               }
               ...
               ICBlock var12 = q(var0, var1.getDefaultBlock());
               if (var12 == null) {
                  return null;
               }
   ...
   private static ICBlock q(ICElementFactory var0, ICBlock var1) {
   ...
   private static ICExpression q(ICExpression var0) {
   ...
   private static boolean q(ICExpression var0, ICExpression var1, List var2) {
      if (!(var0 instanceof ICOperation var3)) {
         ...
         if (var3.getOperatorType() == COperatorType.EQ) {
            ...
            boolean var5 = q(var3.getFirstOperand(), var1, var2);
            if (!var5) {
               return false;
            }

            var5 = q(var3.getSecondOperand(), var1, var2);
            if (!var5) {
               return false;
            }

            if (var3.getThirdOperand() != null) {
               var5 = q(var3.getThirdOperand(), var1, var2);
               if (!var5) {
                  return false;
               }
            }
