...
public class chp {
   private static final ILogger q = GlobalLog.getLogger(chp.class);
   private IDMethodContext RF;

   public chp(IDMethodContext var1) {
      this.RF = var1;
   }
   ...
   public int q() {
      ...
      for (IDInstruction var5 : var1.getInstructions()) {
         var5.visitDepthPre(new chq(this, var2, var3));
      }
      ...
      for (int var8 : var6) {
         if (var8 - var21 >= var6.size() && this.RF.retrievePhysicalRegisterId(var8) < 0) {
            break;
         }
      ...
      for (int var10 : var23) {
         if (var10 - var22 >= var23.size() && this.RF.retrievePhysicalRegisterId(var10) < 0) {
            break;
         }
      ...
      for (int var15 : var2) {
         if (!var20.contains(var15)) {
            ...
            var27.put(var15, this.RF.getVar(var15));
      ...
      for (int var31 : var3) {
         if (!var20.contains(var31)) {
            ...
            var27.put(var31, this.RF.getVar(var31));
      ...
      if (var12.isEmpty()) {
         ...
         for (int var39 : var12.keySet()) {
            ...
            IDVar var19 = this.RF.createVar(var17, var18.getType(), false);
            Assert.a(var19 != null);
         ...
         for (IDInstruction var40 : var1.getInstructions()) {
            var40.visitDepthPost(new chr(this, var12));
         }

         if (com.pnfsoftware.jeb.corei.parsers.dexdec.eo.xK) {
