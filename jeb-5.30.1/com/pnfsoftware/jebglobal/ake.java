...
public class ake extends AbstractCBlockOptimizer {
   private static final StructuredLogger q = aeg.q(ake.class);
         ...
         if (var1.get(var3) instanceof ICIfStm var5) {
            for (int var6 = 1; var6 < var5.sizeWithoutDefault(); var6++) {
               ...
               for (int var8 = 0; var8 < var6; var8++) {
                  if (aew.q((ICExpression)var5.getBranchPredicate(var8), (ICExpression)var7)) {
            ...
            do {
               ...
               for (int var15 = 0; var15 < var5.sizeWithoutDefault() - 1; var15++) {
                  ...
                  if (CUtil.hasNoSideEffects(var18) && CUtil.hasNoSideEffects(var9)) {
                     ICPredicate var10 = this.q(var5, var9, var15 + 1);
                     if (var10 != null) {
                     ...
                     Integer var11 = this.q(var18, var9);
                     if (var11 != null && var11 > 0) {
                        ...
                        var2++;
                        var14 = true;
                        var10 = this.q(var5, var5.getBranchPredicate(var15 + 1), var15 + 1);
                        if (var10 != null) {
                     ...
                     var9.visitDepthPost(new akf(this, var23));
                     var9.visitDepthPost(new akg(this));
                  }
               }

               if (!var14) {
                  ICPredicate var16 = this.q(var5, null, var5.sizeWithoutDefault());
                  if (var16 != null) {
   ...
   private ICPredicate q(ICIfStm var1, ICPredicate var2, Integer var3) {
      if (var2 == null) {
         ...
         if (var9 instanceof ICOperation) {
            ...
            if (CUtil.isOperation((ICExpression)var9, COperatorType.EQ)) {
               ...
               var12 = akc.q((ICOperation)var9, this.m, this.cf);
            }
         ...
         ICExpression var10 = akc.q(var4, this.m, this.cf);
         if (var10 != null
   ...
   public Integer q(ICPredicate var1, ICPredicate var2) {
      if (var1.getExpression() instanceof ICOperation && var2.getExpression() instanceof ICOperation) {
         ...
         aew.CU var5 = aew.CU.q(var3);
         if (var5 == null) {
            return null;
         } else {
            aew.CU var6 = aew.CU.q(var4);
            if (var6 == null) {
               return null;
            } else if (var5.xK() == var6.xK() && !var5.RF(var6)) {
               ake.eo var7 = new ake.eo(var5);
               ake.eo var8 = new ake.eo(var6);
               if (var7.RF) {
                  return 1;
               } else if (var8.RF) {
                  return -1;
               } else if (var7.xK.isEmpty()) {
                  return var8.xK.isEmpty() ? 0 : -1;
               } else if (var8.xK.isEmpty()) {
                  return 1;
               } else if (var7.xK.size() == var7.q.size() * 2) {
                  if (var8.xK.size() == var8.q.size() * 2) {
                     return var7.q.size() != var8.q.size() ? var7.q.size() - var8.q.size() : ((BigInteger)var7.q.get(0)).compareTo((BigInteger)var8.q.get(0));
                  } else {
                     return -1;
                  }
               } else if (var8.xK.size() == var8.q.size() * 2) {
                  return 1;
               } else {
                  BigInteger var9 = (BigInteger)var7.xK.get(0);
                  BigInteger var10 = (BigInteger)var8.xK.get(0);
                  if (var9 == null) {
                     return var10 == null ? ((BigInteger)var7.xK.get(1)).compareTo((BigInteger)var8.xK.get(1)) : -1;
                  } else {
   ...
   private static class eo {
      ...
      public eo(aew.CU var1) {
         this.Dw = var1.Uv().asRanges();
         if (aew.q(this.Dw)) {
            this.RF = true;
         } else {
            for (Range var3 : this.Dw) {
               if (aew.q(var3)) {
                  this.q
