...
public abstract class aie extends AbstractCBlockOptimizer {
   @Override
   ...
   public int optimizeBlock(ICBlock var1, ICCompound var2, ICStatement var3) {
      ...
      while (var5 < var1.size()) {
         ...
         if (!this.q(var6)) {
            ...
            int var12 = this.q(var11);
            if (var12 == 0) {
               var5++;
            } else {
               ICLabel var9 = this.q(var5, var1, var3);
               aie.eo var10 = this.q(var1, var11, var5, var9, var12);
               var4 += var10.q;
               var5 += var10.RF;
            }
         }
   ...
   private ICLabel q(int var1, ICBlock var2, ICStatement var3) {
      ICStatement var4 = this.getNextSiblingStatement(var1, var2, var3);
      return var4 instanceof ICLabel ? (ICLabel)var4 : null;
   }

   protected abstract int q(ICGenericWhileLoop var1);

   protected abstract aie.eo q(ICBlock var1, ICGenericWhileLoop var2, int var3, ICLabel var4, int var5);

   protected static class eo {
      int q;
      int RF = 1;
   }
}
