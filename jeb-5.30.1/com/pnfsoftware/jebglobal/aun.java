...
public class aun extends AbstractEExpressionOptimizer {
   public aun() {
      ...
      for (IEGeneric var5 : var1) {
         if (var5 instanceof IESlice) {
            ...
            if (var2 instanceof IEMem) {
               ...
               IEGeneric var9 = this.q(var7, var8);
               if (var9 != null) {
                  return new aun.eo(var3 - 1, var9);
               }
            }
            ...
            return new aun.eo(var3 - 1, var12);
         }
   ...
   private IEGeneric q(IEMem var1, IEMem var2) {
      ...
      if (!this.q(var1.getBitsize())) {
         ...
         if (!var4.isOperation(OperationType.ADD)) {
            ...
            if (var12.isImm()) {
               return amw.q(var11, var5) && var12.asImm().getValueAsLong() == var13 ? var10 : null;
            } else if (!var11.isImm()) {
               return null;
            } else {
               return amw.q(var12, var5) && var11.asImm().getValueAsLong() == var13 ? var10 : null;
            }
         }
      }
   }
   ...
   private static class eo {
      ...
      public eo(int var1, IEGeneric var2) {
         this.q = var1;
         this.RF = var2;
      }
   }
