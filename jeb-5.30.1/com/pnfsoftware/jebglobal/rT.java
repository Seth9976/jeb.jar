...
public class rT {
   public static int q(IMachineContext var0, Integer var1) throws ProcessorException {
      byte[] var2 = q(var0, var1, 4);
      return EndianUtil.bytesToInt(var2, 0, var0.getInformation().getEndianness().toByteOrder());
   }

   public static byte RF(IMachineContext var0, Integer var1) throws ProcessorException {
      try {
   ...
   public static short xK(IMachineContext var0, Integer var1) throws ProcessorException {
      byte[] var2 = q(var0, var1, 2);
      return EndianUtil.bytesToShort(var2, 0, var0.getInformation().getEndianness().toByteOrder());
   }

   public static byte[] q(IMachineContext var0, Integer var1, int var2) throws ProcessorException {
   ...
   public static Long q(IMachineContext var0, int var1) {
      return RF(var0, var1, 32);
   }

   public static Long RF(IMachineContext var0, int var1) {
      return RF(var0, var1, 64);
   }
   ...
   public static boolean q(IMachineContext var0) {
      if (var0 != null && var0.getRegisters() != null) {
   ...
   public static boolean RF(IMachineContext var0) {
      if (!q(var0)) {
   ...
   public static Integer xK(IMachineContext var0) {
      if (var0 != null && var0.getRegisters() != null) {
         byte[] var1 = var0.getRegisters().getValue(16);
         if (var0.getInformation().getEndianness().isLittle()) {
            EndianUtil.swapByGroup(var1, 4);
   ...
   public static boolean Dw(IMachineContext var0) {
      if (!q(var0)) {
         throw new IllegalArgumentException("Context does not contain CPSR register");
      } else {
         byte[] var1 = var0.getRegisters().getValue(16);
   ...
   public static boolean Uv(IMachineContext var0) {
      if (!q(var0)) {
         throw new IllegalArgumentException("Context does not contain CPSR register");
      } else {
         byte[] var1 = var0.getRegisters().getValue(16);
