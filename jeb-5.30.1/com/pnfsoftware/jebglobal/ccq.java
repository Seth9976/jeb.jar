...
public class ccq extends AbstractDOptimizer {
   private static final ILogger q = GlobalLog.getLogger(ccq.class);
   private int RF;
   private Set xK = new HashSet();
   private static String Dw = "axProtHelperClasses";
   ...
   @Override
   public int perform() {
      Set var1 = q(this.g, false);
      if (var1 != null && !var1.isEmpty()) {
         this.RF = 0;

         for (IDInstruction var3 : this.cfg.instructions()) {
            var3.visitInstruction(new ccr(this, var1), true);
         }
   ...
   private IDImm q(IDCallInfo var1) {
      ...
      if (!var2.canRun()) {
         ...
         try {
            ...
            this.xK.add(var1.getMethodSignature());
            var6 = null;
         } finally {
   ...
   public static Set q(IDGlobalContext var0, boolean var1) {
      return var1 ? (Set)var0.getData(Dw, var0x -> new ConcurrentHashSet()) : (Set)var0.getData(Dw);
   }
}
