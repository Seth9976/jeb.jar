...
public class cby extends AbstractDOptimizer {
   public cby() {
      this.addTag("slow");
      ...
      for (BasicBlock var5 : this.cfg) {
         for (int var6 = 0; var6 < var5.size(); var6++) {
            ...
            if (var7.isAssignToVar() && var7.getAssignSource() instanceof IDImm var8) {
               ...
               if (!var3.add(new Couple(var10.getId(), var8)) && var2.add(var5.getAddressOfInstruction(var6)) && this.q(var5, var6, var10.getId(), var8)) {
                  var1++;
               }
            }
         }
   ...
   boolean q(BasicBlock var1, int var2, int var3, IDImm var4) {
      this.analyzeChains();
