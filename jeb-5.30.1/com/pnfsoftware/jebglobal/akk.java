...
public class akk extends AbstractCStatementOptimizer {
   @Override
   protected ICStatement optimizeStatement(ICStatement var1) {
      int var2 = 0;
      if (var1 instanceof ICSwitchStm var3) {
         if (var3.hasDefaultBlock() && this.q(var3.getDefaultBlock())) {
         ...
         for (int var13 = 0; var13 < var3.size(); var13++) {
            ...
            if ((var8 || var12 != null) && !var15.isEmpty() && var15.get(0) instanceof ICConditionalStatement) {
               ...
               if (q((ICConditionalStatement)var9, var12)) {
                  if (var9 instanceof ICIfStm) {
                     var9 = aiw.q(this.ef, (ICIfStm)var9, 0);
                     if (var9 == null) {
                        continue;
                     }
                  }
                  ...
                  if (var15.size() > 1) {
                     if (!akh.RF((ICConditionalStatement)var9)) {
                        continue;
                     }
                  ...
                  if (this.q(var3, var13, var15, (ICConditionalStatement)var9, var10)) {
                     var2++;
                     var13--;
                  }
               }
   ...
   private static boolean q(ICConditionalStatement var0, ICExpression var1) {
      ICExpression var2;
      if (var0 instanceof ICIfStm) {
         var2 = akh.q(((ICIfStm)var0).getBranchPredicate(0).getExpression());
      } else {
   ...
   private boolean q(ICSwitchStm var1, int var2, ICBlock var3, ICConditionalStatement var4, ICBlock var5) {
      boolean var6 = var1.hasDefaultBlock() && var2 == var1.size() - 1;
      if (var4 instanceof ICSwitchStm var7) {
         if (!q(this.ef, var1) && !q(this.ef, var7)) {
            if (var3.size() != 1 && q(var7)) {
               return false;
            } else {
               if (var6) {
                  this.q(var1, var7, null, var5);
               } else {
                  this.q(var1, var7, var3, var5);
               }
   ...
   private int q(ICSwitchStm var1, ICSwitchStm var2, ICBlock var3, ICBlock var4) {
      int var5 = 0;
   ...
   static boolean q(ICElementFactory var0, ICSwitchStm var1) {
   ...
   static boolean q(ICSwitchStm var0) {
      List var1 = var0.getBlocks();

      for (int var2 = 0; var2 < var1.size(); var2++) {
         ICBlock var3 = (ICBlock)var1.get(var2);
         if (!CUtil.visitICStatementDepthPost(new akl(var3), var3, null)) {
            return true;
         }
      }
   ...
   private boolean q(ICBlock var1) {
      if (var1.size() == 1) {
