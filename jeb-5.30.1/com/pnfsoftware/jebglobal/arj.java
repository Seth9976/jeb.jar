...
public class arj extends AbstractEOptimizer {
   private static final StructuredLogger q = aeg.q(arj.class);
               ...
               if (EUtil.isConditionalJump(var9)) {
                  ...
                  if (var14 == var4) {
                     if (var15 != var8 && var15 == var13 && var8.irrinsize() == 0) {
                        if (var7.irrinsize() == 0 && CollectionUtil.compare(var7.getIrregularOutputBlocks(), var4.getIrregularOutputBlocks(), false)) {
                     ...
                     } else if (var7.irrinsize() == 0 && CollectionUtil.compare(var7.getIrregularOutputBlocks(), var4.getIrregularOutputBlocks(), false)) {
