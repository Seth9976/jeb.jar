...
class hG extends AbstractCommandHandler {
   hG(if var1, ICommandManager var2, String var3, CommandParameter[] var4, String var5, String var6) {
   ...
   public ExecutionResult execute(List var1) {
      ...
      try {
         ...
         if.xK.catching(var10);
         return ExecutionResult.error(var10);
      }

      long var3 = this.q.q(var2[0].getValue());
      int var5 = Conversion.stringToInt(var2[1].getValue(), -1);
      if (var3 >= 0L && var5 >= 0) {
         byte[] var6 = new byte[var5];
         var5 = ((um)if.RF(this.q)).readMemory(var3, var5, var6, 0);
         if (var5 < 0) {
            ...
            if (var8 != null) {
               ...
               if (com.pnfsoftware.jeb.util.io.IO.writeFileSafe(var9, var6, 0, var5, true)) {
