...
public class Xz extends AbstractNativeDisassemblerPlugin {
   public static final String q = "arm64";
   public static final String RF = "DocumentationRoot";
   ...
   static {
      ...
      ELFPluginsService.getInstance().addRelocationContext(xf.io);
      ELFPluginsService.getInstance().addRelocationContext(xf.Hk);
      ELFPluginsService.getInstance().addRelocationContext(xf.qa);
      ELFPluginsService.getInstance().addRelocationContext(xf.Me);
   }
}
