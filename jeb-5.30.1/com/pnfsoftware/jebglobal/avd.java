...
public class avd extends AbstractEOptimizer {
   int q;
   ...
   protected int perform() {
      if (this.q == 0) {
         ...
         if (this.xK == null) {
            this.RF = this.ectx.getConverter().getDecompiler();
            this.xK = this.ectx.getWildcardTypeManager().getNativeTypeManager();
            this.Dw = this.xK.getType("char");
            this.Uv = this.xK.getType("wchar_t");
         }
               ...
               for (int var4 = 0; var4 < var3.size(); var4++) {
                  ...
                  if (var5.isCall()) {
                     ...
                     if (var6.isStaticCallsite() && var6.getCountOfReturns() == 1) {
                        ...
                        int var27 = this.q(var26);
                        if (var27 == 1) {
                           avd.eo var10 = (avd.eo)this.ectx.getGlobalContext().getData("ir_decryption_attempts");
                           if (var10 == null) {
                              var10 = new avd.eo();
                           ...
                           avd.eo.eo var12 = (avd.eo.eo)var10.q.get(var11);
                           if (var12 == null) {
                              var12 = new avd.eo.eo();
                              var10.q.put(var11, var12);
                           }

                           if (var12.RF < 2 && (var12.q < 8 || var12.xK != 0)) {
                              var12.q++;
                              ...
                              if (var28 != 0L) {
                                 ...
                                 if (var29 != null && var29.length() >= 4) {
                                    ...
                                    ICConstantFactory var30 = this.RF.getHighLevelContext().getConstantFactory();
   ...
   private int q(IWildcardType var1) {
      if (var1 == null) {
         return 0;
      } else {
         ...
         if (var2 == null) {
            ...
            if (!(var2 instanceof IReferenceType)) {
               ...
               if (var3 instanceof IReferenceType) {
                  return 0;
               } else if (this.Uv != null && TypeUtil.checkAliasedType(var3, this.Uv)) {
                  return 2;
               } else {
                  if (this.Dw != null) {
