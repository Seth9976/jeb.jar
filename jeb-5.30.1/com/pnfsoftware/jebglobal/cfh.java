...
public class cfh extends AbstractDOptimizer {
   private static final ILogger q = GlobalLog.getLogger(cfh.class, Integer.MAX_VALUE);
   private boolean RF;
            ...
            while (var5 < var3.size()) {
               ...
               if (var6.isNop()) {
                  ...
                  if (!var6.hasSideEffects(this.ctx, true)) {
                     ...
                     if (!this.RF && var19 instanceof IDArrayElt var20) {
