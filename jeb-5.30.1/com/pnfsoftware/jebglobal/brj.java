...
public class brj extends AbstractJOptimizer {
   int q;
   private static final int RF = 10000;
   private int xK;
   ...
   public int perform() {
      if (this.c == null) {
         ...
         for (IJavaMethod var2 : this.c.getMethods()) {
            var2.visitDepthPost(new brk(this));
         }
   ...
   IJavaMethod q(IJavaClass var1, String var2) {
   ...
   IJavaCall q(IJavaStatement var1) {
   ...
   boolean q(IJavaMethod var1, List var2, Map var3) {
   ...
   boolean q(IJavaMethod var1, IJavaCall var2, Map var3, List var4, Map var5) {
      if (var2 == null) {
   ...
   boolean q(IJavaIdentifier var1, IJavaExpression var2) {
