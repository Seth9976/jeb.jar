...
public class ajo extends AbstractCBlockOptimizer {
   @Override
   protected int optimizeBlock(ICBlock var1) {
      ...
      for (int var3 = 0; var3 < var1.size(); var3++) {
         ...
         if (var4 instanceof ICReturn) {
            ...
            var2 += this.q(var1, var3, (ICReturn)var4);
         }
      }
   ...
   private int q(ICBlock var1, int var2, ICReturn var3) {
      int var4 = 0;
      if (var2 == 0) {
         return var4;
      } else {
         if (var1.get(var2 - 1) instanceof ICIfStm var6) {
            for (int var7 = 0; var7 < var6.getBranchPredicates().size(); var7++) {
               if (this.q(var3, var6.getBranchBody(var7))) {
                  var4++;
               }
            }

            if (this.q(var3, var6.getDefaultBlock())) {
               var4++;
   ...
   private boolean q(ICReturn var1, ICBlock var2) {
