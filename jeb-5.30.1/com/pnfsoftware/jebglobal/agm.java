...
@Ser
public class agm extends afh implements ICJumpFar {
   @SerId(1)
   ICExpression RF;

   agm(ICExpression var1) {
      this.RF = var1;
   }
   ...
   public void generate(COutputSink var1) {
      ...
      var1.space();
      if (this.RF instanceof ICConstantInteger) {
         ((ICConstantInteger)this.RF).getFormatter().setBase(NumberFormatter.NumberBase.HEXADECIMAL);
      }
   ...
   public agm RF() {
      agm var1 = new agm(this.RF.duplicate());
      super.q(var1);
      return var1;
   }
