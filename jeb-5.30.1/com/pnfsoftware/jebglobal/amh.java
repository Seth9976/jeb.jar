...
public class amh implements Comparator {
   ...
   public int q(IEGeneric var1, IEGeneric var2) {
      ...
      if (var3 != var4 || var3 == 0) {
         ...
         if (var18 == var25) {
            ...
            Integer var32 = this.q.getUnderlyingRegisterId(var18);
            Integer var35 = this.q.getUnderlyingRegisterId(var25);
            if (var32 != null && var35 != null) {
               ...
               String var39 = ((amy)var1).getName();
               String var11 = ((amy)var2).getName();
