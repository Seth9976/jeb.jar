...
@Ser
public class amo implements IEStackManager {
   private static final StructuredLogger Dw = aeg.q(amo.class);
   @SerId(1)
   aml q;
   @SerId(2)
   int RF;
   ...
   public amo(aml var1) {
      this.q = var1;
      this.RF = var1.getGlobalContext().getAddressBitsize();
      if (this.RF % 8 != 0) {
   ...
   public Long getLowestVariableOffset() {
      IEVar var1 = this.q.oW.RF(33554432, Integer.MAX_VALUE);
      return var1 == null ? null : var1.getAddress();
   }

   @Override
   public Long getHighestVariableOffset() {
      IEVar var1 = this.q.oW.xK(33554432, Integer.MAX_VALUE);
      return var1 == null ? null : var1.getAddress();
   }
   ...
   public boolean hasVariables() {
      return !this.q.oW.q(33554432, Integer.MAX_VALUE).isEmpty();
   }

   @Override
   public Collection getVariables() {
      return this.q.oW.q(33554432, Integer.MAX_VALUE);
   }
   ...
   public IEVar getVariable(long var1) {
      ...
      if (var3 < 33554432) {
         ...
         return this.q.oW.RF(var3);
      }
   }

   @Override
   public IEVar getVariableAtSlot(int var1) {
      int var2 = 1073741824 + var1 * this.RF;
      if (var2 >= 33554432 && var2 < Integer.MAX_VALUE) {
         IEVar var3 = this.q.oW.RF(var2);
   ...
   public IEVar removeVariable(long var1) {
      ...
      if (var3 < 33554432) {
         ...
         return this.q.oW.q(var3);
      }
   }

   @Override
   public boolean canClearNativeStack(long var1, long var3) {
      IStackframeManager var5 = this.q.getRoutine().getData().getStackframeManager();
   ...
   public IEVar createStackItem(long var1, int var3) {
      int var6 = var3;
      IStackframeManager var7 = this.q.getRoutine().getData().getStackframeManager();
      IMethodStackMemoryModel var8 = this.q.getRoutine().getData().getStackframeModel();
      ITypeManager var9 = this.q.getWildcardTypeManager().getNativeTypeManager();
      ...
      if (var11 == null) {
         ...
         INativeType var16 = TypeUtil.getFirstSimpleType(((INativeDataItem)var11).getType());
         var6 = 8 * var16.getSize();
         var10 = this.createPureStackItem(var4, var6);
         String var17 = ((INativeContinuousItem)var11).getName(true);
         if (var17 != null) {
            ((amy)var10).q(var17);
         }

         Object[] var18 = new Object[]{var10};
      }
   ...
   public IEVar createPureStackItem(long var1, int var3) {
      ...
      if (var4 >= 33554432 && var4 + var3 <= Integer.MAX_VALUE) {
         ...
         if (var5 != null) {
            ...
            var5 = this.q.oW.q(var4, var6, var3, var1, true);
            Assert.a(var5 != null);
            return var5;
         }
      } else {
   ...
   public IWildcardType getActualStackItemType(long var1) {
      IMethodStackMemoryModel var3 = this.q.getRoutine().getData().getStackframeModel();
      ...
      if (!(var4 instanceof INativeDataItem)) {
         ...
         return this.q.getWildcardTypeManager().create(var5);
      }
   }
