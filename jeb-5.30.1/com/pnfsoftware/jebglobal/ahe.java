...
@Ser
public class ahe extends aff implements ICWhileStm {
   @SerId(1)
   ICPredicate RF;
   @SerId(2)
   ICBlock xK;

   ahe(ICPredicate var1, ICBlock var2) {
   ...
   public ahe RF() {
      ahe var1 = new ahe(this.RF.duplicate(), this.xK.duplicate());
      super.q(var1);
      return var1;
   }
   ...
   public boolean insertAt(long var1, ICStatement var3) {
      return this.xK.insertAt(var1, var3);
   }
   ...
   public List generateFlatList() {
      ArrayList var1 = new ArrayList();
      var1.add(new aib(this, this.RF));
      var1.addAll(this.xK.generateFlatList());
      var1.add(new aic());
      return var1;
   }
