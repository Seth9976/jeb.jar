...
public class bpd extends AbstractJBlockOptimizer {
   @Override
   public int optimizeBlock(IJavaBlock var1, IJavaElement var2) {
      ...
      for (int var4 = 0; var4 < var1.size(); var4++) {
         ...
         if (var5 instanceof IJavaWhile) {
            if (this.RF(var1, var4)) {
               var3++;
            } else if (this.q(var1, var4)) {
               var3++;
            }
         }
      }
   ...
   private boolean RF(IJavaBlock var1, int var2) {
      ...
      if (var4.isEmpty()) {
         ...
         if (var5 instanceof IJavaAssignment && ((IJavaAssignment)var5).getLeft() instanceof IJavaIdentifier) {
            ...
            if (!this.q(var3.getBody(), var6)) {
               return false;
            } else {
               IJavaStatement var8 = this.q(var7, Sets.newHashSet(var3));
               if (var8 == null) {
                  return false;
               } else if (!this.RF(var7, Sets.newHashSet(var3, var8))) {
                  return false;
               } else {
                  var4.removeLast();
   ...
   private boolean q(IJavaBlock var1, IJavaLabel var2) {
      return var1.visitDepthPost(new bpe(this, var2));
   }

   private IJavaStatement q(IJavaIdentifier var1, Collection var2) {
      IJavaStatement[] var3 = new IJavaStatement[1];
      this.m.getBody().visitDepthPre(new bpf(this, var2, var1, var3));
      return var3[0];
   }

   private boolean RF(IJavaIdentifier var1, Collection var2) {
      return this.m.getBody().visitDepthPre(new bpg(this, var2, var1));
   }
}
